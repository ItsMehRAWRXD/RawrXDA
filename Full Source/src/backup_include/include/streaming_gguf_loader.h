...
using GGMLType = CPUInference::GGMLType;
using TensorInfo = CPUInference::TensorInfo;
using GGUFHeader = CPUInference::GGUFHeader;
using GGUFMetadata = CPUInference::GGUFMetadata;
using IGGUFLoader = CPUInference::IGGUFLoader;
