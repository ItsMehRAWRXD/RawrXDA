@echo off
REM ============================================================================
REM OS Explorer Interceptor Build Script - Visual Studio Environment
REM Uses Visual Studio Developer Command Prompt environment
REM ============================================================================

echo Building OS Explorer Interceptor with Visual Studio Environment...
echo.
...
ml64.exe /c /Fo%OBJ_PATH%\os_explorer_interceptor.obj ^
    /D"_WINDOWS" ^
    /D"_AMD64_" ^
...
link.exe /DLL /SUBSYSTEM:WINDOWS ^
...
ml64.exe /c /Fo%OBJ_PATH%\os_interceptor_cli.obj ^
    /D"_CONSOLE" ^
    /D"_AMD64_" ^
