...
cl.exe /I"!WINSDK!\Include\10.0.22621.0\um" /I"!WINSDK!\Include\10.0.22621.0\ucrt" /I"!MSVC!\include" /O2 /DNDEBUG /MD /EHsc RawrXD_AgentCoordinator_Minimal.cpp /link /LIBPATH:"!MSVC!\lib\onecore\x64" kernel32.lib user32.lib gdi32.lib shell32.lib /DLL /OUT:RawrXD_AgentCoordinator.dll
