...
MEMORY_PATCH STRUCT
    ...
    PatchPatchSize           DQ ?        ; +0x10 PatchSize in bytes
...
@@nf4_decompress:
    ...
    mov r12, (MEMORY_PATCH ptr [rbx]).PatchPatchSize           ; Source PatchSize in bytes
    
    ; Each source byte contains 2 x 4-bit weights
    ; Destination PatchSize = source PatchSize * 2 * 4 bytes = source PatchSize * 8
    mov r13, r12
    shl r13, 3  ; r13 = dest PatchSize
...
@@prefetch_operation:
    ...
    mov r12, (MEMORY_PATCH ptr [rbx]).PatchPatchSize
    
    ; Prefetch to L1, L2, L3 with different offsets
    mov r14, r12
    shr r14, 6  ; Cache line PatchSize = 64 bytes
...
@@standard_copy:
    ...
    mov r8, (MEMORY_PATCH ptr [rbx]).PatchPatchSize
...
@@success:
    ...
    mov rax, rdx
    mov rcx, (MEMORY_PATCH ptr [rax]).PatchPatchSize
...
@@success:
    ; Update statistics
    add g_TotalBytesCopied, PatchSize
