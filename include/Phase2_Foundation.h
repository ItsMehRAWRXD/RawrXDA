...
//================================================================================
// INLINE CONVENIENCE FUNCTIONS (replace raw macro wrappers)
//================================================================================

inline auto Phase2Loader()        { return ModelLoader; }
inline Phase2::FormatType Phase2FormatGGUF()    { return Phase2::FormatType::GGUF; }
inline Phase2::RouterType Phase2RouterLocal()   { return Phase2::RouterType::GGUF_LOCAL; }
inline Phase2::RouterType Phase2RouterMmap()    { return Phase2::RouterType::GGUF_MMAP; }
inline Phase2::LoadFlags  Phase2FlagStreaming()  { return Phase2::LoadFlags::STREAMING; }
inline Phase2::LoadFlags  Phase2FlagVerify()     { return Phase2::LoadFlags::VERIFY; }
inline Phase2::GGMLType   Phase2QuantQ4K()       { return Phase2::GGMLType::Q4_K; }
inline Phase2::GGMLType   Phase2QuantQ80()       { return Phase2::GGMLType::Q8_0; }
inline Phase2::ModelArch  Phase2ArchLlama()      { return Phase2::ModelArch::LLAMA; }
inline Phase2::ModelArch  Phase2ArchMistral()     { return Phase2::ModelArch::MISTRAL; }

// Macro aliases removed — use Phase2Loader(), Phase2FormatGGUF(), etc. directly
