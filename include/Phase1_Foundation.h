...
/*================================================================================
 INLINE ACCESSORS FOR PHASE 1 OPERATIONS
 (Replaced macro wrappers with type-safe inline functions)
================================================================================*/

inline Foundation& Phase1Instance()                   { return Foundation::GetInstance(); }
inline PHASE1_CONTEXT* Phase1Context()                { return Foundation::GetInstance().GetRawContext(); }
inline void* Phase1Malloc(size_t size)                 { return Foundation::GetInstance().AllocateSystemMemory(size); }
inline void* Phase1MallocAligned(size_t size, size_t a){ return Foundation::GetInstance().AllocateSystemMemory(size, a); }
inline void* Phase1NUMAMalloc(uint32_t node, size_t s) { return Foundation::GetInstance().AllocateNUMAMemory(node, s); }
inline uint64_t Phase1Cycles()                         { return Foundation::GetInstance().ReadTSC(); }
inline uint64_t Phase1Micros()                         { return Foundation::GetInstance().GetElapsedMicroseconds(); }
inline double   Phase1Millis()                         { return Foundation::GetInstance().GetElapsedMilliseconds(); }
inline bool     Phase1HasAVX512()                      { return Foundation::GetInstance().HasAVX512(); }
inline bool     Phase1HasAVX2()                        { return Foundation::GetInstance().HasAVX2(); }
inline uint32_t Phase1Cores()                          { return Foundation::GetInstance().GetPhysicalCoreCount(); }
inline uint32_t Phase1Threads()                        { return Foundation::GetInstance().GetLogicalCoreCount(); }

// Macro aliases removed — use Phase1Instance(), Phase1Context(), Phase1Malloc(), etc. directly
