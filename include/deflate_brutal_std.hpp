...
#pragma once
/**
 * @file deflate_brutal_std.hpp
 * @brief MASM brutal gzip compress/decompress — STL-only (C++20).
 *
 * Uses std::vector<uint8_t> only. No Qt dependency.
 */
#include <cstdint>
#include <cstdlib>
#include <vector>
 ...
 * requires zlib/miniz or similar.
 */
