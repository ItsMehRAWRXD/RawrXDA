...
Write-Host "  🚀 RAWRXD v2.0.0 SOVEREIGN SYSTEM DEMONSTRATION" -ForegroundColor Yellow
...
# ═══════════════════════════════════════════════════════════════════════════════
# STEP 0: HARDWARE SETUP & DETECTION
# ═══════════════════════════════════════════════════════════════════════════════

Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host "  STEP 0: Hardware Detection & Configuration" -ForegroundColor Yellow
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
Write-Host ""

$setupScript = "$PSScriptRoot\hardware_setup.ps1"
if (Test-Path $setupScript) {
    try {
        Write-Host "Running hardware detection..." -ForegroundColor Gray
        & $setupScript -SkipValidation -ErrorAction SilentlyContinue
        Write-Host "✓ Hardware detection completed" -ForegroundColor Green
        Write-Host ""
    } catch {
        Write-Host "⚠ Hardware setup skipped (using existing config)" -ForegroundColor Yellow
        Write-Host ""
    }
} else {
    Write-Host "⚠ hardware_setup.ps1 not found - skipping detection" -ForegroundColor Yellow
    Write-Host ""
}
