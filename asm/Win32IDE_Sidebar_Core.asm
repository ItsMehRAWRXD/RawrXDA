...
LogCriticalSection dq 6 dup(0)  ; CRITICAL_SECTION is 40 bytes (5 QWORDS)
...
hPopulateEvent dq 0
TreeCriticalSection dq 6 dup(0)  ; CRITICAL_SECTION
TreeQueueHead dq 0
TreeQueueTail dq 0
...
RawrXD_LogMessage proc frame
    ...
    mov rax,QWORD PTR [szTimeBuffer]
    ...
    mov rax,rsp
    push rsi            ; msg
    push rbx            ; line (64-bit)
    push rdi            ; file
    sub rsp,32
    call wsprintfA
    add rsp,32+24       ; shadow space + pushed params
...
RawrXD_InitVirtualTree proc frame
    ...
    mov r9d,112Ch  ; TVM_SETEXTENDEDSTYLE
    call SendMessageA
...
do_resize:
    ...
    xor r9,r9
    push 1          ; repaint
    push rax        ; cy (height - unchanged)
    mov eax,nSidebarWidth
    push rax        ; cx
    push 0          ; y
    push 0          ; x
    push -1         ; HWND_TOP
