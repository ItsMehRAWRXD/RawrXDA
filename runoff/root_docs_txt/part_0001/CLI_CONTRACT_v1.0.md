...
| 1.2     | 2026-02-10 | Added subsystem 22: DiskRecovery (RawrXD_DiskRecoveryAgent.asm). Library module with C-callable exports. Wired into SubsystemRegistry + AgentBridge. Total: 22 subsystem API entries (18 CLI + 4 library). |
