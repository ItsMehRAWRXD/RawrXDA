...
echo [12/12] Assembling RawrXD_LocalParity_Kernel...
%ML64% /c /Fo%OUTDIR%\RawrXD_LocalParity_Kernel.obj /W3 /nologo /Zi /Zd RawrXD_LocalParity_Kernel.asm

echo Linking Interconnect DLL...
%LINK% /DLL /DEF:RawrXD_Interconnect.def /OUT:%OUTDIR%\RawrXD_Interconnect.dll /OPT:REF /LTCG %OUTDIR%\*.obj kernel32.lib ws2_32.lib user32.lib gdi32.lib ntdll.lib
