...
; Parameters: RCX = Haystack, RDX = Needle
; Returns: RAX = Pointer to first occurrence in Haystack, or NULL
; ═══════════════════════════════════════════════════════════════════════════════
RawrXD_StrStr PROC FRAME
    push rbx
    push rsi
    push rdi
    .pushreg rbx
...
@search_loop:
    ...
    ; Compare [rsi] with [rdi] for len rbx
    push rsi
    push rdi
    ...
    mov rdx, rdi
    mov r8, rbx
    ; Custom MemCmp loop since RtlCompareMemory is bytes matched
...
; RawrXD_StrCmp
; Compare two strings.
; Returns: RAX = 0 if equal, <0 or >0 diff
; ═══════════════════════════════════════════════════════════════════════════════
