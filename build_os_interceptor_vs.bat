@echo off
REM ============================================================================
REM OS Explorer Interceptor Build Script for Visual Studio
REM Uses Visual Studio Build Tools instead of MASM32
REM ============================================================================

echo Building OS Explorer Interceptor with Visual Studio...
echo.
