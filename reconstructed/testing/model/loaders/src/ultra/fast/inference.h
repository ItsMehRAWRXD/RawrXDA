...
public:
    ...
    TensorPruningScorer();
    explicit TensorPruningScorer(const PruningConfig& config);
    ~TensorPruningScorer();
...
public:
    ...
    explicit StreamingTensorReducer(const ReductionConfig& config);
    ~StreamingTensorReducer();
...
public:
    ...
    ModelHotpatcher();
    explicit ModelHotpatcher(const HotpatchConfig& config);
    ~ModelHotpatcher();
