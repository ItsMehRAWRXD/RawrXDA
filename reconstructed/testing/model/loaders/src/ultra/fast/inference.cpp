...
TensorPruningScorer::TensorPruningScorer()
    : TensorPruningScorer(PruningConfig{}) {
}
...
StreamingTensorReducer::StreamingTensorReducer()
    : StreamingTensorReducer(ReductionConfig{}) {
}
...
ModelHotpatcher::ModelHotpatcher()
    : ModelHotpatcher(HotpatchConfig{}) {
}
...
AutonomousInferenceEngine::AutonomousInferenceEngine()
    : AutonomousInferenceEngine(InferenceConfig{}) {
}
