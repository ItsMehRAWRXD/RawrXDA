...
public:
    ...
    uint64_t GetMetadataUInt64(const std::string& key) const;
    bool GetMetadataBool(const std::string& key) const;
...
private:
    ...
    size_t CalculateTensorSize(const NativeGGUFTensorInfo& tensor) const;
