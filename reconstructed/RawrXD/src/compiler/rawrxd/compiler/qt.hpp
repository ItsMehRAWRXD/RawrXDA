...
private:
    ...
    void generateIRForFunction(ASTNode* func, QTextStream& ir);
    void generateIRForBlock(ASTNode* block, QTextStream& ir, int indent);
    void generateIRForStatement(ASTNode* stmt, QTextStream& ir, int indent);
    QString generateIRForExpression(ASTNode* expr, QTextStream& ir, int indent);
    ...
    void generateX86_64Assembly(QTextStream& out);
    void generateX86_32Assembly(QTextStream& out);
    void generateARM64Assembly(QTextStream& out);
    QString resolveOperand(const QString& op, const QHash<QString, QString>& regMap);
    ...
    QHash<QString, QString> m_varMap;
