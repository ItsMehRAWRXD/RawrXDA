...
.data
    ...
    szLogSystemInitStart BYTE "Logging system initialization starting.", 0
    szLogSystemInitSuccess BYTE "Logging system initialization successful.", 0
    szLogSystemInitFailed BYTE "Logging system initialization failed.", 0
    szLoggingTime   BYTE "logging_time", 0
...
LogInitialize PROC
    ...
    ; ============================================================================
    ; Log logging system initialization start
    ; ============================================================================
    LEA rcx, [rel szLogSystemInitStart]
    ...
    ; ============================================================================
    ; PHASE 3: Set log level based on environment
    ; ============================================================================
    CALL Config_IsProduction
    TEST rax, rax
    JZ log_init_dev_mode
    
    ; Production mode: WARNING level
    MOV DWORD PTR [g_LogContext.log_level], LOG_LEVEL_WARNING
    MOV DWORD PTR [g_LogContext.log_targets], LOG_TARGET_FILE
    JMP log_init_targets_set
    
log_init_dev_mode:
    ; Development mode: DEBUG level
    MOV DWORD PTR [g_LogContext.log_level], LOG_LEVEL_DEBUG
    MOV DWORD PTR [g_LogContext.log_targets], LOG_TARGET_ALL
    
log_init_targets_set:
    ...
    ; ============================================================================
    ; Log logging system initialization success
    ; ============================================================================
    LEA rcx, [rel szLogSystemInitSuccess]
...
log_init_fail:
    ; ============================================================================
    ; Log logging system initialization failure
    ; ============================================================================
    LEA rcx, [rel szLogSystemInitFailed]
...
write_log_done:
    ; ============================================================================
    ; Measure logging performance and record metrics
    ; ============================================================================
    CALL QueryPerformanceCounter
    SUB rax, [BenchValue]  ; Calculate elapsed time
    MOV rcx, OFFSET szLoggingTime
    MOV rdx, rax
