...
IDM_TOOLS_ZERO_DAY      EQU 4005
IDM_TOOLS_ZERO_DAY_FORCE EQU 4006
...
;==========================================================================
; ZERO-DAY SETTINGS MENU HANDLERS
;==========================================================================

; Forward declarations for Zero-Day handlers
...
;==========================================================================
; PUBLIC: menu_tools_zero_day() -> eax (success)
; Show Zero-Day Settings Panel
;==========================================================================
PUBLIC menu_tools_zero_day
menu_tools_zero_day PROC
    push rbx
    sub rsp, 32
    
    ; Initialize Zero-Day settings from config
    ...
    pop rbx
    ret
menu_tools_zero_day ENDP

;==========================================================================
; PUBLIC: menu_tools_zero_day_force() -> eax (success)
; Toggle Force Complex Goals mode
;==========================================================================
PUBLIC menu_tools_zero_day_force
menu_tools_zero_day_force PROC
    push rbx
    sub rsp, 32
    
    ; Toggle force mode and show status
    call zero_day_settings_toggle_force_mode
    
    ; Log toggle operation
    lea rcx, [szZeroDayForce_Log]
    lea rdx, [rax]  ; rax contains new mode value
    call output_log_agent
    ...
    pop rbx
    ret
menu_tools_zero_day_force ENDP

;==========================================================================
; ZERO-DAY MENU LOG STRINGS
;==========================================================================
.data
    szZeroDaySettings_Log   BYTE "[Zero-Day] Settings panel opened", 0
    szZeroDayForce_Log      BYTE "[Zero-Day] Force complex goals mode toggled", 0
