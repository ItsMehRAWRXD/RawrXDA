...
IDM_GPU_ENABLE       equ 2023
IDM_GPU_NVIDIA       equ 2024
IDM_GPU_AMD          equ 2025
IDM_GPU_INTEL        equ 2026
IDM_GPU_DETECT       equ 2027
IDM_GPU_BENCHMARK    equ 2028
...
.data?
    ...
    ; GPU state
    gpu_enabled         DWORD ?     ; 1 = GPU acceleration enabled
    gpu_vendor_pref     DWORD ?     ; Preferred vendor (0=NVIDIA, 1=AMD, 2=Intel)
    gpu_device_count    DWORD ?
    gpu_initialized     DWORD ?
