...
deflate_godmode PROC
    ...
    ; Reserve locals and shadow space (keeps 16-byte alignment before calls)
    sub     rsp, 72

    ; Args
    mov     rsi, rcx        ; src
    mov     r15, rdx        ; len
    mov     qword ptr [rbp-72], r8   ; out_len*
    mov     qword ptr [rbp-80], r9   ; hash_buf
    ...
    mov     qword ptr [rbp-64], rdi  ; remember base for length calc
    ...
    mov     r11d, HASH_SIZE
.zero_hash:
    mov     dword ptr [r10 + rcx*4], 0xFFFFFFFF
    inc     ecx
    cmp     ecx, r11d
    jl      .zero_hash
    ...
    mov     r10, qword ptr [rbp-80]  ; hash_buf base
