...
struct AppState {
    ...
    struct DownloadProgress { int progress_percent = 0; } download_progress;
    ...
    bool running = false;
    // Simple UI flags (used by GUI)
    bool show_model_browser_window = false;
    bool show_settings_window = false;
    bool show_download_window = false;
    APIServer* api_server = nullptr;  // Pointer to active API server instance
};
