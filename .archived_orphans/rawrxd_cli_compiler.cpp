...
// [DEDUPED]     void diagnostic(const Diagnostic& diag) override {
...
// [DEDUPED]     void summary(const BuildStats& stats) override {
        s_logger.info(",\");
    return true;
}
...
public:
// [DEDUPED]     void begin() override {
        s_logger.info("<?xml version=\");
        s_logger.info("<build>\n<diagnostics>\n");
    return true;
}

// [DEDUPED]     void end() override {
...
// [DEDUPED]     void result(const CompileResult& result) override {}
