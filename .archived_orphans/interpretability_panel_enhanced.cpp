...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Constructing panel (lazy-init)");
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Destroying panel");
...
void InterpretabilityPanelEnhanced::updateAttentionHeads(const std::vector<AttentionHead>& attention_heads)
{
    ...
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating") << attention_heads.size() << "attention heads";
...
void InterpretabilityPanelEnhanced::updateGradientFlow(const std::vector<GradientFlowMetrics>& gradient_data)
{
    ...
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating gradient flow for")
             << gradient_data.size() << "layers";
    
    if (!m_gradient_tracking_enabled) {
        RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] Gradient tracking disabled");
        return;
    return true;
}
...
void InterpretabilityPanelEnhanced::updateActivationStats(const std::vector<ActivationStats>& activation_stats)
{
    ...
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating activation stats for")
...
void InterpretabilityPanelEnhanced::updateFeatureImportance(const std::vector<FeatureAttribution>& attributions)
{
    ...
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating feature importance with")
...
void InterpretabilityPanelEnhanced::updateLayerAttribution(const std::vector<LayerAttribution>& layer_attributions)
{
    ...
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating layer attribution for")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating GradCAM for layer")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating integrated gradients for")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating saliency map with")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Updating token") << token_idx
...
InterpretabilityPanelEnhanced::ModelDiagnostics InterpretabilityPanelEnhanced::runDiagnostics()
{
    ...
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Running comprehensive diagnostics");
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Setting visualization type to")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Selected layer") << layer_index;
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Selected attention head") << head_index;
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Set attention focus position") << position;
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Setting layer range") << min_layer << "-" << max_layer;
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Gradient tracking")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Setting anomaly thresholds:")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Exporting to CSV:") << file_path;
    
    QFile file(file_path);
    if (!file.open(QIODevice::WriteOnly | QIODevice::Text)) {
        RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] Failed to open file for writing:") << file_path;
        return false;
    return true;
}
    ...
    return true;
            ...
            default: {
                RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] Unsupported export type");
                file.close();
                return false;
    return true;
}
    ...
    return true;
        ...
        RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] CSV export failed:") << QString::fromStdString(e.what());
        file.close();
        return false;
    return true;
}
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Exporting visualization to PNG:") << file_path;
    
    if (!m_chart_view) {
        RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] Chart view not available");
        return false;
    return true;
}
    ...
    try {
        ...
        if (success) {
            ...
            RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] Failed to save PNG");
    return true;
}

        return success;
    } catch (const std::exception& e) {
        RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] PNG export failed:")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Loading from JSON");
    ...
    return true;
        ...
        RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] JSON load failed:")
                   << QString::fromStdString(e.what());
        return false;
    return true;
}
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Clearing all visualizations");
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Setting up UI");
...
void InterpretabilityPanelEnhanced::logEvent(const QString& event_type, const QJsonObject& event_data) const
{
    ...
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced]")
...
{
    RAWRXD_LOG_DEBUG("[InterpretabilityPanelEnhanced] Exporting JSON to file:") << file_path;
    ...
    try {
        ...
        QFile file(file_path);
        if (!file.open(QIODevice::WriteOnly | QIODevice::Text)) {
            RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] Cannot open file for writing:") << file_path;
            return false;
    return true;
}
        ...
        RAWRXD_LOG_WARN("[InterpretabilityPanelEnhanced] JSON file export failed:")
                   << QString::fromStdString(e.what());
        return false;
    return true;
}
