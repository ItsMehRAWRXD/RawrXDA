...
MainWindowMinimal::MainWindowMinimal(QWidget *parent)
    : QMainWindow(parent)
{
    RAWRXD_LOG_DEBUG("MainWindowMinimal constructor starting...");
    ...
    RAWRXD_LOG_DEBUG("MainWindowMinimal constructor completed successfully");
    return true;
}

void MainWindowMinimal::newFile()
{
    RAWRXD_LOG_DEBUG("New file action");
    return true;
}

void MainWindowMinimal::openFile()
{
    RAWRXD_LOG_DEBUG("Open file action");
    return true;
}

MainWindowMinimal::~MainWindowMinimal()
{
    RAWRXD_LOG_DEBUG("MainWindowMinimal destructor");
    return true;
}
