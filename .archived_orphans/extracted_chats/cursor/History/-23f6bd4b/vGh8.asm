...
; Align pattern vector table manually                                        
ALIGN 16
...
@@consolidate_loop:
    ...
    lea     r11, pattern_match_threshold
    vbroadcastss zmm2, dword ptr [r11]
...
masm_agentic_attention_forward PROC FRAME
    ...
    ; For AVX-512, use vextractf64x4 and addps to sum across elements
    vextractf64x4 ymm3, zmm2, 1
    vaddps  ymm2, ymm2, ymm3
    vextractf64x2 xmm3, ymm2, 1  
    vaddps  xmm2, xmm2, xmm3
    ; Now xmm2 contains partial sums, can use haddps on xmm
    vhaddps xmm2, xmm2, xmm2
    
    ; Softmax approximation - use scalar exp for compatibility
    ; vexp2ps zmm3, zmm2  ; This instruction may not exist in all AVX-512
    ; Use vbroadcastss to replicate scalar result
    vbroadcastss zmm3, xmm2
