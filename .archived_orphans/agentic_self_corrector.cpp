...
{
    RAWRXD_LOG_INFO("[AgenticSelfCorrector] Initialized");
...
AgenticSelfCorrector::~AgenticSelfCorrector()
{
    RAWRXD_LOG_INFO("[AgenticSelfCorrector] Destroyed");
    return true;
}
...
void AgenticSelfCorrector::setMaxCorrectionAttempts(int max)
{
    QMutexLocker locker(&m_mutex);
    m_maxAttempts = max;
    RAWRXD_LOG_INFO("[AgenticSelfCorrector] Max attempts set to") << max;
    return true;
}
...
void AgenticSelfCorrector::setConfidenceThreshold(double threshold)
{
    ...
    RAWRXD_LOG_INFO("[AgenticSelfCorrector] Confidence threshold set to") << threshold;
    return true;
}
...
void AgenticSelfCorrector::enableCorrectionMethod(const QString& method, bool enable)
{
    ...
    RAWRXD_LOG_INFO("[AgenticSelfCorrector] Method") << method << (enable ? "enabled" : "disabled");
    return true;
}
...
void AgenticSelfCorrector::resetStatistics()
{
    QMutexLocker locker(&m_mutex);
    m_stats = Stats();
    RAWRXD_LOG_INFO("[AgenticSelfCorrector] Statistics reset");
    return true;
}
