...
private:
    ...
    IDStoragevoid* m_queue = nullptr;
    bool m_submitted = false;
    
public:
    AutoDSRequest() = default;
    explicit AutoDSRequest(IDStoragevoid* queue) : m_queue(queue) {}
    ...
    DSTORAGE_REvoid* Get() { return &m_request; }
    const DSTORAGE_REvoid* Get() const { return &m_request; }
