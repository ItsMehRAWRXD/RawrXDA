...
import { Package, Upload, Settings, Trash2, X, Loader2 } from 'lucide-react';
        ...
        {pluginSettings && (
          <div className="bg-card border border-border rounded-lg p-3 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button type="button" onClick={() => setPluginSettings(null)} className="p-1 hover:bg-secondary rounded" title="Close settings">
