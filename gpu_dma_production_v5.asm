...
MEMORY_PATCH STRUCT
    ...
    PatchSize           DQ ?        ; +0x10 PatchSize in bytes
...
@@nf4_decompress:
    ...
    mov rdi, [rbx+8]
    ; Load parameters
    mov r12, QWORD PTR [rbx+16]           ; Source PatchSize in bytes
...
Titan_InitializeGPU PROC FRAME
    ...
    lea rax, hFreq
    ; External call omitted:     call QueryPerformanceFrequency
    cmp rax, 0
    je @@freq_failed
...
Titan_InitDirectStorage PROC PRIVATE
    ...
    ; External call omitted:     call GetProcAddress
    cmp rax, 0
    je @@not_available
