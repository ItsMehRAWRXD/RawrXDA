...
private:
    ...
    void* m_vulkanContext = nullptr;          // VkInstance when HAVE_VULKAN
    QList<void*> m_vulkanPhysicalDevices;    // List of VkPhysicalDevice when HAVE_VULKAN
    void* m_vulkanPhysicalDevice = nullptr;   // Currently selected VkPhysicalDevice
    bool  m_vulkanBudgetSupported = false;    // VK_EXT_memory_budget available
