; ================================================
; RXUC-TerraForm v5.0 - Complete Compiler Implementation
; Full Parser + x64 CodeGen + PE Writer + Folder Compilation
; Zero Dependencies, Pure MASM64, Drag-and-Drop Build
; ================================================
...
; Error Messages
sz_usage db "Usage: Drag folder or .tf file onto executable",10,0
sz_compiling db "[*] Compiling: ",0
sz_success db "[+] Build successful",10,0
sz_err_file db "[!] Cannot open file",10,0
sz_err_syntax db "[!] Syntax error",10,0
sz_err_read db "[!] Read error",10,0
sz_err_write db "[!] Write error",10,0
sz_err_toplevel db "[!] Expected function or global declaration",10,0
sz_err_undef db "[!] Undefined symbol",10,0
...
pe_optional_header:
dw 20Bh               ; Magic
db 0,1                ; Major/Minor Linker
dd 0,0,0              ; Code/Data/BSS sizes
dd 1000h              ; EntryPoint
dd 1000h              ; BaseOfCode
dq 140000000h         ; ImageBase
...
dw 0                  ; Win32Version
dd 3000h              ; SizeOfImage
dd 400h               ; SizeOfHeaders
dd 0                  ; CheckSum
dw 3                  ; Subsystem
dw 0                  ; DllCharacteristics
dq 100000h            ; StackReserve
dq 1000h              ; StackCommit
dq 100000h            ; HeapReserve
dq 1000h              ; HeapCommit
dd 0                  ; LoaderFlags
...
; Symbol Table
sym_table db SYMBOL_SIZE * MAX_SYMS dup(?)
sym_count dd ?
