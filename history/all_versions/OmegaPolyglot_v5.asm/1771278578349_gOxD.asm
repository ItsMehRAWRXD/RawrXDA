...
; --- Banner & Menu ---
szBanner    db 13,10
            db "  OMEGA-POLYGLOT v5.0 - Professional Reverse Engineering Suite",13,10
            db "  PE Analysis | Import/Export Recon | Entropy | CFG | Decompiler",13,10
            db "  =============================================================",13,10,13,10,0

szMenu      db "  [1]  Full PE Analysis        [7]  Source Reconstruction",13,10
            db "  [2]  Import Table            [8]  TLS Callbacks",13,10
            db "  [3]  Export Table             [9]  Hex Dump",13,10
            db "  [4]  Entropy / Packer Scan   [10] Disassemble",13,10
            db "  [5]  String Extraction       [11] Full Reconnaissance",13,10
            db "  [6]  Control Flow Recovery   [12] HTML Report",13,10
            db "  [0]  Exit",13,10
            db "  > ",0
...
WriteStr proc hOut:DWORD, lpStr:DWORD
    ...
    invoke lstrlen, lpStr
    invoke WriteFile, hOut, lpStr, eax, addr dwWritten, 0
    ret
WriteStr endp
