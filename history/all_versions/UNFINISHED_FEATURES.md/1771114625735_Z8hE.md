...
| **ide** | chat_panel_integration: createPanel, Copilot/Q env checks, processTokenStream callback; refactoring_plugin/language_plugin use of "TODO" are logic (preserve TODO comments / keyword), not stubs. |
...
2026-02-14 (Batch 7: Qt→Win32 IDE/CLI audit, QtCompat::ThreadPool impl, docs/QT_TO_WIN32_IDE_AUDIT.md)
