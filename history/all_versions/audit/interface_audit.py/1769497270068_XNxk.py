...
# Todo List structure
TODO = {
    "GUI":     ["ThermalDashboardWidget visible", "Menu toggle works", "60 FPS refresh"],
    "KERNEL":  ["pocket_lab.exe ENTERPRISE badge", "Global\\SOVEREIGN_STATS online", "0.7 t/s sustained"],
    "MMF":     ["Global\\SOVEREIGN_NVME_TEMPS alive", "temp bars color flip >40 C"],
    "CI":      ["audit.bat gate passes", "badge auto-asserts ENTERPRISE"],
    "SHIP":    ["build package.zip", "release notes.txt", "OTA stub updater"]
}

def whats_left():
    print("\n----------------------------------------------------------------")
    print("REMAINING CHECKLIST")
    print("----------------------------------------------------------------")
...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "--left":
        ...
        run_audit()
        # Optional: Print checklist after audit if requested, or keep separate
        # whats_left()
