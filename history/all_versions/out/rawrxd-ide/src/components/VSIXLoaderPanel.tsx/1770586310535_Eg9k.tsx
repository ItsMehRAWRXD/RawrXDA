...
export const VSIXLoaderPanel: React.FC = () => {
  ...
  return (
    <div className="p-4 space-y-4 h-full flex flex-col">
      ...
      <div 
        className={`flex-1 min-h-[120px] border-2 border-dashed rounded-lg flex flex-col items-center justify-center p-8 transition-colors cursor-pointer ${
      ...
      >
        ...
        {uploadStatus && (
          <p className={`text-sm mt-3 ${
            uploadStatus.startsWith('✅') ? 'text-green-400' :
