...
; Canary stored at [rbp-10h] — a dedicated slot above the shadow space area.
; rbp is stable across the function, so cookie XOR rbp is invariant.
; IMPORTANT: CANARY_PROLOGUE must be placed AFTER all pushes and sub rsp.
;            The frame must include [rbp-10h] in its allocated region.
;            CANARY_EPILOGUE must be placed BEFORE any add rsp / pops.
