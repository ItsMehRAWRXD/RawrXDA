...
void line_thick(Canvas& c, float x0, float y0, float x1, float y1, float thickness, const Color& col) {
    float dx = x1 - x0;
    float dy = y1 - y0;
...
void stroke_rect(Canvas& c, int x, int y, int w, int h, float thickness, const Color& col) {
...
void stroke_circle(Canvas& c, float cx, float cy, float r, float thickness, const Color& col) {
...
void fill_ellipse(Canvas& c, float cx, float cy, float rx, float ry, const Color& col) {
...
void flood_fill(Canvas& c, int x, int y, const Color& new_color) {
