...
struct json {
    ...
    // Iterators for object (basic support)
    std::map<std::string, json>::iterator begin() { return m_object.begin(); }
    std::map<std::string, json>::iterator end() { return m_object.end(); }
    std::map<std::string, json>::const_iterator begin() const { return m_object.begin(); }
    std::map<std::string, json>::const_iterator end() const { return m_object.end(); }
};
