...
// Also defined in api_server.h - using compatible layout
struct ChatMessage {
    std::string role;
    std::string content;
...
// Also defined in hf_downloader.h - using compatible layout
...
struct AppState {
    ...
    // Download state (pointer to avoid circular dependency)
    DownloadProgress download_progress;
    
    // Chat history (pointer to avoid circular dependency)
