...
namespace Status {
    ...
    constexpr bool EnterpriseSupport_Implemented   = false;  // display-only
    ...
    constexpr bool MultiGPU_Implemented            = false;  // display-only
    ...
    constexpr bool DistributedSwarm_Gated          = false;  // MISSING — TODO
    constexpr bool GPUQuant4Bit_Gated              = false;  // MISSING — TODO
    constexpr bool EnterpriseSupport_Gated         = false;  // N/A
    constexpr bool UnlimitedContext_Gated          = true;   // GetMaxContextLength
    constexpr bool FlashAttention_Gated            = true;   // streaming engine
    constexpr bool MultiGPU_Gated                  = false;  // N/A
    ...
    constexpr int ImplementedCount = 6;   // DualEngine + AVX512 + Swarm + GPUQuant + Context + Flash
    constexpr int GatedCount       = 4;   // DualEngine + AVX512 + Context + FlashAttn
    constexpr int UIWiredCount     = 8;   // All displayed in License Creator
    constexpr int StubCount        = 2;   // EnterpriseSupport + MultiGPU
}
...
namespace Files {
    ...
    constexpr const char* Swarm_Gate          = "MISSING — needs Enterprise_CheckFeature(0x04)";
    ...
    constexpr const char* GPUQuant_Gate       = "MISSING — needs Enterprise_CheckFeature(0x08)";

    // Enterprise Support
    constexpr const char* Support_Header      = "MISSING — needs support_tier.h";
    constexpr const char* Support_Impl        = "MISSING — needs support_routing.cpp";
    constexpr const char* Support_ASM         = "N/A";
    constexpr const char* Support_Gate        = "N/A (no implementation)";
    ...
    // Multi-GPU
    constexpr const char* MultiGPU_Header     = "MISSING — needs multi_gpu.h";
    constexpr const char* MultiGPU_Impl       = "MISSING — needs multi_gpu_dispatch.cpp";
    constexpr const char* MultiGPU_ASM        = "MISSING — needs GPU DMA multi-device kernel";
    constexpr const char* MultiGPU_Gate       = "N/A (no implementation)";
}
