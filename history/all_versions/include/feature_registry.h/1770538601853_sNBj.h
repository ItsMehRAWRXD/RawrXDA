...
// ============================================================================
// RAW_REGISTER_FEATURE — Auto-registration macro
// ============================================================================
// Usage:
...
//
// This macro creates a static initializer that registers the feature at
// program startup before main() is entered.
// ============================================================================
