...
bool EnterpriseSecurity::enforceSecurityPolicy(const QString& policyName, const QJsonObject& context) {
    Q_UNUSED(policyName)
    Q_UNUSED(context)
    return false;
}

QJsonObject EnterpriseSecurity::getSecurityPolicyStatus() {
    return QJsonObject();
}