...
QJsonObject EnterpriseMetricsCollector::getToolMetrics(const QString& toolName) const {
    Q_UNUSED(toolName)
    return QJsonObject();
}

QJsonObject EnterpriseMetricsCollector::getMissionMetrics(const QString& missionId) const {
    Q_UNUSED(missionId)
    return QJsonObject();
}

QJsonObject EnterpriseMetricsCollector::getSystemMetrics() const {
    return QJsonObject();
}

void EnterpriseMetricsCollector::setMetricsRetentionPeriod(int days) {
    Q_UNUSED(days)
}
