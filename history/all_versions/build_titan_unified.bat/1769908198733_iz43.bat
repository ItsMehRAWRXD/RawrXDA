...
echo [3.5/4] Assembling Pipe Server...
"!ML64!" /c /Zi /Fo"!OUTDIR!\RawrXD_PipeServer.obj" "!SRCDIR!\RawrXD_PipeServer.asm"
if errorlevel 1 (
    echo [-] Assembly failed
    exit /b 1
)
...
"!LINKER!" /SUBSYSTEM:CONSOLE /LARGEADDRESSAWARE:NO /OUT:"!OUTEXE!" ^
    ...
    "!OUTDIR!\RawrXD_PipeServer.obj" ^
    kernel32.lib ntdll.lib user32.lib advapi32.lib ucrt.lib libcmt.lib libvcruntime.lib
if errorlevel 1 (
    echo [-] Linking failed
    exit /b 1
)
