...
// SetMaxMode/DeepThinking/DeepResearch removed from here due to redefinition errors.
// Logic should be moved to header or header body removed.
// For now, relying on header implementation (simple setters).
/*
