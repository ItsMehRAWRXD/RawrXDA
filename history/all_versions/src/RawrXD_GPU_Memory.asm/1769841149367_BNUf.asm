...
Vram_Initialize PROC
    ...
    ; manual offset calc or typed access. Types access works for index 0
    mov g_VramHeap.Blocks[0].blkOffset, 0
    mov g_VramHeap.Blocks[0].blkSize, rbx
    mov g_VramHeap.Blocks[0].blkFlags, BLOCK_FLAG_FREE
