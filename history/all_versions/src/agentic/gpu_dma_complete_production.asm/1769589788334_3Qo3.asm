...
EXTERN __imp_GetVersionExA:QWORD
EXTERN __imp_InitializeSRWLock:QWORD
EXTERN __imp_AcquireSRWLockShared:QWORD
EXTERN __imp_ReleaseSRWLockShared:QWORD
...
MAX_BUFFER_SIZE         EQU 1000000000h
MAX_DMA_SIZE            EQU 10000000h
