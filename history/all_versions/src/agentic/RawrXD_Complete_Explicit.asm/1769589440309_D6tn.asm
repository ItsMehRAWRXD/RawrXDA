...
; Zero-initialized global structures (avoid complex initialization syntax)
g_infinity_stream       INFINITY_STREAM_FULL {0}
g_task_scheduler        TASK_SCHEDULER {0}
g_conflict_detector     CONFLICT_DETECTOR {0}
g_heartbeat_monitor     HEARTBEAT_MONITOR {0}
