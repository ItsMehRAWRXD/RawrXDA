...
Infinity_InitLocks PROC FRAME
    ...
    lea rcx, [rbx + OFFSET INFINITY_STREAM_FULL.status_lock]
    call InitializeSRWLock
    
    lea rcx, [rbx + OFFSET INFINITY_STREAM_FULL.stats_lock]
    call InitializeSRWLock
...
Infinity_LockStatusShared PROC FRAME
    .endprolog
    lea rcx, [g_infinity_stream + OFFSET INFINITY_STREAM_FULL.status_lock]
