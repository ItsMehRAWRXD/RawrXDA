...
; Zero-initialized global structures
g_infinity_stream       DB SIZEOF INFINITY_STREAM_FULL DUP(0)
g_task_scheduler        DB SIZEOF TASK_SCHEDULER DUP(0)
g_conflict_detector     DB SIZEOF CONFLICT_DETECTOR DUP(0)
g_heartbeat_monitor     DB SIZEOF HEARTBEAT_MONITOR DUP(0)
...
Infinity_LockStatusShared PROC
    .endprolog
...
Infinity_UnlockStatusShared PROC
    .endprolog
    lea rcx, g_infinity_stream.status_lock
...
Infinity_LockStatusExclusive PROC
    .endprolog
    lea rcx, g_infinity_stream.status_lock
...
Infinity_UnlockStatusExclusive PROC
    .endprolog
    lea rcx, g_infinity_stream.status_lock
...
find_slot_loop:
    ...
    imul rax, rcx, SIZEOF QUAD_SLOT_FULL
    add rax, rsi
...
do_load:
    ...
    mov QWORD PTR [rdi].QUAD_SLOT_FULL.dma_overlapped.InternalHigh, 0
    mov rax, [rdi].QUAD_SLOT_FULL.hdd_offset
    mov DWORD PTR [rdi].QUAD_SLOT_FULL.dma_overlapped.OffsetLow, eax
    mov ecx, 32
    shr rax, cl
    mov DWORD PTR [rdi].QUAD_SLOT_FULL.dma_overlapped.OffsetHigh, eax
...
ConflictDetector_Initialize PROC
    push rbx
    push rsi
    push rdi
    push r12
...
; Register resource
ConflictDetector_RegisterResource PROC
...
ConflictDetector_LockResource PROC
...
ConflictDetector_CheckDeadlock PROC
