...
RING_BUFFER STRUCT ALIGN(4096)
    ...
    SegmentLocks        QWORD RING_SEGMENT_COUNT DUP (?)  ; Per-segment locks
...
;------------------------------------------------------------------------------
ENGINE_CONTEXT STRUCT ALIGN(64)
...
;------------------------------------------------------------------------------
STREAM_CONTEXT STRUCT ALIGN(64)
    StreamId            QWORD ?
...
;------------------------------------------------------------------------------
TITAN_ORCHESTRATOR STRUCT ALIGN(4096)
    ; Magic and version
    ...
    Engines             ENGINE_CONTEXT ENGINE_TYPE_COUNT DUP (<>)
