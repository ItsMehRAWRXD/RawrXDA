...
AGENT_CONTEXT STRUCT
    ...
    inference_engine    DB SIZEOF INFERENCE_ENGINE DUP(?)
    gen_context         DB SIZEOF GENERATION_CONTEXT DUP(?)
    ...
    metrics             DB SIZEOF AGENT_METRICS DUP(?)
...
RegisterTool PROC FRAME
    ...
    lea r10, [rcx].TOOL_DEFINITION.name
    push rcx
    mov rcx, r10
    mov rdx, rdi
    call lstrcpyA
