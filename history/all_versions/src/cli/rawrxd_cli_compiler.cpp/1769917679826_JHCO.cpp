            ...
            ext == ".py" || ext == ".js" || ext == ".ts") {
             ...
             if (options.useAI) {
                 ...
                 if (!brokenSource.empty()) {
                     ...
                     std::string fixedSource = ModelCaller::generateRewrite(
                         brokenSource, 
...
public:
    ...
    void showHelp() const {
        std::cout << m_appName << " - " << m_description << "\n\n";
        std::cout << "Usage: " << m_appName << " [options] file...\n\n";
        std::cout << "Options:\n";
        for (const auto& opt : m_options) {
            std::cout << "  ";
    ...
    void showVersion() const {
        std::cout << m_appName << " version " << VERSION << "\n";
    }
