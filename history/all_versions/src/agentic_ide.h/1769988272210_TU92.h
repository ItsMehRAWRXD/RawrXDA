...
// Definitions moved to CommonTypes.h
...
private:
    ...
    std::unique_ptr<RawrXD::MultiTabEditor> m_multiTabEditor;
    std::unique_ptr<RawrXD::ChatInterface> m_chatInterface;
...
} // namespace RawrXD// Modern error handling
enum class IDEError {
    Success = 0,
    InitializationFailed,
    ComponentNotFound,
...
private:
    ...
    std::mutex m_queueMutex; // Protects queue
