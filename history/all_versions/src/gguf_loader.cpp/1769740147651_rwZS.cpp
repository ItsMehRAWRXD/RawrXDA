...
#include <iostream>
#include <sstream>
// ggml stores bf16 values as 16-bit payloads.
// typedef uint16_t ggml_bf16_t;  // Already defined in gguf_loader.h
...
\n\nbool GGUFLoader::ParseHeader() {
    ...
    if (header_.version != 3) {
        std::cout << "[GGUFLoader] Loading legacy GGUF version " << header_.version
                  << " (compat mode)" << std::endl;
    }
...
bool GGUFLoader::ParseMetadata() {
    ...
    for (uint64_t i = 0; i < header_.tensor_count; ++i) {
        ...
        // Detect deprecated or out-of-range types and trigger conversion workflow.
        const bool is_deprecated_type =
            (type_val == 4 || type_val == 5 ||
             type_val == 31 || type_val == 32 || type_val == 33 ||
             type_val == 36 || type_val == 37 || type_val == 38);
        const bool is_out_of_range = type_val >= static_cast<uint32_t>(GGMLType::COUNT);

        if (is_deprecated_type || is_out_of_range) {
...
uint64_t GGUFLoader::CalculateTensorSize(const std::vector<uint64_t>& shape, GGMLType type) const {
    ...
    switch (type) {
        ...
        case GGMLType::F16:
            return num_elements * sizeof(ggml_half);
        case GGMLType::BF16:
            return num_elements * sizeof(ggml_bf16_t);
        case GGMLType::F64:
            return num_elements * sizeof(double);
        case GGMLType::I8:
            return num_elements * sizeof(int8_t);
        case GGMLType::I16:
            return num_elements * sizeof(int16_t);
        case GGMLType::I32:
            return num_elements * sizeof(int32_t);
        case GGMLType::I64:
            return num_elements * sizeof(int64_t);

        case GGMLType::Q4_0:
            return block_aligned_size(QK4_0, sizeof(block_q4_0));
        case GGMLType::Q4_1:
            return block_aligned_size(QK4_1, sizeof(block_q4_1));
        case GGMLType::Q5_0:
            return block_aligned_size(QK5_0, sizeof(block_q5_0));
        case GGMLType::Q5_1:
            return block_aligned_size(QK5_1, sizeof(block_q5_1));
        case GGMLType::Q8_0:
            return block_aligned_size(QK8_0, sizeof(block_q8_0));
        case GGMLType::Q8_1:
            return block_aligned_size(QK8_1, sizeof(block_q8_1));
        case GGMLType::MXFP4:
            return block_aligned_size(QK_MXFP4, sizeof(block_mxfp4));

        case GGMLType::Q2_K:
            return block_aligned_size(QK_K, sizeof(block_q2_K));
        case GGMLType::Q3_K:
            return block_aligned_size(QK_K, sizeof(block_q3_K));
        case GGMLType::Q4_K:
            return block_aligned_size(QK_K, sizeof(block_q4_K));
        case GGMLType::Q5_K:
            return block_aligned_size(QK_K, sizeof(block_q5_K));
        case GGMLType::Q6_K:
            return block_aligned_size(QK_K, sizeof(block_q6_K));
        case GGMLType::Q8_K:
            return block_aligned_size(QK_K, sizeof(block_q8_K));

        case GGMLType::IQ2_XXS:
            return block_aligned_size(QK_K, sizeof(block_iq2_xxs));
        case GGMLType::IQ2_XS:
            return block_aligned_size(QK_K, sizeof(block_iq2_xs));
        case GGMLType::IQ3_XXS:
            return block_aligned_size(QK_K, sizeof(block_iq3_xxs));
        case GGMLType::IQ1_S:
            return block_aligned_size(QK_K, sizeof(block_iq1_s));
        case GGMLType::IQ4_NL:
            return block_aligned_size(QK4_NL, sizeof(block_iq4_nl));
        case GGMLType::IQ3_S:
            return block_aligned_size(QK_K, sizeof(block_iq3_s));
        case GGMLType::IQ2_S:
            return block_aligned_size(QK_K, sizeof(block_iq2_s));
        case GGMLType::IQ4_XS:
            return block_aligned_size(QK_K, sizeof(block_iq4_xs));
        case GGMLType::IQ1_M:
            return block_aligned_size(QK_K, sizeof(block_iq1_m));

        case GGMLType::TQ1_0:
            return block_aligned_size(QK_K, sizeof(block_tq1_0));
        case GGMLType::TQ2_0:
            return block_aligned_size(QK_K, sizeof(block_tq2_0));

        default:
            throw std::runtime_error("Unsupported tensor type: " + GetTypeString(type));
    }
}
...
bool GGUFLoader::SetCompressionType(GGUFCompressionType type) {
...
bool GGUFLoader::DecompressData(const std::vector<uint8_t>& compressed, 
                                 std::vector<uint8_t>& decompressed) {
    if (compression_type_ == GGUFCompressionType::NONE) {
    ...
    try {
        switch (compression_type_) {
            case GGUFCompressionType::BRUTAL_GZIP:
            case GGUFCompressionType::ZLIB: {
            ...
            case GGUFCompressionType::DEFLATE: {
...
static std::string GetUnsupportedTypeNameByValue(uint32_t type_val) {
    switch (type_val) {
        case 4:   return "DEPRECATED_Q4_2";
        case 5:   return "DEPRECATED_Q4_3";
        ...
        case 30:  return "BF16";
        case 31:  return "DEPRECATED_Q4_0_4_4";
        case 32:  return "DEPRECATED_Q4_0_4_8";
        case 33:  return "DEPRECATED_Q4_0_8_8";
        case 34:  return "TQ1_0";
        case 35:  return "TQ2_0";
        case 36:  return "DEPRECATED_IQ4_NL_4_4";
        case 37:  return "DEPRECATED_IQ4_NL_4_8";
        case 38:  return "DEPRECATED_IQ4_NL_8_8";
        case 39:  return "MXFP4";
        default:  return "UNKNOWN_TYPE_" + std::to_string(type_val);
    }
}
