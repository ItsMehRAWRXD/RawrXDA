...
struct Color {
    ...
    Color lighter(int factor = 150) const {
        ...
        int r_ = std::min(255, (int)(r * factor / 100));
        int g_ = std::min(255, (int)(g * factor / 100));
        int b_ = std::min(255, (int)(b * factor / 100));
    ...
    Color darker(int factor = 200) const {
        ...
        int r_ = std::max(0, (int)(r * 100 / factor));
        int g_ = std::max(0, (int)(g * 100 / factor));
        int b_ = std::max(0, (int)(b * 100 / factor));
        return Color(r_, g_, b_, a);
    }
