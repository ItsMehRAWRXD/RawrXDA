...
═══════════════════════════════════════════════════════════════════════════════
    ...
    void WriteDriveTopology(std::ostream& out) {
        ...
        const char* driveRoles[] = {
            ...
            "Model Shard A (Q Tensors)",
            "Model Shard B (K Tensors)",
            "Model Shard C (V Tensors)",
            "Output Heads + Embeddings"
        };
    ...
    void WritePerformanceMetrics(std::ostream& out) {
        ...
        out << "Theoretical Peaks (800B Model):" << std::endl;
        out << "  • Cold-Load Target:            3.7 ms (with GHOST-MAP)" << std::endl;
        out << "  • Effective VRAM:              80 GB (5-drive virtualized)" << std::endl;
        out << "  • PCIe Saturation:             96% (Direct BAR + SDMA)" << std::endl;
