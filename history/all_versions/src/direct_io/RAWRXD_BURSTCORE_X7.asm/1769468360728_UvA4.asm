...
EXTERN GetTensorMetadata:PROC             ; rcx = tensor_id → rax=offset, rdx=size (returned in RAX/RDX struct)
...
.const
ZoneLimit      EQU 64                     ; Max zone slots
LaneCount      EQU 4                      ; SIMD-style burst lanes
...
_loop:
    ...
    ; Get metadata
    mov rcx, r12
    call GetTensorMetadata   ; rax=offset, rdx=size
    mov r13, rax             ; offset
    mov r14, rdx             ; size
