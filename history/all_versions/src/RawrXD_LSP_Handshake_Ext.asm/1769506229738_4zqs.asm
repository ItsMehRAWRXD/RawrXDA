...
; Server profiles
align 16
ServerProfiles          SERVER_PROFILE \
    <SERVER_CLANGD, 0, offset ClangdStrings, 2, 0, offset ClangdInitTemplate, ClangdInitTemplateLen, 0FFFh, 0, 0>, \
    <SERVER_PYRIGHT, 0, offset PyrightStrings, 2, 0, offset PyrightInitTemplate, PyrightInitTemplateLen, 7FFh, 1h, 0>, \
    <SERVER_RUST_ANALYZER, 0, offset RustAnalyzerStrings, 1, 0, offset RustAnalyzerInitTemplate, RustAnalyzerInitTemplateLen, 1FFFh, 0, 0>, \
    <SERVER_TYPESCRIPT, 0, offset TypeScriptStrings, 1, 0, offset TypeScriptInitTemplate, TypeScriptInitTemplateLen, 0FFFh, 0, 0>, \
    <SERVER_GOLANG, 0, offset GolangStrings, 1, 0, offset GolangInitTemplate, GolangInitTemplateLen, 0FFFh, 0, 0>, \
    <SERVER_ZIG, 0, offset ZigStrings, 1, 0, offset ZigInitTemplate, ZigInitTemplateLen, 7FFh, 0, 0>
