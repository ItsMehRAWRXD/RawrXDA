...
; =============================================================================
; Defense-in-Depth license enforcement layer:
;   1. Direct PEB anti-debug (bypasses API hooks/detours)
;   2. Hardware-locked challenge-response (CPUID + Volume serial XOR mix)
;   3. AES-NI kernel entry point decryption (800B shim)
