...
QUADBUF_CTX STRUCT 8
    ...
    width           DD      ?               ; Client width in pixels
    height          DD      ?               ; Client height in pixels
...
asm_quadbuf_init PROC FRAME
    ...
    mov     DWORD PTR [g_qb_ctx.width], eax
    mov     eax, DWORD PTR [rsp+48+12]      ; bottom
    mov     DWORD PTR [g_qb_ctx.height], eax
    ...
    mov     rcx, rbx                        ; hdc
    mov     edx, DWORD PTR [g_qb_ctx.width]
    mov     r8d, DWORD PTR [g_qb_ctx.height]
    ...
    mov     eax, DWORD PTR [g_qb_ctx.width]
...
asm_quadbuf_render_frame PROC FRAME
    ...
    mov     eax, DWORD PTR [g_qb_ctx.height]
...
@@token_loop:
    ...
    add     eax, ecx
    cmp     eax, DWORD PTR [g_qb_ctx.width]
    jl      @@no_wrap
    ...
    cmp     eax, DWORD PTR [g_qb_ctx.height]
    jl      @@no_wrap
...
@@tokens_done:
    ...
    xor     edx, edx                        ; xDest = 0
    xor     r8d, r8d                        ; yDest = 0
    mov     r9d, DWORD PTR [g_qb_ctx.width] ; nWidth
...
@@render_loop:
    ...
    ; Wait for tokens or timeout (16ms for 60 FPS)
    mov     rcx, QWORD PTR [g_qb_ctx.hRenderEvent]
    test    rcx, rcx
    jz      @@sleep_fallback
    mov     edx, FRAME_INTERVAL_MS
    call    WaitForSingleObject
    jmp     @@do_render

@@sleep_fallback:
    mov     ecx, FRAME_INTERVAL_MS
    call    Sleep
...
asm_quadbuf_resize PROC FRAME
    ...
    ; Update dimensions
    mov     DWORD PTR [g_qb_ctx.width], r12d
    mov     DWORD PTR [g_qb_ctx.height], r13d
