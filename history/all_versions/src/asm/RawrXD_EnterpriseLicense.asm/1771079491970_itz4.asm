...
; Environment variable for dev unlock
szDevEnvVar             BYTE "RAWRXD_ENTERPRISE_DEV", 0
...
szDbgDevUnlock          BYTE "[Enterprise] DEV UNLOCK ACTIVE (all features enabled)", 0Ah, 0
ENDIF
...
; Developer / License Creator unlock — bypasses license validation when
; environment variable RAWRXD_ENTERPRISE_DEV=1 is set.
; Grants all enterprise features (0xFF) for local testing.
;
; Returns: RAX = 1 if dev unlock active, 0 if not
; =============================================================================
