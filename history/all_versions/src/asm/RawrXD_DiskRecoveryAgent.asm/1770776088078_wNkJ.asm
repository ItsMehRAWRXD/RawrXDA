...
.data?
    ...
    ; Transfer buffer, page-aligned for DMA
    align 4096
...
ConsolePrint PROC
    push rbx
    push rsi
    sub  rsp, 48              ; Shadow + local bytesWritten
    ...
    mov  qword ptr [rsp+40], 0 ; lpOverlapped = NULL (stack arg 5)
    call WriteFile
...
ScsiInquiryQuick PROC
    ...
    mov  dword ptr [rsp+40], SPTD_WITH_SENSE         ; nOutBufferSize
    lea  rax, bytesRet
