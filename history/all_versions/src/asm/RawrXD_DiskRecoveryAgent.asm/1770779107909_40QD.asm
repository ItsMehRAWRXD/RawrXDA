...
DiskRecovery_Main PROC
    ...
    push rbx
    push r12
    sub  rsp, 40              ; 2 pushes (16) + 40 = 56 ≡ 8 mod 16 from entry
                              ; As /entry: RSP ≡ 0 mod 16 → 0-16-40 = -56 ≡ 8 mod 16
                              ; As C call:  RSP ≡ 8 mod 16 → 8-16-40 = -48 ≡ 0 mod 16
                              ; Use sub 48 for entry point correctness:
    add  rsp, 40              ; Undo the sub above
    sub  rsp, 48              ; 2 pushes (16) + 48 = 64 → entry: 0-64=0 mod 16 ✓
