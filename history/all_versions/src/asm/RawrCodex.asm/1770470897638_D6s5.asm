...
@@disasm_loop:
    ...
    mov eax, DWORD PTR [rsp + OFFSET RAWRINSTRUCTION.instrLen]
    add r14d, eax
...
@@ascii_break:
    ...
    movsxd rax, eax
    mov [rsp + OFFSET RAWRSTRING.fileOff], rax
    mov [rsp + OFFSET RAWRSTRING.strLen], ecx
    ...
    mov rsi, [rbx].RAWRCODEX_CTX.pFileBase
    mov rax, [rsp + 24 + OFFSET RAWRSTRING.fileOff]
    add rsi, rax
    xor ecx, ecx
    mov edx, [rsp + 24 + OFFSET RAWRSTRING.strLen]
    cmp edx, 255
    jle @@copy_str_ok
    mov edx, 255
@@copy_str_ok:
