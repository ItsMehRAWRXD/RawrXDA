...
streaming_metrics   StreamingMetrics <>       ; C-ABI-compatible metrics struct
...
_SO_standalone_main PROC
    ...
    lea rcx, norm_shader
    mov rdx, OP_NORM
    movzx r8, DWORD PTR [exec_header].ExecHeader.operator_count
    ...
    movzx rdx, DWORD PTR [exec_header].ExecHeader.operator_count
    ...
    lea rcx, layer_table
    movzx rdx, DWORD PTR [exec_header].ExecHeader.layer_count
...
LoadExecFile PROC
    ...
    cmp rax, 584543494F524157h    ; "RawrXD-Exec"
    jne load_fail
...
CreateRMSNormPipeline PROC
    ...
    mov [rsi].VkShaderModuleCreateInfo.pCode, [rbx].ShaderModule.codePtr
...
PrintString PROC
    ...
    invoke WriteFile, STD_OUTPUT_HANDLE, rbx, eax, r9, 0
    pop rbx
    ret
PrintString ENDP
...
PrintError PROC
    ...
    invoke lstrlenA, rbx
    lea r9, bytes_written
    invoke WriteFile, STD_ERROR_HANDLE, rbx, eax, r9, 0
    pop rbx
    ret
PrintError ENDP
