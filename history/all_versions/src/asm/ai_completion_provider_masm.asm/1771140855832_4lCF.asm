...
@@score_loop:
    ...
    ; Properly reduce zmm2 to scalar
    vextractf64x4 ymm3, zmm2, 1    ; Extract upper half to ymm3
    vaddps  ymm2, ymm2, ymm3       ; Add halves
    vextractf32x4 xmm3, ymm2, 1    ; Extract upper half to xmm3  
...
@@max_done:
    ...
    xor     r11, r11
    vbroadcastss zmm2, xmm1         ; Max in all lanes
