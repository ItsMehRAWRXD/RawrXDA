...
ShellInteg_ReadOutput PROC FRAME
    ...
    lea     rax, [rsp + 48]         ; &totalBytesAvail
    sub     rsp, 48
    mov     qword ptr [rsp + 32], rax
    mov     qword ptr [rsp + 40], 0 ; lpBytesLeftThisMessage = NULL
    call    PeekNamedPipe
    add     rsp, 48
    test    eax, eax
    jz      @si_read_pipe_err
    ...
    mov     eax, dword ptr [rsp + 48]   ; totalBytesAvail
    test    eax, eax
    jz      @si_read_empty
...
@si_read_no_term:
    ...
    ; Increment commands-detected counter
