...
@@avx2_jt_k:
    ...
    movsxd  rbx, ebx
    vmovss  xmm1, dword ptr [rsi + r8 + rbx*4]
    ; B[k, j]
    movsxd  r8, ebx
    imul    r8, r13                     ; k * ldb_bytes
    movsxd  rbx, edx
    vmovss  xmm2, dword ptr [rdi + r8 + rbx*4]
...
@@avx2_it_k:
    ...
    imul    rbx, r11
    movsxd  rax, eax
    vmovss  xmm1, dword ptr [rsi + rbx + rax*4]
    ; B[k, j]
    movsxd  rbx, eax
    imul    rbx, r13
    movsxd  rax, edx
    vmovss  xmm2, dword ptr [rdi + rbx + rax*4]
    vfmadd231ss xmm0, xmm1, xmm2
...
@@avx512_it_k:
    ...
    movsxd  r8, edx
    shl     r8, 2
    vmovss  xmm2, dword ptr [rdi + rax + r8]
    vfmadd231ss xmm0, xmm1, xmm2
    add     rbx, 4
    inc     eax
    jmp     @@avx512_it_k
...
@@avx512_gemv_4row_reduce:
    ...
    ; zmm0 → xmm0[0]
    vextractf32x8 ymm16, zmm0, 1
    vaddps  ymm0, ymm0, ymm16
    vextractf128 xmm16, ymm0, 1
    vaddps  xmm0, xmm0, xmm16
    vhaddps xmm0, xmm0, xmm0
    vhaddps xmm0, xmm0, xmm0

    vextractf32x8 ymm16, zmm1, 1
    vaddps  ymm1, ymm1, ymm16
    vextractf128 xmm16, ymm1, 1
    vaddps  xmm1, xmm1, xmm16
    vhaddps xmm1, xmm1, xmm1
    vhaddps xmm1, xmm1, xmm1

    vextractf32x8 ymm16, zmm2, 1
    vaddps  ymm2, ymm2, ymm16
    vextractf128 xmm16, ymm2, 1
    vaddps  xmm2, xmm2, xmm16
    vhaddps xmm2, xmm2, xmm2
    vhaddps xmm2, xmm2, xmm2

    vextractf32x8 ymm16, zmm3, 1
    vaddps  ymm3, ymm3, ymm16
    vextractf128 xmm16, ymm3, 1
    vaddps  xmm3, xmm3, xmm16
    vhaddps xmm3, xmm3, xmm3
    vhaddps xmm3, xmm3, xmm3
