...
#else
    // Non-Windows: loadKeyFromFile not implemented in minimal IDE/Phase 4 build; use loadKeyFromMemory or license server.
    (void)path;
    return LicenseResult::error("loadKeyFromFile not implemented on this platform");
#endif
}
