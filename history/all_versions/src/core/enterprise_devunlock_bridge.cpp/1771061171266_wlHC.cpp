...
// ============================================================================
// The ASM module (RawrXD_EnterpriseLicense.asm) exports 12 symbols but does
// NOT export Enterprise_DevUnlock. The C++ stubs file provides it but is
// compiled out when RAWR_HAS_MASM=1.
//
// This bridge file provides Enterprise_DevUnlock when RAWR_HAS_MASM=1 (i.e.
// when the stubs are disabled). When stubs ARE active (!RAWR_HAS_MASM),
// this file compiles to nothing to avoid duplicate symbols.
//
// NO SOURCE FILE IS TO BE SIMPLIFIED.
// ============================================================================

// Only compile when RAWR_HAS_MASM is active (stubs are disabled)
