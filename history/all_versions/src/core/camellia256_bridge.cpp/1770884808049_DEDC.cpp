...
CamelliaResult Camellia256Bridge::initialize() {
    ...
    return CamelliaResult::ok("Camellia-256 initialized (HWID-derived key, SHA-256 KDF, Shadow-Page Detour active)");
}
...
CamelliaResult Camellia256Bridge::shutdown() {
    ...
    // Shutdown the SelfRepairLoop first — this rolls back all active
