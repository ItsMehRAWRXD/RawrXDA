...
int32_t  FlashAttention_CheckAVX512()                                { return 0; }   // No AVX-512
int32_t  FlashAttention_Init()                                       { return 0; }   // No AVX-512
int32_t  FlashAttention_Forward(void* /*cfg*/)                       { return -1; }  // Not available
int32_t  FlashAttention_GetTileConfig(void* out)                     {
    if (out) {
        // Zero out the tile config struct (16 bytes: 4 x int32)
