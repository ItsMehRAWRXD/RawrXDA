...
std::string EnterpriseFeatureManager::GenerateAuditReport() const {
    ...
    ss << "═══════════════════════════════════════════════════════════════\n";
    ss << "  [-] main.cpp does NOT call EnterpriseLicense::Initialize()\n";
    ss << "  [-] main.cpp does NOT call EnterpriseFeatureManager::Initialize()\n";
    ss << "  [-] Swarm orchestrator has no license gate check\n";
    ss << "  [-] GPU kernel auto-tuner has no license gate check\n";
    ss << "  [-] No /license REPL command for runtime license inspection\n";
