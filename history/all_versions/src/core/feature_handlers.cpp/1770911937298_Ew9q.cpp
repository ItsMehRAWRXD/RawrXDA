...
// ============================================================================
static struct BackendCfgState {
    std::mutex mtx;
    struct BackendEntry { std::string name; bool available = false; };
    std::vector<BackendEntry> backends = {
        {"Ollama (local)", false}, {"OpenAI", false}, {"Anthropic", false}, {"HuggingFace", false}
    };
