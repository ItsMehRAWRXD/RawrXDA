...
// ============================================================================
// WIN32 COMMAND IDs — CANONICAL values from Win32IDE_Commands.cpp
// ============================================================================
// These MUST match the IDs in Win32IDE_Commands.cpp (the range-based router).
// The routeCommand() ranges are:
//   1000-1999 → handleFileCommand     4100-4399 → handleAgentCommand
//   2000-2999 → handleEditCommand     5000-5999 → handleToolsCommand
//   3000-3999 → handleViewCommand     6000-6999 → handleModulesCommand
//   4000-4099 → handleTerminalCommand 7000-7999 → handleHelpCommand
//   8000-8999 → handleGitCommand      9000-9999 → various handlers
// ============================================================================

// ── File: 1000-1099 (from Win32IDE_Commands.cpp) ──
#define IDM_FILE_NEW_R             1001
#define IDM_FILE_OPEN_R            1002
#define IDM_FILE_SAVE_R            1003
#define IDM_FILE_SAVE_AS_R         1004
#define IDM_FILE_SAVE_ALL_R        1005
