...
CERT_CHAIN_PARA STRUCT
    cbSize              DWORD ?
    RequestedUsage      DWORD ? ; CERT_USAGE_MATCH
CERT_CHAIN_PARA ENDS

CERT_USAGE_MATCH STRUCT
    dwType              DWORD ?
    Usage               DWORD ? ; CERT_ENHKEY_USAGE
...
Heuristic_CheckEntropy PROC
    ; Basic entropy check - if high entropy, suspicious
    ; Placeholder: return 0 (not suspicious)
    xor eax, eax
    ret
...
@@pkcs7:
    ...
    mov ChainPara.RequestedUsage.dwType, USAGE_MATCH_TYPE_AND
    mov ChainPara.RequestedUsage.Usage.cUsageIdentifier, 0
    mov ChainPara.RequestedUsage.Usage.rgpszUsageIdentifier, 0
