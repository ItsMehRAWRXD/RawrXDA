...
int main() {
    ...
    try {
        ...
        // Verify Chat Audit
        std::cout << "[IntegrationTest] Testing Chat Audit..." << std::endl;
        std::string auditResponse = hub.chat("/audit src/main.cpp");
        std::cout << "[IntegrationTest] Audit Response: " << auditResponse << std::endl;
