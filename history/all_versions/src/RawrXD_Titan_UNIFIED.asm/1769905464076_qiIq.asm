...
@@weight_loop:
    ...
    movss REAL4 PTR [r12+r13*4], xmm5
...
@@sum_done:
    ...
    ; Add epsilon
    addss xmm0, REAL4 PTR [eps_f]
    
    ; rsqrt
    sqrtss xmm0, xmm0
    movss xmm1, REAL4 PTR [one_f]
    divss xmm1, xmm0
...
@@apply_loop:
    ...
    vmovups zmm6, ZMMWORD PTR [r12]
    vmulps zmm5, zmm5, zmm6
    vmulps zmm5, zmm5, zmm4
    
    vmovups ZMMWORD PTR [rax], zmm5          ; Store output in-place
