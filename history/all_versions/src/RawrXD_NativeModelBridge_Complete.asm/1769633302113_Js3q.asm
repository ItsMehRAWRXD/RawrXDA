...
LoadModelNative PROC USES rbx lpPath:QWORD, ppContext:QWORD
    ...
    mov qword ptr [rbx], hFile
    mov qword ptr [rbx + 8], hMapping
    mov qword ptr [rbx + 16], pBase
    mov qword ptr [rbx + 24], fileSize
...
@@q2_k_group:
    ...
    mov ecx, r13
    shr ecx, 1
    movzx ecx, byte ptr [rsi + 128 + rcx]
...
@@q4_k_scales:
    ...
    mov ecx, r13d
    sub ecx, 4
    movzx eax, byte ptr [rsi + 4 + rcx + 4]
    and eax, 0Fh
    mov r14d, eax
    
    movzx eax, byte ptr [rsi + 4 + r13]
    shr eax, 6
    shl eax, 4
    or r14d, eax
