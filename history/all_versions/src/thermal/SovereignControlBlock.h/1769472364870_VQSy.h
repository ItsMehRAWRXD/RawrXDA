...
struct alignas(64) SovereignControlBlock {
    ...
    // Offset constants for MASM access
    static constexpr size_t OFFSET_MAGIC = offsetof(SovereignControlBlock, magic);
    static constexpr size_t OFFSET_VERSION = offsetof(SovereignControlBlock, version);
    static constexpr size_t OFFSET_SEQUENCE = offsetof(SovereignControlBlock, sequenceNumber);
    static constexpr size_t OFFSET_TIMESTAMP = offsetof(SovereignControlBlock, lastUpdateTime);
    static constexpr size_t OFFSET_BURST_MODE = offsetof(SovereignControlBlock, burstMode);
    static constexpr size_t OFFSET_ACTIVE_DRIVES = offsetof(SovereignControlBlock, activeDrives);
    static constexpr size_t OFFSET_NVME_TEMPS = offsetof(SovereignControlBlock, nvmeTemps);
    static constexpr size_t OFFSET_GPU_TEMP = offsetof(SovereignControlBlock, gpuTemp);
    static constexpr size_t OFFSET_CPU_TEMP = offsetof(SovereignControlBlock, cpuTemp);
    static constexpr size_t OFFSET_THERMAL_THRESHOLD = offsetof(SovereignControlBlock, thermalThreshold);
    static constexpr size_t OFFSET_THROTTLE = offsetof(SovereignControlBlock, throttle);
    static constexpr size_t OFFSET_SOFT_THROTTLE = offsetof(SovereignControlBlock, softThrottleValue);
    static constexpr size_t OFFSET_HEADROOM = offsetof(SovereignControlBlock, thermalHeadroom);
    static constexpr size_t OFFSET_PREDICTION_VALID = offsetof(SovereignControlBlock, predictionValid);
    static constexpr size_t OFFSET_DRIVE_CMD = offsetof(SovereignControlBlock, driveCmd);
    static constexpr size_t OFFSET_DRIVE_LOADS = offsetof(SovereignControlBlock, driveLoads);
    static constexpr size_t OFFSET_PREDICTION = offsetof(SovereignControlBlock, prediction);
    static constexpr size_t OFFSET_AUTH = offsetof(SovereignControlBlock, auth);
};
#pragma pack(pop)

// Verify structure size at compile time
static_assert(sizeof(SovereignControlBlock) == 512, 
