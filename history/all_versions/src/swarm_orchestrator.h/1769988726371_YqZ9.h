...
// struct SwarmTask moved to CommonTypes.h or used from there. But wait, CommonTypes one is simple.
// The one here has context and a promise. Let's rename this one to InternalSwarmTask or similar to avoid conflict.
