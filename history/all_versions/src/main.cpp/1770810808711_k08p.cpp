...
// Auto-generated command registry (250+ GUI→CLI bridge)
...
╚══════════════════════════════════════════════════════════════╝
    ...
    // Initialize auto-registered commands (extends SharedFeatureRegistry
    // with all GUI-only IDM_* commands, making them CLI-accessible)
