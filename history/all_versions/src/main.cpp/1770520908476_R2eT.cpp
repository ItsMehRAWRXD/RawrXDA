...
║  Phase 25: AMD GPU Toggle • Sandbox • 800B Streaming Quant  ║
╚══════════════════════════════════════════════════════════════╝
)" << std::endl;
...
REPL Commands:
  ...
  exit                      Quit
    ...
    {
        auto r = swarmBridge.initialize();
        std::cout << "[SYSTEM] Swarm Decision Bridge: " << r.detail << "\n";
    }
    ...
    {
        auto r = modelHotpatcher.initialize();
        std::cout << "[SYSTEM] Universal Model Hotpatcher: " << r.detail << "\n";
    }
    ...
    {
        auto r = releaseEngine.initialize();
        std::cout << "[SYSTEM] Production Release Engine: " << r.detail
                  << " gates=" << releaseEngine.getLicenseGateCount() << "\n";
    }
