        ...
        while (true) {
            ...
            // ── Phase 33: Voice Chat Commands ──
                ...
                std::cout << "[Voice Metrics]\n"
                          << "  Recordings:    " << m.recordingCount.load() << "\n"
                          << "  Playbacks:     " << m.playbackCount.load() << "\n"
                          << "  Transcriptions:" << m.transcriptionCount.load() << "\n"
                          << "  TTS Calls:     " << m.ttsCount.load() << "\n"
                          << "  Errors:        " << m.errorCount.load() << "\n"
                          << "  Bytes Recorded:" << m.bytesRecorded.load() << "\n"
                          << "  VAD Events:    " << m.vadSpeechEvents.load() << "\n";
            }
            else {
