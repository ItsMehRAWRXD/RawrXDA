    ...
    if (enable_repl) {
        ...
        while (true) {
            ...
            // ═══════════════════════════════════════════════════════════
                ...
                if (active) {
                    std::cout << "  Max model size: " << RawrXD::EnterpriseLicense::GetMaxModelSizeGB() << " GB\n";
                    std::cout << "  800B unlocked: " << (RawrXD::EnterpriseLicense::Is800BUnlocked() ? "Yes" : "No") << "\n";
                } else {
                ...
                std::cout << "  Max context: " << RawrXD::EnterpriseLicense::GetMaxContextLength() << " tokens\n";
                if (!active) {
