...
private:
    ...
    // Phase 10 Operations
    IncidentResponseCoordinator* m_incidentCoordinator;
    RunbookExecutor* m_runbookExecutor;
    MetricAnomalyDetector* m_anomalyDetector;
    SLOTracker* m_sloTracker;
    PostmortemGenerator* m_postmortemGenerator;
