...
// Agentic/AI Menu (900-999)
#define IDM_AI_CHAT             901
#define IDM_AI_GENERATE         902
#define IDM_AI_EXPLAIN          903
#define IDM_AI_REFACTOR         904
#define IDM_AI_AGENT_LOOP       905
#define IDM_AI_AUTODIGEST       906
#define IDM_AI_TITAN_SLOTS      907
...
private:
    ...
    int GetUserInputLineNumber() const;
    void NavigateToLine(int lineNumber);
    void LogNavigationAction(const std::string& action, int lineNumber);
    void ToggleCommentForCurrentLanguage();
    void ExpandSelectionIntelligently();
    void ShrinkSelectionIntelligently();
    ...
    // Chat / AI state
    RawrXD::Backend::OllamaClient m_ollama{ "http://localhost:15099" };
