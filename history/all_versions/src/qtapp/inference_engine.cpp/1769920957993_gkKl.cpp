...
std::string InferenceEngine::analyzeCode(const std::string& code)
{
    ...
    analysis += "- Length: " + std::to_string(length) + " chars\n";
    analysis += "- Lines: " + std::to_string(lines) + "\n";
    analysis += "- Tokens: " + std::to_string(tokenCount) + "\n";
    analysis += "- Est. Complexity: " + std::to_string(complexity);
