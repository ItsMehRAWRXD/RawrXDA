...
// Prevent D3D11_1 from being included if we're already including D3D11
#ifndef _D3D11_1_H_
#define _D3D11_1_H_DISABLE
#endif

// Include d3d11 headers in correct order to avoid type conflicts
...
// Re-enable D3D11_1 if it wasn't originally disabled
#ifdef _D3D11_1_H_DISABLE
#undef _D3D11_1_H_DISABLE
#undef _D3D11_1_H_
#endif
