...
void AgenticObservability::logDebug(
    ...
    const nlohmann::json& context)
{
    log(LogLevel::DEBUG_LEVEL, component, message, context);
}
...
void AgenticObservability::logInfo(
    ...
    const nlohmann::json& context)
{
    log(LogLevel::INFO_LEVEL, component, message, context);
}
...
void AgenticObservability::logWarn(
    ...
    const nlohmann::json& context)
{
    log(LogLevel::WARN_LEVEL, component, message, context);
}
    ...
    const TimePoint& endTime) const
{
    ...
    report << "LOGS:\n";
    auto logs = getLogs(100, LogLevel::DEBUG_LEVEL);
