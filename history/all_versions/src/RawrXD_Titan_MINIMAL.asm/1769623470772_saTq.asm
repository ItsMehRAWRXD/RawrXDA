...
Quant_Q2K_Deblock PROC FRAME
    ...
    ; Process 128 weights from 2-bit quantized block
    xor r13d, r13d
...
@@loop:
    ...
    ; Load byte and extract 2-bit quant value
    mov rax, r13
    shr rax, 2
    ...
    ; Store (simplified - no actual scale in this skeleton)
...
@@sum_loop:
    ...
    vmovups zmm1, ZMMWORD PTR [rcx + rax*64]
