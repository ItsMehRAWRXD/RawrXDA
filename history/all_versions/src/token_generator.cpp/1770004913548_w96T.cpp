...
RawrXD::Expected<std::wstring, RawrXD::TokenError> TokenGenerator::utf8ToWide(const std::string&) { return L""; }
RawrXD::Expected<std::string, RawrXD::TokenError> TokenGenerator::wideToUtf8(const std::wstring&) { return ""; }
