    ...
    try {
        ...
        if (prefix.find("void ") != std::string::npos || prefix.find("int ") != std::string::npos) {
             if (prefix.back() == '{') {
                 ...
                 // Generate compilable stub based on return type guess
                 if (prefix.find("int ") != std::string::npos) completion += "    return 0;\n";
                 else if (prefix.find("bool ") != std::string::npos) completion += "    return false;\n";
                 else if (prefix.find("std::string") != std::string::npos || prefix.find("String") != std::string::npos) completion += "    return \"\";\n";
                 else if (prefix.find("void ") != std::string::npos) completion += "    return;\n";
                 else completion += "    return {}; // Default-constructed\n";
                 completion += "}";
             } else if (prefix.back() == '(') {
                 completion += ") {\n";
