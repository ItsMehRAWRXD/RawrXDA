 ...
 *
 * Key fix: std::future is retained in ChainStep until completion,
...
// ============================================================================
// ChainStep — holds a future alive until the LLM response completes.
...
public:
    ...
    ChainStep() = default;
    explicit ChainStep(const std::string& name) : m_name(name) {}
    ~ChainStep();
...
// ============================================================================
// ChainExecutor — runs a sequence of ChainSteps, holding all futures alive
// ============================================================================
class ChainExecutor {
public:
