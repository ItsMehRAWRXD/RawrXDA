...
int main(int argc, char* argv[]) {
    ...
    output["load_time_ms"] = result.load_time_ms;
    output["inference_time_ms"] = result.inference_time_ms;
    output["tokens_generated"] = result.tokens_generated;
    output["tokens_per_sec"] = static_cast<float>(result.tokens_per_sec);
    output["avg_latency_ms"] = static_cast<float>(result.avg_latency_ms);
