...
static const V2WiringStatus g_v2Wiring[] = {
    ...
    { FeatureID::MemoryHotpatching,     true, true, true, false, true, true, false,1, "model_memory_hotpatch.cpp" },
    { FeatureID::ByteLevelHotpatching,  true, true, true, false, true, true, false,1, "byte_level_hotpatcher.cpp" },
    { FeatureID::ServerHotpatching,     true, true, true, false, true, false,false,1, "gguf_server_hotpatch.cpp" },
    { FeatureID::UnifiedHotpatchManager,true, true, true, false, true, true, false,1, "unified_hotpatch_manager.cpp" },
    ...
    { FeatureID::AgenticFailureDetect,  true, true, true, false, true, true, false,1, "agentic_failure_detector.cpp" },
    { FeatureID::AgenticPuppeteer,      true, true, true, false, true, true, false,1, "agentic_puppeteer.cpp" },
    { FeatureID::AgenticSelfCorrection, true, true, true, false, true, true, false,1, "agentic_self_corrector.cpp" },
    { FeatureID::ProxyHotpatching,      true, true, true, false, true, true, false,1, "proxy_hotpatcher.cpp" },
    { FeatureID::ServerSidePatching,    true, true, true, false, true, false,false,1, "gguf_server_hotpatch.cpp" },
...
static int cmdDevUnlock() {
    ...
    // V1 system — call the extern C bridge
