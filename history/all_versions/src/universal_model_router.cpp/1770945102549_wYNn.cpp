...
#include <cstdlib>
#include <algorithm>
#include "../include/local_reasoning_integration.h"
#include "../include/agentic/project_context.h"
                                      ...
                                      std::function<void(const std::string& chunk, bool complete)> callback)
{
    if (model_name.find("Reasoning") != std::string::npos) {
        ...
        std::string analysis = LocalReasoningIntegration::analyzeCurrentContext(prompt);
