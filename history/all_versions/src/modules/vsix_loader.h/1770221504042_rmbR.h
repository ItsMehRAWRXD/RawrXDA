...
private:
    ...
    VSIXLoader(); // Private constructor for singleton
    VSIXLoader(const VSIXLoader&) = delete; // Delete copy
    VSIXLoader& operator=(const VSIXLoader&) = delete; // Delete assignment
