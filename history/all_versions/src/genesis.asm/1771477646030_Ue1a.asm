...
g_Pattern_ContextAnalyzer BYTE \
    ...
    "    .endprolog",13,10,\
    "    ; [GENESIS:BUILD_SYMBOL_INDEX]",13,10,\
    "    xor eax, eax",13,10,\
    "    ret",13,10,\
...
@@:
    ...
    mov  qword ptr [rbp-8h], qword ptr [rcx]       ; pTemplate → local
    mov  qword ptr [rbp-10h], qword ptr [rcx+8]    ; pTaskDesc → local
    mov  qword ptr [rbp-18h], qword ptr [rcx+16]   ; pFileName → local
    mov  qword ptr [rbp-20h], qword ptr [rcx+24]   ; pObjName  → local
