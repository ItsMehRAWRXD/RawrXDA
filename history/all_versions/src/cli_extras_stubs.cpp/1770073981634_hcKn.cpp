...
<head>
    ...
    <style>
        body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #1a1a1a; color: #fff; margin: 0; display: flex; align-items: center; justify-content: center; height: 100vh; }
...
<body>
    <div class="container">
        ...
        <div class="status">WebSocket Connected: <span id="ws-status">Connecting...</span></div>
    </div>
...
std::string AgenticEngine::processQuery(const std::string& query) {
    ...
    if (query.rfind("/plan ", 0) == 0) {
        ...
        return planTask(goal, true).dump(2);
    }
