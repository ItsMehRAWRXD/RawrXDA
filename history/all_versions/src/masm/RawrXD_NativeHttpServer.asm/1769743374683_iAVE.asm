...
HttpServer_Initialize PROC
    ...
    ; Create version structure on stack (1.0)
    sub rsp, 48         ; 32 (shadow) + 16 (structure)
    mov word ptr [rsp + 32], 1       ; MajorVersion
    ...
    sub rsp, 32
    xor rcx, rcx        ; ReservedHandle
    xor edx, edx        ; Flags
    lea r8, [g_ServerContext.hRequestQueue]
    ...
    sub rsp, 64 + 32    ; Buffer for URL + Shadow
    lea rcx, [rsp + 32]
    mov word ptr [rcx], 'h'
    ...
    ; TODO: Convert port number to ASCII and append
    ; For now, use fixed port 23959
    ...
    mov edx, 0          ; Flags
    lea r8, [rsp + 32]  ; URL prefix
    sub rsp, 32
    call HttpAddUrl
    add rsp, 32
    add rsp, 64 + 32    ; Clean up URL buffer
    test eax, eax
    jnz @@add_url_failed
...
@@create_threads:
    ...
    ; CreateThread(lpSecurityAttributes, dwStackSize, lpStartAddress, lpParameter, dwCreationFlags, lpThreadId)
    sub rsp, 64         ; Shadow(32) + Args 5-6(16) + Alignment(16)
    xor rcx, rcx        ; Security
...
@@create_failed:
@@init_failed:
    ; EAX already contains the Win32 error code
    jmp @@init_done
