...
HttpServer_Initialize PROC
    ...
    ; HTTPAPI_VERSION is a 32-bit struct (2 USHORTs)
    mov ecx, 00020000h  ; MajorVersion = 2, MinorVersion = 0 (packed USHORTs)
    ; Wait, bit order: first field at lower address.
    ; In a register, lower address means lower bits? 
    ; No, USHORT HttpApiMajorVersion is at offset 0.
    ; So version 2.0 is ECX = 00000002h (if Major is first)
    ; Actually, let's use 00000002h for v2.0
    mov ecx, 00000002h 
