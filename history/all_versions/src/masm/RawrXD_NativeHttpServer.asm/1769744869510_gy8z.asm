...
HttpServer_Initialize PROC
    ...
    ; HttpCreateRequestQueue(HTTPAPI_VERSION Version, PCWSTR pName, PSECURITY_ATTRIBUTES pSys, ULONG Flags, PHANDLE pHandle)
    mov ecx, 00000002h  ; Version 2.0
    xor rdx, rdx        ; pName = NULL
    xor r8, r8          ; pSecurityAttributes = NULL
    xor r9, r9          ; Flags = 0
    lea rax, [g_ServerContext.hRequestQueue]
    sub rsp, 48         ; 32 (shadow) + 8 (arg5) + 8 (align)
    mov [rsp + 32], rax ; Argument 5: pRequestQueueHandle
