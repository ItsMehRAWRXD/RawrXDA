...
; RCX = template, RDX = buffer, R8 = size
; ---------------------------------------------------------------------------
FormatSuccessResponse PROC
    ...
    ; Format response
    mov r9, rcx         ; Template
    mov rcx, rdx        ; Buffer (dest)
    mov rdx, r9         ; Format string
    lea r8, g_ServerContext  ; Args could go here
...
HttpServer_Initialize PROC
    ...
    sub rsp, 16
    mov word ptr [rsp], 1       ; MajorVersion
    mov word ptr [rsp+2], 0     ; MinorVersion
    
    mov rcx, rsp        ; pVersion
