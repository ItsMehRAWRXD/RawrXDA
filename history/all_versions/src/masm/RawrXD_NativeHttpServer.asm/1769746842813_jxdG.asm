...
@@request_loop:
    ...
    ; HttpReceiveHttpRequest(hQueue, RequestId, Flags, pRequest, pLength, pBytesReceived, pOverlapped)
    sub rsp, 64         ; Space for 3 stack args (5,6,7) + Shadow(32) + Align
    ...
    mov qword ptr [rsp + 32], MAX_REQUEST_SIZE ; Arg 5: RequestBufferLength
    mov qword ptr [rsp + 40], 0 ; Arg 6: pBytesReceived (optional)
    mov qword ptr [rsp + 48], 0 ; Arg 7: pOverlapped
    ...
    ; Send HTTP response
    ; HttpSendHttpResponse(hQueue, RequestId, Flags, pResponse, pCachePolicy, pBytesSent, pReserved2, Reserved3, pOverlapped, pLogData)
    sub rsp, 512 + 128   ; Response structure + Shadow + 6 Stack Args + Align
    mov rdi, rsp
    add rdi, 128         ; pResponse buffer starts after shadow/args space
    ...
    mov qword ptr [rsp + 32], 0 ; Arg 5: pCachePolicy
    mov qword ptr [rsp + 40], 0 ; Arg 6: pBytesSent
    mov qword ptr [rsp + 48], 0 ; Arg 7: pReserved2
    mov qword ptr [rsp + 56], 0 ; Arg 8: Reserved3
    mov qword ptr [rsp + 64], 0 ; Arg 9: pOverlapped
    mov qword ptr [rsp + 72], 0 ; Arg 10: pLogData
...
HttpServer_Initialize PROC
    ...
    ; Initialize HTTP Server API (Version 2.0)
    ; HttpInitialize(HTTPAPI_VERSION Version, ULONG Flags, PVOID pReserved)
    mov ecx, 00000002h  ; MajorVersion = 2, MinorVersion = 0
    ...
    ; Create request queue (Version 2.0)
    ; HttpCreateRequestQueue(HTTPAPI_VERSION Version, PCWSTR pName, PSECURITY_ATTRIBUTES pSecurity, ULONG Flags, PHANDLE pHandle)
    mov ecx, 00000002h  ; Version
    xor rdx, rdx        ; pName
    xor r8, r8          ; pSecurity
    xor r9, r9          ; Flags
    sub rsp, 48         ; Shadow space (32) + 1 parameter (8) + alignment (8)
    ...
    ; Convert port 23959 to wide string "23959" (hardcoded for now)
