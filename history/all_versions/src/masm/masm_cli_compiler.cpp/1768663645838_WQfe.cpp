// ============================================================================
// masm_cli_compiler.cpp
// Command-Line MASM Compiler with Full Features
// Multi-file support, optimization, verbose output, error reporting
// ============================================================================
...
private:
    ...
    std::vector<uint8_t> generatePEFile() {
        ...
        // Copy machine code
        pe.insert(pe.end(), m_machineCode.begin(), m_machineCode.end());
