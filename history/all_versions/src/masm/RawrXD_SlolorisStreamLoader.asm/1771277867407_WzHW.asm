...
EXTRN Sleep:PROC
EXTRN InterlockedIncrement:PROC
EXTRN InterlockedDecrement:PROC
EXTRN InterlockedCompareExchange64:PROC
...
Sloloris_AttachModel PROC FRAME
    ...
    mov     rsi, [rsp + 56 + 56 + 40]   ; pTensorOffsets (after pushed regs + alloc + ret)
...
@@skip_offsets:
    ...
    mov     rsi, [rsp + 56 + 56 + 48]   ; pTensorSizes
