...
.data
    ...
    g_blockedFeatures dd 0  ; Global feature flags
    
    ; SIMD masks for character classification
    charClassMask db 64 dup(0)  ; Character classification mask
    whitespaceMask db 64 dup(0) ; Whitespace detection mask
    operatorMask db 64 dup(0)   ; Operator detection mask
