...
;=============================================================================
; Lexer_IsKeyword
; Checks if an identifier is a keyword for the given language
; pIdent: Pointer to identifier string
; language: Language ID
; Returns: 1 if keyword, 0 if not
;=============================================================================
Lexer_IsKeyword proc frame pIdent:dq, language:dword
    local pKeywords:dq
    ...
    .elseif language == LANG_CPP
        ...
        invoke Lexer_IsKeywordInList, pIdent, offset szKeywordsC
        .if eax
            mov eax, 1
            ret
        .endif
    ...
    invoke Lexer_IsKeywordInList, pIdent, pKeywords
    ret
...
;=============================================================================
Lexer_IsKeywordInList proc frame pIdent:dq, pList:dq
    push rbx
    push rsi
    push rdi
