...
// --- Stub GGUFServer ---
class GGUFServer {}; // Define stub for unique_ptr
...
namespace IDE {
    ...
    // Note: Changed return type to CompletionSuggestion to match header
...
// FormatRouter::~FormatRouter() is defaulted in header, so no implementation here.
