...
import { Terminal, Bot, Clock, Shield, Eye, Zap } from 'lucide-react';
...
function App() {
  ...
  const [rightPanel, setRightPanel] = useState<'tools' | 'agents' | 'failures' | 'history' | 'policy' | 'explain' | 'backend'>('tools');
