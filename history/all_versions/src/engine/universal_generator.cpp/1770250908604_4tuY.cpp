...
void UniversalGenerator::InitializeTemplates() {
    ...
    templates["web-app"] = ProjectTemplate{
        {"web-app", "Simple web application", LanguageType::JAVASCRIPT, {
    ...
    // CLI Tool Template
    templates["cli-tool"] = ProjectTemplate{
    ...
    // Library Template
    templates["library"] = ProjectTemplate{
    ...
    // Game Template
    templates["game"] = ProjectTemplate{
    ...
    // Embedded Template
    templates["embedded"] = ProjectTemplate{
