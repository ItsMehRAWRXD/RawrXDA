...
Math_InitTables PROC FRAME
    ...
    ; Initialize Sin/Cos tables with dummy values 
    ; (Real implementation would use fsin/fcos or precomputed data)
    lea rcx, g_SinTable
    lea rdx, g_CosTable
    mov r8d, 4096
    xor eax, eax
...
@init_loop:
    ...
    ; 0.5 in float is 3F000000h
    mov dword ptr [rcx + rax*4], 3F000000h 
    mov dword ptr [rdx + rax*4], 3F000000h 
