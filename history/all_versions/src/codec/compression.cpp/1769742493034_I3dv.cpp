...
QByteArray deflate(const QByteArray& data, bool* success) {
    ...
    QByteArray compressed(static_cast<std::size_t>(compressedSize), Qt::Uninitialized);
...
QByteArray inflate(const QByteArray& data, bool* success) {
    ...
    QByteArray decompressed(static_cast<std::size_t>(decompressedSize), Qt::Uninitialized);
