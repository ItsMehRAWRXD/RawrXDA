                    ...
                    case IDM_TOOLS_AUTO_REFACTOR:
                        {
                            ...
                            wCode.pop_back();
                            std::string code = WideToUTF8(wCode);
                            std::string params = "{\"code\":\"" + code + "\",\"type\":\"auto\"}";
                            std::string refactored = GenerateAnything("auto_refactor", params);
                            pThis->CreateNewTab(L"Refactored.cpp", L"");
                            SetWindowTextW(pThis->hEditor_, UTF8ToWide(refactored).c_str());
                            AppendOutputText(pThis->hOutput_, L"[Auto Refactor] Refactored code generated in new tab.\r\n");
                        }
                        return 0;
                    case IDM_TOOLS_GENERATE_TESTS:
                        {
                            ...
                            wCode.pop_back();
                            std::string code = WideToUTF8(wCode);
                            std::string params = "{\"code\":\"" + code + "\",\"framework\":\"gtest\"}";
                            std::string tests = GenerateAnything("generate_tests", params);
                            pThis->CreateNewTab(L"Generated_Tests.cpp", L"");
                            SetWindowTextW(pThis->hEditor_, UTF8ToWide(tests).c_str());
                            AppendOutputText(pThis->hOutput_, L"[Test Gen] Generated tests in new tab.\r\n");
                        }
                        return 0;
