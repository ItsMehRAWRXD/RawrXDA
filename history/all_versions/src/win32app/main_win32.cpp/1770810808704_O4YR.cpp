...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR lpCmdLine, int nCmdShow) {
    ...
    // Initialize auto-registered commands (250+ GUI→CLI bridge)
    // This runs AFTER FeatureRegistrar static init, extending the registry
    // with all IDM_* commands that were GUI-only. Auto-generated by:
    //   python scripts/auto_register_commands.py
    initAutoFeatureRegistry();
