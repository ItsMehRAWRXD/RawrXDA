...
#define IDC_PS_BTN_AGENTIC 5017
#define IDC_PS_BTN_HOTPATCH 5018
...
void Win32IDE::createPowerShellToolbar() {
    ...
    m_hwndPSBtnAgentic = CreateWindowExA(
        0, "BUTTON", "Agentic",
        WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        btnX, btnY, btnWidth, btnHeight,
        m_hwndPowerShellPanel,
        (HMENU)IDC_PS_BTN_AGENTIC,
        m_hInstance, NULL
    );
    btnX += btnWidth + btnSpacing;
    
    m_hwndPSBtnHotpatch = CreateWindowExA(
        0, "BUTTON", "Hotpatch",
        WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
        btnX, btnY, btnWidth, btnHeight,
        m_hwndPowerShellPanel,
        (HMENU)IDC_PS_BTN_HOTPATCH,
        m_hInstance, NULL
    );
}
        ...
        case WM_COMMAND: {
            ...
            switch (id) {
                ...
                case IDC_PS_BTN_LOAD_RAWRXD:
                    ...
                    break;
                case IDC_PS_BTN_AGENTIC:
                    if (ide) ide->triggerAgenticBeacon();
                    break;
                case IDC_PS_BTN_HOTPATCH:
                    if (ide) ide->triggerHotpatchBeacon();
                    break;
            }
            break;
        }
