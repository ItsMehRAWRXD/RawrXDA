...
void Win32IDE::createExplorerView(HWND hwndParent)
{
    ...
    m_hwndExplorerTree = CreateWindowExA(
        ...
        TVS_EX_DOUBLEBUFFER | TVS_EX_FADEINOUTEXPANDOS,  // Optimized for 10k+ files
...
void Win32IDE::startDebugging()
{
    ...
    if (CreateProcessA(nullptr, cmdBuffer, nullptr, nullptr, FALSE,
        ...
        m_debugProcessId = pi.dwProcessId;
        m_debugThreadId = pi.dwThreadId;
...
// ============================================================================
// Win32 Debug API - Real Debugger Integration (Zero Stubs)
// ============================================================================
