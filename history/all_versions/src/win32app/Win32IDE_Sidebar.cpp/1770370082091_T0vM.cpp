...
// Qt-style logging macros replaced with standard output
#define qInfo() std::cout
#define qDebug() std::cout  
#define qWarning() std::cerr
#define qCritical() std::cerr
#define qError() std::cerr
...
void Win32IDE::newFolderInExplorer()
{
    ...
    // Simple implementation - create with default name
    try {
