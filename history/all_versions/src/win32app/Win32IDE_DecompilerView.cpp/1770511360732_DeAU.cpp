...
static void DecompView_PaintDecomp(DecompViewState* state);
static void DecompView_PaintDisasm(DecompViewState* state);
...
// ============================================================================
static LRESULT CALLBACK SplitterBarProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    DecompViewState* state = g_decompState;
