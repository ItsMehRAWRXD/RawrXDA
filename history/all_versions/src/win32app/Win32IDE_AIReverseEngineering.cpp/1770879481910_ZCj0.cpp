...
static LRESULT CALLBACK airePanelWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE: {
        ...
        addBtn(15,  130, L"\U0001F4C2 Load Binary",     IDM_AIRE_LOAD);
        addBtn(155, 130, L"\U0001F916 AI Rename",        IDM_AIRE_AI_RENAME);
        addBtn(295, 130, L"\U0001F6E1 Vuln Scan",        IDM_AIRE_VULNSCAN);
        addBtn(435, 130, L"\U0001F4DD AI Annotate",      IDM_AIRE_ANNOTATE);
        addBtn(575, 130, L"\U0001F4CA Call Graph",       IDM_AIRE_CALLGRAPH);
        addBtn(715, 130, L"\U0001F4BE Export",           IDM_AIRE_EXPORT);
...
bool Win32IDE::handleAIRECommand(int commandId) {
