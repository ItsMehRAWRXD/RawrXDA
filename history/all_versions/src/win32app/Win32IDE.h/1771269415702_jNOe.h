...
// Forward-declare SwarmOrchestrator to avoid pulling in C++23/spdlog/nlohmann deps
namespace RawrXD { class SwarmOrchestrator; }
...
enum class CommandID : int {
    ...
    TERMINAL_SPLIT_H = 2305,
    TERMINAL_SPLIT_V = 2306,
    ...
    // Build commands (2800-2899)
    BUILD_PROJECT = 2801,
    BUILD_CLEAN = 2802,
    BUILD_REBUILD = 2803,
    BUILD_RUN = 2804,
    BUILD_STOP = 2805,
    BUILD_CONFIG_DEBUG = 2806,
    BUILD_CONFIG_RELEASE = 2807,
    BUILD_ASM_CURRENT = 2808,
    BUILD_SET_TARGET = 2809,
    BUILD_SHOW_LOG = 2810,

    // Agent commands (2900-2999)
    AGENT_START_LOOP = 2901,
    AGENT_EXECUTE_CMD = 2902,
    AGENT_CONFIGURE_MODEL = 2903,
    AGENT_VIEW_TOOLS = 2904,
    AGENT_VIEW_STATUS = 2905,
    AGENT_STOP = 2906,

    // Autonomy commands (3000-3099)
    AUTONOMY_TOGGLE = 3001,
    AUTONOMY_SET_LEVEL = 3002,
    AUTONOMY_VIEW_LOG = 3003,
    AUTONOMY_CONFIGURE = 3004,
    AUTONOMY_RESET = 3005,
    AUTONOMY_STATUS = 3006,
...
public:
    ...
    // Build System — MASM64 + C++ Hybrid Toolchain
    std::unique_ptr<RawrXD::ToolchainBridge> m_toolchain;
    ...
    void onBuildRun();
    void onBuildStop();
    void onBuildAsmCurrent();
    void onBuildSetTarget();
    void onBuildShowLog();
    void onBuildSetConfig(RawrXD::BuildConfig config);
...
private:
    ...
    // Command routing (uses refactored CommandInfo system above)
    ...
    // m_commandRegistry / m_filteredCommands declared above with CommandInfo type
