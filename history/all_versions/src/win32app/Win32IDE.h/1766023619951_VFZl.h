...
private:
    ...
    bool loadVSCodeExtensionModule();
    std::string invokeVSCodeExtensionCommand(const std::string& command, const std::vector<std::string>& args = {});
...
private:
    ...
    bool m_powerShellVSCodeExtensionLoaded;  // VS Code Extension module loaded
    ...
    bool loadVSCodeExtensionModule();
    std::string invokeVSCodeExtensionCommand(const std::string& commandName, const std::vector<std::string>& args);
