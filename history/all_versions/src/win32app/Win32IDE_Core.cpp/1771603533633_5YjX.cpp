...
void Win32IDE::onCreate(HWND hwnd)
{
    ...
    // ================================================================
    // WIRE ALL SYSTEMS TOGETHER - Complete Integration
    // ================================================================
    OutputDebugStringA("[onCreate] wireAllSystems - Full System Integration...\n");
    wireAllSystems();
    OutputDebugStringA("[onCreate] All systems wired and operational\n");
