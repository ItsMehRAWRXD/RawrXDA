...
static COLORREF symbolKindColor(int kind) {
    switch (kind) {
    case SK_Class:       case SK_Interface: case SK_Struct: return RGB(78, 201, 176);
    case SK_Method:      case SK_Function:  case SK_Constructor: return RGB(220, 220, 170);
    case SK_Variable:    case SK_Field:     case SK_Property: return RGB(156, 220, 254);
    case SK_Enum:        case SK_EnumMember: return RGB(184, 215, 163);
    case SK_Constant:    return RGB(100, 150, 224);
    case SK_Namespace:   case SK_Module: case SK_Package: return RGB(200, 200, 200);
...
static const char* symbolKindIcon(int kind) {
    switch (kind) {
    case SK_Class:       return "C";
    case SK_Interface:   return "I";
    case SK_Struct:      return "S";
    case SK_Method:      return "m";
    case SK_Function:    return "f";
    case SK_Constructor: return "c";
    case SK_Variable:    return "v";
    case SK_Field:       return "F";
    case SK_Property:    return "p";
    case SK_Enum:        return "E";
    case SK_EnumMember:  return "e";
    case SK_Constant:    return "K";
    case SK_Namespace:   return "N";
    case SK_Module:      return "M";
    default:             return ".";
    }
}
