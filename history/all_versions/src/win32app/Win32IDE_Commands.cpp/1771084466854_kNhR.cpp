...
void Win32IDE::handleViewCommand(int commandId) {
    switch (commandId) {
        ...
        case IDM_ENT_MODEL_COMPARE:
            if (!gateEnterpriseFeatureUI(m_hwnd, RawrXD::License::FeatureID::ModelComparison,
                L"Model Comparison", "Win32IDE::ModelComparison")) {
                break;
            }
            MessageBoxW(m_hwnd, L"Model Comparison is wired. UI panel is pending.",
...
void Win32IDE::executeCommandFromPalette(int index)
{
    ...
    routeCommandUnified(commandId, this, m_hwndMain);
