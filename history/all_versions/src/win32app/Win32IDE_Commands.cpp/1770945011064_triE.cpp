...
void Win32IDE::handleToolsCommand(int commandId) {
    switch (commandId) {
        ...
        case IDM_AI_MODEL_REGISTRY:
            ...
            break;
        case IDM_AI_CHECKPOINT_MANAGER:
            if (m_checkpointManager) m_checkpointManager->show();
            break;
        case IDM_AI_INTERPRETABILITY:
...
void Win32IDE::buildCommandRegistry()
{
    ...
    m_commandRegistry.push_back({IDM_AI_CHECKPOINT_MANAGER,  "AI: Show Checkpoint Manager",           "", "AI"});
    m_commandRegistry.push_back({IDM_AI_INTERPRETABILITY,    "AI: Show Interpretability Panel",       "", "AI"});
