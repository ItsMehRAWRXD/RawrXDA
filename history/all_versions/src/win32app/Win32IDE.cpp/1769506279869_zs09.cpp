...
#define IDM_POWERSHELL_SWARM_CONTROL 3060
#define IDM_POWERSHELL_MODULE_LIFECYCLE 3061
#define IDM_POWERSHELL_PLUGIN_CRAFT 3062
#define IDM_POWERSHELL_PERFORMANCE 3063
#define IDM_POWERSHELL_SECURITY 3064
#define IDM_POWERSHELL_LANGUAGE_REGISTRY 3065
...
void Win32IDE::createMenuBar(HWND hwnd)
{
    ...
    HMENU hPowerShellMenu = CreatePopupMenu();
    AppendMenuA(hPowerShellMenu, MF_STRING, IDM_POWERSHELL_SWARM_CONTROL, "Swarm Control Center");
    AppendMenuA(hPowerShellMenu, MF_SEPARATOR, 0, nullptr);
    AppendMenuA(hPowerShellMenu, MF_STRING, IDM_POWERSHELL_MODULE_LIFECYCLE, "Module Lifecycle Inventory");
    AppendMenuA(hPowerShellMenu, MF_STRING, IDM_POWERSHELL_PLUGIN_CRAFT, "Plugin Craft Room Commands");
    AppendMenuA(hPowerShellMenu, MF_STRING, IDM_POWERSHELL_PERFORMANCE, "Performance Framework Commands");
    AppendMenuA(hPowerShellMenu, MF_STRING, IDM_POWERSHELL_SECURITY, "Security Framework Commands");
    AppendMenuA(hPowerShellMenu, MF_STRING, IDM_POWERSHELL_LANGUAGE_REGISTRY, "Language Registry Commands");
    AppendMenuA(m_hMenu, MF_POPUP, (UINT_PTR)hPowerShellMenu, "&PowerShell");
...
void Win32IDE::onAgentToggleConsent() {
    ...
    config.pszWindowTitle = L"Agent Consent Level";
