...
// ---------------------------------------------------------------------------
// quickLoadGGUFModel — Quick-access model loader: a lightweight text input
// that accepts any model source and resolves it. Accessible from command
// palette and keyboard shortcuts.
// ---------------------------------------------------------------------------
void Win32IDE::quickLoadGGUFModel() {
    SCOPED_METRIC("model.quick_load");
