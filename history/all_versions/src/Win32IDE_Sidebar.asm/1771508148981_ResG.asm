...
; TreeView messages
TVM_SETEXTENDEDSTYLE    EQU 0400h + 44
TVM_INSERTITEMA         EQU 0400h + 0
TVM_DELETEITEM          EQU 0400h + 1
TVM_EXPAND              EQU 0400h + 2

; ListView messages  
LVM_SETEXTENDEDLISTVIEWSTYLE EQU 0400h + 54
LVM_INSERTITEMA         EQU 0400h + 7
LVM_SETITEMTEXTA        EQU 0400h + 46
LVM_DELETEALLITEMS      EQU 0400h + 9
