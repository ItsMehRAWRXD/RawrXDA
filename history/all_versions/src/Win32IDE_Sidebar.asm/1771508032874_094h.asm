...
ACTIVITY_BAR_STYLE      EQU WS_CHILD or WS_VISIBLE or BS_OWNERDRAW
TREEVIEW_STYLE          EQU WS_CHILD or WS_VISIBLE or WS_BORDER or TVS_HASBUTTONS or TVS_HASLINES or TVS_LINESATROOT or TVS_SHOWSELALWAYS
