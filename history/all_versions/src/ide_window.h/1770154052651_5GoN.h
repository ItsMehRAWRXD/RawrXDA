...
private:
    ...
    HWND hParameterHint_;t_;
    HWND hFindDialog_;t_;
...
};    std::vector<CommandEntry> commandList_;    };        int id;        std::wstring name;    struct CommandEntry {