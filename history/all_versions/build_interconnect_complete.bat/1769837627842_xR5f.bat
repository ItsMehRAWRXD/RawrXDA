...
%ML64% /c /Zi /Fo..\build\System_Primitives.obj RawrXD_System_Primitives.asm
%ML64% /c /Zi /Fo..\build\RingBuffer_Consumer.obj RawrXD_RingBuffer_Consumer.asm
%ML64% /c /Zi /Fo..\build\HTTP_Router.obj RawrXD_HTTP_Router.asm
%ML64% /c /Zi /Fo..\build\Model_StateMachine.obj RawrXD_Model_StateMachine.asm
%ML64% /c /Zi /Fo..\build\Swarm_Orchestrator.obj RawrXD_Swarm_Orchestrator.asm
%ML64% /c /Zi /Fo..\build\Agentic_Router.obj RawrXD_Agentic_Router.asm
%ML64% /c /Zi /Fo..\build\Streaming_Formatter.obj RawrXD_Streaming_Formatter.asm
%ML64% /c /Zi /Fo..\build\JSON_Parser.obj RawrXD_JSON_Parser.asm
%ML64% /c /Zi /Fo..\build\GPU_Memory.obj RawrXD_GPU_Memory.asm
%ML64% /c /Zi /Fo..\build\Inference_Engine.obj RawrXD_Inference_Engine.asm
%ML64% /c /Zi /Fo..\build\Complete_Interconnect.obj RawrXD_Complete_Interconnect.asm
