...
@@:     lodsw
        ...
        ; ---- try to open as file ----
        mov     rcx, [rsp+48h]      ; saved UTF-16 rsi
        if 0
        ; Wait, I need to save rsi before WideCharToMultiByte
        endif
...
lang_ps_label:  mov     rsi, offset lang_ps
        jmp     lang_copy_label
lang_js_label:  mov     rsi, offset lang_js
        jmp     lang_copy_label
lang_py_label:  mov     rsi, offset lang_py
        jmp     lang_copy_label
lang_cpp_label: mov     rsi, offset lang_cpp
        jmp     lang_copy_label
lang_raw_label: mov     rsi, offset lang_raw
lang_copy_label:
        mov     rdi, rcx
        call    strcpy
        pop     rdi
