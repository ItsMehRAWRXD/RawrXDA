...
.const
 ...
 ; Constants (Moved to .const to avoid strict addressing errors)
 val_half       REAL4 1.5
 val_scale      REAL4 0.12345
 val_epsilon    REAL4 1.0e-5
 val_one        REAL4 1.0
...
@loop:
    ...
    cvtsi2ss xmm0, ebx
    movss xmm1, DWORD PTR val_half
    subss xmm0, xmm1
    movss xmm1, DWORD PTR val_scale
    mulss xmm0, xmm1
...
@sum_sq:
    ...
    movss xmm2, DWORD PTR val_epsilon
    vaddss xmm0, xmm0, xmm2
    
    vsqrtss xmm0, xmm0, xmm0
    movss xmm2, DWORD PTR val_one
