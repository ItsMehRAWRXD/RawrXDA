...
public:
    ...
    // Writing
    FileOperationResult writeFile(const std::wstring& path, const std::wstring& content, bool createBackup = true);
    FileOperationResult writeFileRaw(const std::wstring& path, const std::vector<uint8_t>& data, bool createBackup = true);
