...
static AICompletion g_currentCompletion;
...
void ShowAICompletion(const AICompletion& completion) {
    ...
    SendMessageW(g_hwndEditor, EM_REPLACESEL, FALSE, g_completionText.c_str());
...
void HideAICompletion() {
    ...
    SendMessageW(g_hwndEditor, EM_REPLACESEL, FALSE, L"");
