...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_SIZE: {
        ...
        if (g_bChatVisible) {
            ...
            MoveWindow(GetDlgItem(hwnd, IDC_CHAT_STOP), chatX + btnWidth * 3, btnY, btnWidth, btnHeight, TRUE);
            MoveWindow(GetDlgItem(hwnd, IDC_CHAT_CLEAR), chatX + btnWidth * 4, btnY, btnWidth, btnHeight, TRUE);
            MoveWindow(GetDlgItem(hwnd, IDC_CHAT_SEND), chatX + btnWidth * 5, btnY, btnWidth, btnHeight, TRUE);
