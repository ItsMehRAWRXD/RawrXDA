...
private:
    ...
    void CreateMenuBar() {
        m_mainMenu = CreateMenuW();
        
        HMENU hFileMenu = CreatePopupMenuW();
        AppendMenuW(hFileMenu, MFT_STRING, 1001, L"&Open");
        AppendMenuW(hFileMenu, MFT_STRING, 1002, L"&Save");
        AppendMenuW(hFileMenu, MFT_SEPARATOR, 0, nullptr);
        AppendMenuW(hFileMenu, MFT_STRING, 1003, L"E&xit");
        AppendMenuW(m_mainMenu, MFT_POPUP, (UINT_PTR)hFileMenu, L"&File");
        
        HMENU hEditMenu = CreatePopupMenuW();
        AppendMenuW(hEditMenu, MFT_STRING, 2001, L"&Undo");
        AppendMenuW(hEditMenu, MFT_STRING, 2002, L"&Redo");
        AppendMenuW(hEditMenu, MFT_SEPARATOR, 0, nullptr);
        AppendMenuW(hEditMenu, MFT_STRING, 2003, L"&Copy");
        AppendMenuW(hEditMenu, MFT_STRING, 2004, L"&Paste");
        AppendMenuW(m_mainMenu, MFT_POPUP, (UINT_PTR)hEditMenu, L"&Edit");
        
        HMENU hViewMenu = CreatePopupMenuW();
        AppendMenuW(hViewMenu, MFT_STRING, 3001, L"&Explorer");
        AppendMenuW(hViewMenu, MFT_STRING, 3002, L"&Terminal");
        AppendMenuW(hViewMenu, MFT_STRING, 3003, L"&Output");
        AppendMenuW(m_mainMenu, MFT_POPUP, (UINT_PTR)hViewMenu, L"&View");
        
        SetMenuW(m_hwnd, m_mainMenu);
    }
