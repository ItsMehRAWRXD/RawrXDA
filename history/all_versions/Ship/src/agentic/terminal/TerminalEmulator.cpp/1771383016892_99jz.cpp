...
void Win32TerminalEmulator::setOnOutput(TerminalOutputCallback callback) {
        m_compatOutputCallback = callback;
    }

    void Win32TerminalEmulator::setOnTitleChange(TerminalOutputCallback callback) {
        m_compatTitleCallback = callback;
    }