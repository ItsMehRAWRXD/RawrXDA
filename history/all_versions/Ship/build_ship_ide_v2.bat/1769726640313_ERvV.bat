...
set LIBS=user32.lib gdi32.lib shell32.lib comctl32.lib comdlg32.lib ole32.lib advapi32.lib
cl /O2 /W3 /DNDEBUG /DUNICODE /D_UNICODE %SRC% /Fe:%OUT% /link %LIBS% /SUBSYSTEM:WINDOWS
