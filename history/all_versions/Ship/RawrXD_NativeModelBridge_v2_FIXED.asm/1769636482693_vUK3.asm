...
@@loop:
    ; Load scale (FP16)
    vmovsh xmm1, WORD PTR [rsi]
    vcvtsh2ss xmm1, xmm1
    vpbroadcastd zmm1, xmm1 ; Scale
    
    ; UNPACK Q4_0 (16 bytes -> 32 nibbles)
    ; This is a high-perf ASM sequence using VPERMB and VAND/VSHR
    vmovdqu xmm2, [rsi + 2] ; 16 bytes
    
    ; Low nibbles
    vpbroadcastd zmm3, dword ptr [q4_0_mask] ; 0x0F
    vpandd zmm4, zmm2, zmm3
    ; High nibbles
    vpsrlw zmm5, zmm2, 4
    vpandd zmm5, zmm5, zmm3
    
    ; Subtract bias (8)
    vpbroadcastd zmm6, dword ptr [q4_0_bias] ; 0x08
    vpsubb zmm4, zmm4, zmm6
    vpsubb zmm5, zmm5, zmm6
