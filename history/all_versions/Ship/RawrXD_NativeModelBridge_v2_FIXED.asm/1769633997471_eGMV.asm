...
LoadModelNative PROC FRAME
    ...
    ; Store header (at offset 32 in context)
    mov eax, [r15]
    mov [rbx + 32], eax     ; magic at offset 32
    mov eax, [r15+4]
    mov [rbx + 36], eax     ; version at offset 36
    mov rax, [r15+8]
    mov [rbx + 40], rax     ; n_tensors at offset 40
    mov rax, [r15+16]
    mov [rbx + 48], rax     ; n_kv at offset 48
