...
LoadModelNative PROC FRAME pCtx:QWORD, pFilePath:QWORD
    ...
    mov eax, [rsi]
    mov edx, 0x46554747  ; GGUF_MAGIC
    cmp eax, edx
    jne @@err
    
    ; Store context (save file handle, mapping, base ptr, size)
    mov QWORD PTR [rbx], r13      ; hFile
    mov QWORD PTR [rbx+8], r15    ; hMapping
    mov QWORD PTR [rbx+16], rsi   ; pBase
    mov QWORD PTR [rbx+24], r14   ; FileSize
...
InitMathTables PROC FRAME
    ...
    mov rcx, 134217728  ; 128 * 1024 * 1024
    call malloc
    test rax, rax
    jz @@err
