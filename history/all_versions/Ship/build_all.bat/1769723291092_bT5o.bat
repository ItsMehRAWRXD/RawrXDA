...
if %errorlevel% neq 0 (
    ...
    link.exe /nologo /DLL /OUT:RawrXD_Titan_Kernel.dll RawrXD_Titan_Kernel.obj %LIBPATH% kernel32.lib ntdll.lib
...
echo [3/5] Building Inference Engine DLL...
...
echo [4/5] Building Win32 IDE (Full Production)...
