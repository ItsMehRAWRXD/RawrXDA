...
SendJsonResponse PROC FRAME
    ...
    mov rbx, rcx                    ; HttpRequest*
    mov r12d, edx                   ; Status code
    mov rsi, r8                     ; JSON body
    ...
    mov rdi, [rbx].HttpRequest.ResponseBuffer
    
    ; Status line
    lea rcx, szHttpStatusTemplate
    mov edx, r12d
    mov r8, rdi
    call wsprintfA
    ...
    ; Send
    mov ecx, [rbx].HttpRequest.Socket
    mov rdx, [rbx].HttpRequest.ResponseBuffer
    mov r8, rdi
    add r8, r12
    sub r8, [rbx].HttpRequest.ResponseBuffer
    xor r9, r9
    call send
...
WaitForInferenceCompletion PROC
    ret
