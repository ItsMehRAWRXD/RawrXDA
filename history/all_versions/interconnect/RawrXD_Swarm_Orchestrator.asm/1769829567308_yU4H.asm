...
Swarm_Initialize PROC FRAME
    ...
    mov ecx, SWARM_MAX_QUEUE_DEPTH * SIZEOF SwarmJob + 64
    mov edx, 64                     ; Alignment
...
fOne                    REAL4 1.0
fMinusOne               REAL4 -1.0
fOneHourMs              REAL4 3600000.0
fDecayRate              REAL4 0.001
fMaxInferencesNorm      REAL4 1000.0
fQueuePenalty           REAL4 0.5
