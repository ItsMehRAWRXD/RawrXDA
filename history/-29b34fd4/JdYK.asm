...
VramHeap STRUCT
    ...
    Blocks              BYTE 229376 DUP (?) ; 4096 * 56
...
Vram_Initialize PROC
    ...
    ; manual offset calc because Blocks is BYTE array
    lea rax, g_VramHeap.Blocks  ; Base address
...
@find_slot:
    mov eax, ecx
    imul rax, VRAM_BLOCK_STRUCT_SIZE
    lea r8, [rsi].VramHeap.Blocks[rax]
