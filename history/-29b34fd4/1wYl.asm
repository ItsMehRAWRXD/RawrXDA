...
Vram_SubmitUpload PROC FRAME
    ...
    mov [rbx].GpuTransferOp.OperationType, 0 ; UPLOAD
    mov [rbx].GpuTransferOp.SrcHostPtr, rcx
    mov [rbx].GpuTransferOp.DstVramOffset, rdx
    mov [rbx].GpuTransferOp.OperationSize, r8
    ...
    mov r8, [rbx].GpuTransferOp.OperationSize
...
@compact_loop:
    ...
    mov [r15].GpuTransferOp.SrcHostPtr, r8  ; Use SrcHostPtr as SrcOffset for Copy
    mov [r15].GpuTransferOp.DstVramOffset, r13
    mov r8, [rdx].VramBlock.VSize
    mov [r15].GpuTransferOp.OpSize, r8
