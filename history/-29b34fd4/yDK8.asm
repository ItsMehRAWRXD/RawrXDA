...
Vram_SubmitUpload PROC FRAME
    ...
    mov r8, (GpuTransferOp PTR [rbx]).OpSize
...
@compact_loop:
    ...
    mov (GpuTransferOp PTR [r15]).OperationType, 2 ; COPY
    mov r8, (VramBlock PTR [rdx]).VOffset
    mov (GpuTransferOp PTR [r15]).SrcHostPtr, r8  ; Use SrcHostPtr as SrcOffset for Copy
    mov (GpuTransferOp PTR [r15]).DstVramOffset, r13
    mov r8, (VramBlock PTR [rdx]).VSize
    mov (GpuTransferOp PTR [r15]).OperationSize, r8
