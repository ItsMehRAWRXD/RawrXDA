...
struct CorrectionResult {
    ...
    AgenticPuppeteer::FailureType detectedFailure = AgenticPuppeteer::FailureType::None;
    QString diagnosticMessage;
    
    static CorrectionResult ok(const QString& output, AgenticPuppeteer::FailureType failure) {
        return CorrectionResult{true, output, failure, "Correction applied"};
    }
    
    static CorrectionResult error(AgenticPuppeteer::FailureType failureType, const QString& diagnostic) {
