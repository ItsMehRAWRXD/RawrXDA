...
.data
    ...
    szAgentDllName   db "AgentLoopPhase2.dll",0
    szAgentDllName1  db "AgentLoopPhase1.dll",0
...
AgentSystem_Init PROC
    ...
    ; Try to load Phase 2 DLL
    invoke LoadLibraryA, ADDR szAgentDllName
    .if eax == 0
        ; Fallback to Phase 1
        invoke LoadLibraryA, ADDR szAgentDllName1
    .endif
    mov g_hAgentDll, eax
    ; Note: We don't fail if DLL is missing, just run in stub mode
