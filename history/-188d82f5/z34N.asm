...
PopulateDirectory proc hParent:DWORD, pszPath:DWORD
    ...
    ; Temporarily disable redraw for faster inserts
    invoke SendMessage, hFileTree, WM_SETREDRAW, FALSE, 0
...
@skipLog:
    ...
    invoke SendMessage, hFileTree, WM_SETREDRAW, TRUE, 0
    invoke InvalidateRect, hFileTree, NULL, TRUE
    ret
