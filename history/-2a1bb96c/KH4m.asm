...
extern PerfMetrics_AddBytes:proc
...
@openNew:
    ...
    ; Open file with sequential scan optimization
    push 0
...
@fileRead:
    ...
    mov g_StreamContext.overlapped.lOffset, eax
    mov eax, dword ptr g_StreamContext.qwBytesRead+4
    mov g_StreamContext.overlapped.lOffsetHigh, eax
    mov eax, g_StreamContext.hEvent
    mov g_StreamContext.overlapped.hEvent, eax
