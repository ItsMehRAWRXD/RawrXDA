...
.emit_loop:
    ...
    ; Debug: print AST node type and token index
    movzx eax, byte [rsi]
    lea rcx, [debug_node_type]
    mov edx, eax
    call printf_wrapper
    
    mov rax, [rsi+8]
    lea rcx, [debug_token_idx]
    mov edx, eax
    call printf_wrapper
...
.entry_ok:
    ...
    ; Debug: print token pointer address
    lea rcx, [debug_msg_token]
    call print_string
    
    ; Print the token text directly
    mov rcx, r8
    inc rcx                         ; skip token type byte
    call print_string
    lea rcx, [newline]
    call print_string
