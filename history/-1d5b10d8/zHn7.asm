...
parser_parse_instruction:
    push rbx
    push r12                        ; callee-saved for AST node pointer
    mov rbx, [g_current_token]      ; mnemonic token index
    call ast_create_node
    mov r12, rax                    ; r12 = AST node (preserved across calls)
    mov byte [r12], AST_INSTRUCTION
    mov [r12+8], rbx
    mov qword [r12+32], 0
