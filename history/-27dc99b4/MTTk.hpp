...
public:
    ...
    public:
        ...
        const_iterator(array_iter it) : m_is_array(true), m_array_it(it) {}
        const_iterator(object_iter it) : m_is_array(false), m_object_it(it) {}
    ...
    public:
        ...
        iterator(array_iter it) : m_is_array(true), m_array_it(it) {}
        iterator(object_iter it) : m_is_array(false), m_object_it(it) {}
