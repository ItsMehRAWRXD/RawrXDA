...
SelfManifestor::scanCurrentProcess() {
    // Enterprise License Gate — Self Manifestor requires Enterprise tier
    if (!LicenseEnforcementGate::getInstance().checkAccess(EnterpriseFeature::SelfManifestor, "scanCurrentProcess")) {
