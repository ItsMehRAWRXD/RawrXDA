...
// Note: ChatHistoryManager is in RawrXD::Database namespace
// Forward declaring as unqualified name for convenience
namespace RawrXD { namespace Database { class ChatHistoryManager; } }
using ChatHistoryManager = RawrXD::Database::ChatHistoryManager;
