...
typedef enum {
    RAWRXD_FILE_TYPE_UNKNOWN = 0,
    RAWRXD_FILE_TYPE_DIRECTORY,
    RAWRXD_FILE_TYPE_SOURCE_C,
    RAWRXD_FILE_TYPE_SOURCE_CPP,
    RAWRXD_FILE_TYPE_SOURCE_H,
    RAWRXD_FILE_TYPE_SOURCE_PY,
    RAWRXD_FILE_TYPE_SOURCE_JS,
    RAWRXD_FILE_TYPE_SOURCE_TS,
    RAWRXD_FILE_TYPE_SOURCE_RS,
    RAWRXD_FILE_TYPE_SOURCE_GO,
    RAWRXD_FILE_TYPE_SOURCE_ASM,
    RAWRXD_FILE_TYPE_CONFIG_JSON,
    RAWRXD_FILE_TYPE_CONFIG_XML,
    RAWRXD_FILE_TYPE_CONFIG_YAML,
    RAWRXD_FILE_TYPE_CONFIG_INI,
    RAWRXD_FILE_TYPE_TEXT,
    RAWRXD_FILE_TYPE_MARKDOWN,
    RAWRXD_FILE_TYPE_BINARY,
    RAWRXD_FILE_TYPE_EXECUTABLE,
    RAWRXD_FILE_TYPE_LIBRARY,
    RAWRXD_FILE_TYPE_IMAGE
} RawrXD_FileType;
