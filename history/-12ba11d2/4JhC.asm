...
LspMessage_ParseFromJson proc frame uses rbx rsi rdi r12 r13 r14 r15, 
    ...
    mov rcx, offset g_SlabAllocator
...
invalid_version:
    ...
    mov rsi, [rbx + r8].LSP_MESSAGE.Method
    
    ; TODO: copy with length check
...
no_result:
    ...
    call Json_FindString
    mov [rbx].LSP_MESSAGE.ErrorMessage, rax
...
LspMessage_Validate proc frame uses rbx rsi rdi, pMessage:ptr LSP_MESSAGE
    ...
    sub rsp, sizeof(MESSAGE_VALIDATION)
    mov rsi, rsp
...
@@:
    ...
    mov rax, rsi
    add rsp, sizeof(MESSAGE_VALIDATION)
    ret
