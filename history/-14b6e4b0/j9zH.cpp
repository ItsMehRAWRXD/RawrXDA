...
void GUIMain::handleMenuCommand(int commandId) {
    switch (commandId) {
        ...
        case 4009: // Generate Bug Report
            MessageBox(m_mainWindow, L"Bug Report Generation Started...", L"Bug Report", MB_OK);
            break;
        case 4010: // Code Suggestions
            MessageBox(m_mainWindow, L"Analyzing for Code Suggestions...", L"Suggestions", MB_OK);
            break;
    }
}
