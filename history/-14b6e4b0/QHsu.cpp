...
// Missing method implementations stubs to allow compilation
std::expected<void, std::string> GUIMain::createEditorWindow() { return {}; }
std::expected<void, std::string> GUIMain::setupLayout() { return {}; }
...
void GUIMain::onEditUndoInternal() {}
void GUIMain::onEditRedoInternal() {}
void GUIMain::onEditCutInternal() {}
void GUIMain::onEditCopyInternal() {}
void GUIMain::onEditPasteInternal() {}
