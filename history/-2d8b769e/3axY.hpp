...
signals:
    ...
    /**
     * @brief Structured log line for UI console
     * Example: time=2025-12-02T22:54:07.082-05:00 level=INFO source=inference_engine.cpp:loadModel msg="loading gguf" path="C:/model.gguf"
     */
...
private:
    QString m_modelPath;
    GGUFLoader* m_loader;
    GGUFParser* m_parser;  // New GGUF v3 parser
    mutable QMutex m_mutex;
    QString m_quantMode{"Q4_0"};  // Default quantization
    QString m_detectedQuantFormat;  // Auto-detected quantization format (e.g., "Q2_K")
