...
#include "gguf_loader.hpp"
    // #include "transformer_inference.hpp"  // Disabled until GGML API compatibility resolved
...
private:
    ...
    // GGML inference context (disabled until API compatibility resolved)
    // ggml_context* m_ggmlCtx{nullptr};
    // QHash<QString, ggml_tensor*> m_ggmlTensors;
    
    // Transformer inference (disabled until GGML API compatibility resolved)
    ...
    // Tokenization helpers (disabled until transformer re-enabled)
