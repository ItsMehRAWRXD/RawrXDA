...
CreateOrchestraPanel proc
    ...
    CreateWnd "BUTTON", addr szStartButton, dwStyle, 0, 180, 60, 20, g_hMainWindow, 0
    mov hStart, eax
    mov g_hStartButton, eax
    
    CreateWnd "BUTTON", addr szPauseButton, dwStyle, 60, 180, 60, 20, g_hMainWindow, 0
    mov hPause, eax
    mov g_hPauseButton, eax
    
    CreateWnd "BUTTON", addr szStopButton, dwStyle, 120, 180, 60, 20, g_hMainWindow, 0
    mov hStop, eax
...
Orchestra_Initialize proc
    LOCAL szWelcome db 256 dup(0)
        ...
        invoke lstrcpy, addr szWelcome, addr szOrchestraWelcome
...
Orchestra_AppendStatus proc pszStatus:DWORD
    ...
    invoke GetTickCount
    invoke lstrcpy, addr szFullMessage, addr szStatusFormat
