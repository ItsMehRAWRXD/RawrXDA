...
CreateOrchestraPanel proc
    ...
    invoke CreateWindowEx, 0, addr WC_BUTTON, addr szStartButton, dwStyle, 0, 180, 60, 20, g_hMainWindow, 0, g_hInstance, NULL
    mov hStart, eax
    mov g_hStartButton, eax
    
    invoke CreateWindowEx, 0, addr WC_BUTTON, addr szPauseButton, dwStyle, 60, 180, 60, 20, g_hMainWindow, 0, g_hInstance, NULL
    mov hPause, eax
    mov g_hPauseButton, eax
    
    invoke CreateWindowEx, 0, addr WC_BUTTON, addr szStopButton, dwStyle, 120, 180, 60, 20, g_hMainWindow, 0, g_hInstance, NULL
    mov hStop, eax
