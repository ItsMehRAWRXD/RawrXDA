...
; External declarations for main window and font
...
CreateOrchestraPanel proc
    ...
    CreateWnd szOrchestraClass, NULL, dwStyle, 0, 0, 400, 200, hMainWindow, IDC_ORCHESTRA
    mov hPanel, eax
    ...
    ; Set font
    invoke SendMessage, hPanel, WM_SETFONT, hMainFont, TRUE
    
    ; Create control buttons
    mov dwStyle, WS_CHILD or WS_VISIBLE or BS_PUSHBUTTON
    
    CreateWnd "BUTTON", addr szStartButton, dwStyle, 0, 180, 60, 20, hMainWindow, 0
    mov hStart, eax
    mov g_hStartButton, eax
    
    CreateWnd "BUTTON", addr szPauseButton, dwStyle, 60, 180, 60, 20, hMainWindow, 0
    mov hPause, eax
    mov g_hPauseButton, eax
    
    CreateWnd "BUTTON", addr szStopButton, dwStyle, 120, 180, 60, 20, hMainWindow, 0
    mov hStop, eax
...
Orchestra_Initialize proc
    ...
    invoke wsprintfA, addr szWelcome, addr szOrchestraWelcome
    invoke SendMessage, g_hOrchestraPanel, WM_SETTEXT, 0, addr szWelcome
