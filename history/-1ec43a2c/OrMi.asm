...
MainDispatcher PROC
    ...
    POLYMACRO
    ; Task 16: Force RSP 16-byte alignment before any calls
    ENSURE_RSP_ALIGNED
    sub rsp, 48h  ; aligned + shadow space
...
_start_entry PROC
    ; Task 16: Force RSP 16-byte alignment per MS x64 ABI
    ENSURE_RSP_ALIGNED
    sub rsp, 28h ; align + shadow space
    call MainDispatcher
    xor rcx, rcx
    call ExitProcess
_start_entry ENDP
