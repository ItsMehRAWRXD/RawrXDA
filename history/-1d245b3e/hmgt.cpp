...
void InferenceEngine::streamingGenerateWorkerSignals(qint64 reqId, const QString& prompt, int maxTokens)
{
    ...
    // We allow multiple reads/generations if the underlying backend supports it,
    // but here we serialize critical sections to prevent race conditions on shared state.
