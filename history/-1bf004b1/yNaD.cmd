...
REM Link
echo Linking...
%MASM_PATH%\link.exe /nologo /subsystem:console /entry:main build\Release\gguf_analyzer_working.obj /LIBPATH:"C:\Program Files (x86)\Windows Kits\10\Lib\10.0.22621.0\um\x64" kernel32.lib /out:build\Release\gguf_analyzer_working.exe
