...
enum TokenType {
    ...
    TOK_XOR, TOK_CALL, TOK_JMP, TOK_LEA, TOK_CMP, TOK_JE, TOK_JNE
};
...
const char* keywords[] = {
    ...
    "MOV","ADD","SUB","RET","PUSH","POP","XOR","CALL","JMP","LEA","CMP","JE","JNE",
    nullptr
};
...
TokenType kwTypes[] = {
    ...
    TOK_MOV,TOK_ADD,TOK_SUB,TOK_RET,TOK_PUSH,TOK_POP,TOK_XOR,TOK_CALL,TOK_JMP,TOK_LEA,TOK_CMP,TOK_JE,TOK_JNE
};
