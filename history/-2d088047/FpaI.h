...
private slots:
    ...
    // ==== ModelTrainer enhancement slots ====
    void openTrainingDialog();
    void viewTrainingProgress();
    void viewModelRegistry();
    void startProfiling();
    void stopProfiling();
    void openObservabilityDashboard();
    void configureHardwareBackend();
    void manageSecuritySettings();
    void startDistributedTraining();
    void viewInterpretabilityReport();
    void openCIPipelineSettings();
    void configureTokenizerLanguage();
