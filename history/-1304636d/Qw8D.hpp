...
private:
    ...
    void scheduleReadyTasks(PlanState& plan);
    void propagateCompletion(PlanState& plan, const QString& taskId);
    ...
    void maybeFinalizePlan(const QString& planId, PlanState& plan);
};
