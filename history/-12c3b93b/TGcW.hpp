...
struct InvocationParams {
    ...
    QByteArray imageData;                   ///< Base64-encoded image for vision models
    QString imageMediaType;                 ///< MIME type: "image/png", "image/jpeg", etc.
    bool hasImage() const { return !imageData.isEmpty(); }
};
...
public:
     ...
     */
    LLMResponse analyzeImage(const QByteArray& imageData,
     ...
     */
    LLMResponse analyzeScreenshot(const QString& prompt);
