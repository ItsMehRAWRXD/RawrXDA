...
; External file tree handle from file_tree_working_enhanced
...
InitializeUILayout proc
    ...
    ; Create file explorer (left panel) - uses file_tree_working_enhanced
    call CreateFileTree
    ; File tree handle is in external g_hFileTree
