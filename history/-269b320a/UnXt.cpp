...
const FeatureDefV2 g_FeatureManifest[TOTAL_FEATURES] = {
    ...
    { FeatureID::ModelComparison,       "Model Comparison",         "Side-by-side model output comparison",   LicenseTierV2::Professional, true,  false, false, "src/core/chain_of_thought_engine.cpp","Phase 32A" },
    { FeatureID::BatchProcessing,       "Batch Processing",         "Process multiple prompts in batch",      LicenseTierV2::Professional, true,  false, false, "src/engine/core_generator.cpp",      "Phase 3" },
    { FeatureID::CustomStopSequences,   "Custom Stop Sequences",    "User-defined generation terminators",    LicenseTierV2::Professional, true,  false, false, "src/engine/sampler.cpp",             "Phase 3" },
    { FeatureID::GrammarConstrainedGen, "Grammar-Constrained Gen",  "BNF/regex constrained generation",       LicenseTierV2::Professional, true,  false, false, "src/engine/sampler.cpp",             "Phase 3" },
    { FeatureID::LoRAAdapterSupport,    "LoRA Adapter Support",     "Load and apply LoRA adapters",           LicenseTierV2::Professional, true,  false, false, "src/engine/gguf_core.cpp",           "Phase 23" },
    { FeatureID::ResponseCaching,       "Response Caching",         "Cache identical prompt responses",        LicenseTierV2::Professional, true,  false, false, "src/core/native_inference_pipeline.cpp","Phase 9" },
    { FeatureID::PromptLibrary,         "Prompt Library",           "Persistent prompt storage/retrieval",     LicenseTierV2::Professional, true,  false, false, "src/agentic/FIMPromptBuilder.cpp",    "Phase 10" },
    { FeatureID::ExportImportSessions,  "Export/Import Sessions",   "Save and load chat sessions",            LicenseTierV2::Professional, true,  false, false, "src/win32app/Win32IDE_Session.cpp",   "Phase 33" },
    ...
    { FeatureID::ModelSharding,         "Model Sharding",           "Split model across storage/memory",      LicenseTierV2::Enterprise,   true,  false, false, "src/core/layer_offload_manager.cpp",  "Phase 9" },
    { FeatureID::TensorParallel,        "Tensor Parallel",          "Parallel tensor computation",            LicenseTierV2::Enterprise,   true,  false, false, "src/core/adaptive_pipeline_parallel.cpp","Phase 22" },
    { FeatureID::PipelineParallel,      "Pipeline Parallel",        "Pipeline-parallel inference stages",     LicenseTierV2::Enterprise,   true,  false, false, "src/core/distributed_pipeline_orchestrator.cpp","Phase 13" },
    ...
    { FeatureID::CustomQuantSchemes,    "Custom Quant Schemes",     "User-defined quantization formats",      LicenseTierV2::Enterprise,   true,  false, false, "src/core/gpu_kernel_autotuner.cpp",   "Phase 23" },
    { FeatureID::MultiGPULoadBalance,   "Multi-GPU Load Balance",   "Distribute across multiple GPUs",        LicenseTierV2::Enterprise,   true,  false, false, "src/core/accelerator_router.cpp",     "Phase 30" },
    { FeatureID::DynamicBatchSizing,    "Dynamic Batch Sizing",     "Auto-tune batch size at runtime",        LicenseTierV2::Enterprise,   true,  false, false, "src/core/execution_scheduler.cpp",    "Phase 9" },
    ...
    { FeatureID::APIKeyManagement,      "API Key Management",       "Generate and rotate API keys",            LicenseTierV2::Enterprise,   true,  false, false, "src/auth/rbac_engine.cpp",           "Phase 50" },
...
LicenseResult EnterpriseLicenseV2::initialize() {
    ...
    // If V1 license system has a valid license, inherit its tier
    extern RawrXD::EnterpriseLicense& GetEnterpriseLicenseV1() noexcept;
    try {
        auto& v1Lic = GetEnterpriseLicenseV1();
        if (v1Lic.IsEnterprise()) {
            // V1 has valid Enterprise license → map to V2 Enterprise tier
            m_tier = LicenseTierV2::Enterprise;
            m_enabledFeatures = TierPresets::Enterprise();
        }
        // Note: V1 Trial/Pro detection would go here in future phases
    } catch (...) {
        // V1 not available, non-fatal
    }
