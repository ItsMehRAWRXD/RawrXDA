...
disasm_ret:
    invoke  lstrcpyA, rdi, str$("ret")
    add     rdi, 4
    jmp     disasm_next
    
disasm_nop:
    invoke  lstrcpyA, rdi, str$("nop")
    add     rdi, 4
    jmp     disasm_next
    
disasm_rex:
    invoke  lstrcpyA, rdi, str$("rex.w")
    add     rdi, 6
...
AnalyzePEHeader PROC
    ...
    ; Open file
    invoke  CreateFileA, rbx, GENERIC_READ, FILE_SHARE_READ, 0, OPEN_EXISTING, 0, 0
    ...
    ; Create mapping
    invoke  CreateFileMappingA, rsi, 0, PAGE_READONLY, 0, 0, 0
    test    rax, rax
    jz      analyze_close
    mov     r8, rax         ; mapping handle
    
    ; Map view
    invoke  MapViewOfFile, r8, FILE_MAP_READ, 0, 0, 0
    test    rax, rax
    jz      analyze_unmap
    ...
    invoke  GlobalAlloc, GPTR, SIZEOF ANALYSIS_RESULT
    mov     rbx, rax
...
hexdump_loop:
    ...
    invoke  wsprintfA, rdi, str$("%08X: "), r9
    add     rdi, 10
...
hex_bytes:
    ...
    invoke  wsprintfA, rdi, str$("%02X "), al
    add     rdi, 3
    inc     r10
    jmp     hex_bytes
    
hex_ascii:
    invoke  lstrcpyA, rdi, str$(" ")
    add     rdi, 1
