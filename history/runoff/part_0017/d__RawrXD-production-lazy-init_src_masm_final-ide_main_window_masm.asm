...
MainWindow_HandleAIChat proc
    sub rsp, 32
    mov rcx, g_mainWindow.hChatPanel
    call ui_show_dialog
    add rsp, 32
...
MainWindow_HandleSettings proc
    sub rsp, 32
    mov rcx, g_mainWindow.hSettingsDialog
    call ui_show_dialog
    add rsp, 32
    ret
...
MainWindow_HandleHotpatchPanel proc
    sub rsp, 32
    mov rcx, g_mainWindow.hHotpatchPanel
    call ui_show_dialog
    add rsp, 32

    sub rsp, 32
    lea rcx, szStatusHotpatchReady
    call MainWindow_SetStatusMessage
    add rsp, 32
    ret
