...
szStringCreateStart BYTE "String creation starting.", 0
szStringCreateSuccess BYTE "String creation successful.", 0
szStringCreateEmpty BYTE "Empty string created.", 0
szStringCreateFailed BYTE "String creation failed.", 0
...
asm_str_create_from_cstr PROC
    ...
    ; ============================================================================
    ; PHASE 3: Enable strict bounds checking in development mode
    ; ============================================================================
    PUSH rcx
    CALL Config_IsProduction
    POP rcx
    TEST rax, rax
    JNZ skip_bounds_check
    
    ; Development mode: Verify string is not too long (prevent buffer overflow)
    XOR rdx, rdx
    MOV r8, 65535       ; Max safe string length
bounds_check_loop:
    CMP rdx, r8
    JGE create_from_cstr_null  ; Too long, return NULL
    CMP BYTE PTR [rcx + rdx], 0
    JE skip_bounds_check
    INC rdx
    JMP bounds_check_loop
...
asm_str_create PROC
    ...
    ; ============================================================================
    ; Log string creation start
    ; ============================================================================
    LEA rcx, [rel szStringCreateStart]
    ...
    ; ============================================================================
    ; Log string creation success
    ; ============================================================================
    LEA rcx, [rel szStringCreateSuccess]
...
str_create_empty:
    ...
    ; ============================================================================
    ; Log empty string creation
    ; ============================================================================
    LEA rcx, [rel szStringCreateEmpty]
    MOV rdx, LOG_LEVEL_INFO
    CALL Logger_LogStructured
...
str_create_fail:
    ; ============================================================================
    ; Log string creation failure
    ; ============================================================================
    LEA rcx, [rel szStringCreateFailed]
