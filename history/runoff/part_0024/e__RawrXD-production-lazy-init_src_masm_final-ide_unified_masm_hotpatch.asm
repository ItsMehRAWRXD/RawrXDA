...
.data
    ...
    msg_feature_disabled BYTE "Hotpatch feature disabled",0
...
hpatch_apply_memory PROC
    ...
    ; ============================================================================
    ; PHASE 3: Check if dynamic hotpatching is enabled
    ; ============================================================================
    MOV ecx, FEATURE_HOTPATCH_DYNAMIC
    CALL Config_IsFeatureEnabled
    TEST rax, rax
    JZ hotpatch_disabled
...
hotpatch_disabled:
    ; Hotpatching feature is disabled - return failure
    lea rsi, msg_feature_disabled
    lea rdi, last_error
    call strcpy_helper
    lea rax, [rsp + 0]
    ...
    lea rcx, last_error
    mov QWORD PTR [rax + PatchResult.detail], rcx
    mov DWORD PTR [rax + PatchResult.error_code], -99
    add rsp, 48
    pop r15
    pop r14
    pop r13
