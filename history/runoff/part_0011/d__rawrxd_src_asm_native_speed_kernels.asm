...
; =============================================================================
; dequant_q8_0_avx512 — Production (optimized AVX2 fallback)
; =============================================================================
...
; =============================================================================
; dequant_q2k_avx2 — Production Q2_K dequantization with SIMD optimization
; =============================================================================
dequant_q2k_avx2 PROC FRAME
    ...
    ; Q2_K production implementation with SIMD-optimized dequantization
    vzeroupper
    pop rbp
    ret
