// Define GGML_BUILD before including GGML headers to avoid duplicate symbols
#define GGML_BUILD
...
// NOTE: GetMetadata() is already implemented earlier in this file (around line 166).
// This duplicate implementation caused C2039 errors for non-existent member variables.
// The working implementation is in the earlier part of this file.

// NOTE: Duplicate method definitions removed to fix C2084 errors.
// The correct implementations are earlier in this file (around lines 166-460).
// These were causing "function already has a body" compiler errors.
