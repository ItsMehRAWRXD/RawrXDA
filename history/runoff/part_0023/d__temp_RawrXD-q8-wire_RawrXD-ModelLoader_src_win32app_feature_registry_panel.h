...
// Integrates with EnterpriseLicenseManager for real-time gating display
...
// ============================================================================
// Feature Display Item — UI-ready version of FeatureManifestEntry
// ============================================================================
struct FeatureDisplayItem {
    EnterpriseFeature featureId;
    std::string name;
...
public:
    ...
    // Callbacks
    using FeatureSelectedCallback = std::function<void(EnterpriseFeature)>;
