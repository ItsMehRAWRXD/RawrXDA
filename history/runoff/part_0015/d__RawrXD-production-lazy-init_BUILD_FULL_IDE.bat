...
REM =====================================================================
echo.
REM STEP 3: Compiling reverse_engineering.asm...
"%ML64%" /c /Fo"reverse_engineering.obj" /nologo /W3 /Zi reverse_engineering_simple.asm
if !errorlevel! neq 0 (
    echo ❌ FAILED: reverse_engineering_simple.asm
    exit /b 1
) else (
