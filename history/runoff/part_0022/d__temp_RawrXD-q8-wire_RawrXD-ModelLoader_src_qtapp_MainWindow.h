...
private slots: /* ----------  original slots  ---------- */
    ...
    // ComponentFactory-based Agent Signal Handlers (New)
...
private slots: /* ----------  new IDE-wide slots  ---------- */
    ...
    // AI/Inference signal handlers
    void onStreamTokenReceived(qint64 reqId, const QString& token);
    void onStreamFinished(qint64 reqId);
...
private: /* ---------------  new IDE members  --------------- */
    ...
    class ExecutionContext* m_executionContext{}; // Execution context for agent operations
    QString m_currentGoal{};                   // Currently active goal/wish
    ...
    // Agent system helper methods
    QString buildExecutionContext() const;
    QString getSelectedText() const;
    QStringList getOpenTabsList() const;
};
