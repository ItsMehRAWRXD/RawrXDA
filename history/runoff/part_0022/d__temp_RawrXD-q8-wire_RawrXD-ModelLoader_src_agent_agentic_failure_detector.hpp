...
public:
    ...
    struct Stats {
        std::int64_t totalOutputsAnalyzed = 0;
        std::unordered_map<int, std::int64_t> failureTypeCounts;
        double avgConfidence = 0.0;
        std::int64_t truePredictions = 0;
        std::int64_t falsePredictions = 0;
    };
...
private:
    ...
    Stats m_stats;
    bool m_enabled = true;
    std::int64_t m_sequenceNumber = 0;
};
