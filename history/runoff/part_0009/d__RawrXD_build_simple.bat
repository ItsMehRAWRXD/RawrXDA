...
REM Link CLI
echo     Linking CLI...
link /SUBSYSTEM:CONSOLE /ENTRY:main /OUT:"%OUT_DIR%\RawrXD-CLI.exe" /DEBUG /PDB:"%OUT_DIR%\RawrXD-CLI.pdb" /LIBPATH:"%SDK_LIB%" /LIBPATH:"%UCRT_LIB%" "%OUT_DIR%\RawrXD_CLI_Titan.obj" %OBJS% kernel32.lib user32.lib ntdll.lib ws2_32.lib
if errorlevel 1 (
...
REM Link GUI
echo     Linking GUI...
link /SUBSYSTEM:WINDOWS /ENTRY:WinMain /OUT:"%OUT_DIR%\RawrXD-IDE.exe" /DEBUG /PDB:"%OUT_DIR%\RawrXD-IDE.pdb" /LIBPATH:"%SDK_LIB%" /LIBPATH:"%UCRT_LIB%" "%OUT_DIR%\RawrXD_GUI_Titan.obj" %OBJS% kernel32.lib user32.lib gdi32.lib comctl32.lib ntdll.lib ws2_32.lib
if errorlevel 1 (
