...
size_t QuickJSExtensionHost::getLoadedExtensionCount() const {
    // In stub mode, report 0 — but log so users know why
    OutputDebugStringA("[QuickJS Stub] getLoadedExtensionCount: QuickJS runtime not linked");
    return 0;
}
size_t QuickJSExtensionHost::getActiveExtensionCount() const {
    OutputDebugStringA("[QuickJS Stub] getActiveExtensionCount: QuickJS runtime not linked");
    return 0;
}
