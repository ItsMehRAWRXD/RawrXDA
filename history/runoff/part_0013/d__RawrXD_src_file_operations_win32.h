...
public:
    ...
    // List files in directory (replaces QDir::entryList)
    ...
    // Read file content (replaces QFile::readAll)
    ...
    // Write file content (replaces QFile::write)
    ...
    // Check if file exists (replaces QFile::exists)
    ...
    // Delete file (replaces QFile::remove)
    ...
    // Create directory (replaces QDir::mkpath)
...
// Helper functions (replaces standalone functions from QDir/QFile)
