...
echo ===============================================
echo.
echo Starting Native IDE System...
echo.
...
if exist "..\native-ide\btnBuilder.java" (
    ...
    cd ..\native-ide
    start java --source 21 btnBuilder.java
    cd ..\NativeIDE
) else (
    ...
    REM Create templates if they don't exist
    if not exist templates mkdir templates
    if not exist templates\hello.c (
