...
OpenGGUFFile        PROTO :QWORD
ValidateGGUFHeader  PROTO :QWORD, :QWORD
SkipMetadataKV      PROTO :QWORD, :QWORD
...
CountParameters     PROTO :QWORD
ExtractLayerIndex   PROTO :QWORD
strstr_ffn          PROTO :QWORD
strstr_attention    PROTO :QWORD
strstr_embed        PROTO :QWORD
strstr_norm         PROTO :QWORD
byte_compare        PROTO :QWORD, :QWORD
PrintString         PROTO :QWORD
...
main PROC
    ...
    mov rax, [gguf_header].metadata_kv
    mov rdx, r12
    call SkipMetadataKV
    test rax, rax
    jz metadata_error
...
WriteExecFile PROC
    ...
    ; Create output file
    invoke CreateFileA, rbx, GENERIC_WRITE, 0, 0,
...
; ---------------------------------------------------------------------------
; External function prototypes (from kernel32.lib)
; ---------------------------------------------------------------------------
...
SetFilePointerEx PROTO :QWORD, :QWORD, :QWORD, :DWORD
