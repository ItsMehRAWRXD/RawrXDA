...
; PROTO declarations for INVOKE
ErrorLogging_LogEvent PROTO :DWORD, :DWORD
...
AgenticIDE_LoadSettings PROC lpProfileName:DWORD
    ...
    invoke ReadFile, hFile, addr g_ToolConfigs, ecx, addr bytesRead, NULL
    test eax, eax
    jz @CloseFile
    
    invoke CloseHandle, hFile
    
    invoke ErrorLogging_LogEvent, 0, OFFSET szConfigLoaded
