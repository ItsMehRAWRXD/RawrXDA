...
;     RichEdit would provide syntax highlighting, undo/redo, and rich formatting.
; ============================================================================
...
; NOTE: RichEdit support deferred; would require:
...
; Local strings defined above, no extern needed
