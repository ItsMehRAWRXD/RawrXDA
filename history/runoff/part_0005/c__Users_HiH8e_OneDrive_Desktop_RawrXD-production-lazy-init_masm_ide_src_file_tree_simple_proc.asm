...
; Creates a basic tree view window.
...
; ---------------------------------------------------------------
CreateFileTree proc hInstance:DWORD, hMainWindow:DWORD
    LOCAL dwStyle:DWORD

    ; Create the tree view control
    mov dwStyle, WS_CHILD or WS_VISIBLE or 1h or 2h or 4h or 20h  ; TVS flags
    invoke CreateWindowEx, 0, addr szTreeClass, NULL, dwStyle, 0, 0, 200, 400, hMainWindow, 1000, hInstance, NULL
    mov g_hFileTree, eax
