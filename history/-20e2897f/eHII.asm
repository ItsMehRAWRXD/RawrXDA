...
rawr1024_menu_load_model PROC
    ...
    lea     rcx, model_load_dialog.file_path
...
status_loop:
    ...
    mov     r8d, [rsi + ENGINE_STATE.id]
    mov     r9d, [rsi + ENGINE_STATE.status]
    mov     r10d, [rsi + ENGINE_STATE.progress]
    mov     r11d, [rsi + ENGINE_STATE.error_code]
