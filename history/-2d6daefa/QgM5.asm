...
msgGoalTest     db "Implement a simple hello world", 0
msgGoalComplex  db "Implement a zero-shot meta-reasoning agent for self-correction", 0
msgPhase6Complex db "[6b] Testing Complex Goal Routing...", 13, 10, 0
msgComplexity   db "    Complexity Level: ", 0
msgZeroDayUsed  db "    [ROUTE] Zero-Day Agentic Engine selected", 13, 10, 0
msgFallbackUsed db "    [ROUTE] Standard Engine selected (fallback)", 13, 10, 0
msgWorkspace    db "c:\temp\workspace", 0
