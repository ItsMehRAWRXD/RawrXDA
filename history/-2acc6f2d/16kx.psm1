...
function Invoke-IntegrationTests {
    ...
    $functionName = 'Invoke-IntegrationTests'
    $startTime = Get-Date
    
    try {
        Write-StructuredLog -Message "Starting integration tests" -Level Info -Function $functionName -Data @{
            ModuleCount = $ModulePaths.Count
        }
        
        $suite = [TestSuite]::new()
        $suite.SuiteName = "IntegrationTests"
        $suite.ModuleName = "Multiple"
        
        # Test 1: Modules load together
        $testStart = Get-Date
        $testResult = [TestResult]::new()
        $testResult.TestName = "Integration_ModulesLoadTogether"
        ...
        try {
            ...
            $testResult.Status = "Passed"
            $testResult.Data["LoadSuccess"] = $true
            $testResult.Data["ModuleCount"] = $ModulePaths.Count
        } catch {
            $testResult.Status = "Failed"
            $testResult.ErrorMessage = $_.Message
            $testResult.Data["LoadSuccess"] = $false
        ...
        # Test 2: Cross-module function calls
        $testStart = Get-Date
        $testResult = [TestResult]::new()
        ...
        Write-StructuredLog -Message "Integration tests failed: $_" -Level Error -Function $functionName
        throw
    }
}
...
function Invoke-ComprehensiveTestSuite {
    ...
    .EXAMPLE
        Invoke-ComprehensiveTestSuite -ModulePaths @("C:\\RawrXD\\RawrXD.Logging.psm1") -OutputPath "C:\\RawrXD\\TestResults"
...
# Export functions
Export-ModuleMember -Function Invoke-ModuleUnitTests, Invoke-IntegrationTests, Invoke-PerformanceTests, Invoke-SecurityTests, Invoke-ComprehensiveTestSuite