...
NativeWidget::NativeWidget(HWND parentHwnd)
    : m_parent(nullptr), m_hwnd(nullptr)
{
    // This constructor is for creating child widgets under an existing HWND
    // The actual window creation will be handled by derived classes
}
