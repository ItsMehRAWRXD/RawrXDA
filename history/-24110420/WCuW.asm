...
; POST body for /api/generate — real prompt, stream=false
szGenBody   BYTE '{"model":"bigdaddyg-alldrive:latest","prompt":"Say hello in one sentence.","stream":false,"options":{"temperature":0.1}}',0
