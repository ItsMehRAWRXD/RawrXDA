...
qint64 ModelQueue::enqueue(const QString& modelPath, const QString& prompt,
    ...
    // Professional License Gate — Multi-Model Queue requires Professional tier
    if (!LicenseEnforcementGate::getInstance().checkAccess(EnterpriseFeature::MultiModelQueue, "enqueue")) {
        return -1;
    }
