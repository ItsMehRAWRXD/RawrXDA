    ...
    def __init__(self):
        ...
        if ML_AVAILABLE:
            try:
                ...
                print("[✓] ML Malware Detector initialized")
            except Exception as e:
                print(f"[!] Failed to initialize ML detector: {str(e)}")
        
    def scan_file(self, file_path: str) -> Dict:
        """Comprehensive file scan with ML classification"""
        ...
        results = {
            ...
            "threat_level": "Clean",
            "confidence": 0,
            "ml_analysis": None  # Will be populated if ML is available
        }
        ...
        # ML-based detection (runs first for quick classification)
        if self.ml_detector:
            print("[*] Performing ML-based classification...")
            ...
            # Add ML detection if malware detected
            if ml_result['is_malware'] and ml_result['confidence'] >= 70:
                results["detections"].append({
                    "engine": "ML Classifier",
                    "detection": f"ML-Detected (Score: {ml_result['score']:.1f}%)",
