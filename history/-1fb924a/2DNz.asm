...
AgenticIDE_TerminalExec_Admin PROC lpParams:DWORD, pResult:DWORD
    ...
    test eax, eax
    jz @Fail
    invoke GetTempFileNameA, addr tmpPath, "RXD", 0, addr tmpFile
    test eax, eax
    jz @Fail
...
@BuildPwsh:
    ...
    invoke lstrcatA, addr args, "pwsh.exe -NoProfile -NonInteractive -Command "
    invoke lstrcatA, addr args, "\""
    mov eax, [ebx].TerminalExecParams.lpCommand
    invoke lstrcatA, addr args, eax
    invoke lstrcatA, addr args, "\""

@AddRedirect:
    invoke lstrcatA, addr args, " 1> \""
    invoke lstrcatA, addr args, addr tmpFile
    invoke lstrcatA, addr args, "\" 2>&1"
