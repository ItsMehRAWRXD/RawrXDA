...
AgenticIDE_Tool_ModelLoad PROC lpParams:DWORD, pResult:DWORD
    ...
    ; unsupported
    mov esi, pResult
    invoke lstrcpyA, addr [esi].ToolResult.szErrorMsg, CStr("Unsupported model source")
    xor eax, eax
    ret
...
@OllamaPull:
    ...
    invoke lstrcpyA, addr cmdLine, addr szCmdPrefix
    invoke lstrcatA, addr cmdLine, CStr("ollama pull ")
...
@OllamaList:
    invoke lstrcpyA, addr cmdLine, addr szCmdPrefix
    invoke lstrcatA, addr cmdLine, CStr("ollama list")
    push pResult
    push 0
    lea eax, cmdLine
    push eax
...
@OllamaRun:
    invoke lstrcpyA, addr cmdLine, addr szCmdPrefix
    invoke lstrcatA, addr cmdLine, CStr("ollama run ")
    mov eax, [ebx].ModelActionParams.lpModelOrUrl
    invoke lstrcatA, addr cmdLine, eax
    invoke lstrcatA, addr cmdLine, CStr(" ")
    invoke lstrcatA, addr cmdLine, addr szQuote
