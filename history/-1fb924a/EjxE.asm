...
@AdminLaunch:
    ; Best-effort: run non-captured in current integrity (caller can still use non-admin profile for capture)
    mov [esi].ToolResult.lpResultData, OFFSET szAdminNotCaptured
    invoke lstrlenA, addr szAdminNotCaptured
