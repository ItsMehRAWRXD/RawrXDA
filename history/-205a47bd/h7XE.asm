...
; C++ AgentHotPatcher (via Bridge)
EXTERN cpp_agent_hotpatcher_init:PROC
EXTERN cpp_detect_hallucination:PROC
EXTERN cpp_correct_hallucination:PROC
...
AgenticEngine_Initialize PROC
    ...
    ; 1. Initialize C++ Hotpatcher
    xor rcx, rcx ; Default flags
    call cpp_agent_hotpatcher_init
