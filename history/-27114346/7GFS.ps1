...
$currentObjs = [System.Collections.Generic.List[System.IO.FileInfo]]::new($uniqueObjs)
...
while ($attempt -le $maxAttempts) {
    ...
    $match = [regex]::Match($fullOutput, '([a-zA-Z0-9_.-]+\.obj)\s*:\s*(?:fatal\s+)?error\s+LNK(?:1223|1112|1143|1136|1107|1104|2017)')
