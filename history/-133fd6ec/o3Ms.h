...
public:
    ...
    HRESULT GetDesc(D3D11_SHADER_TYPE_DESC* out) const { if (out) *out = typeDesc; return S_OK; }
    static D3D10EffectType* make(const D3D11_SHADER_TYPE_DESC& d) { auto p = new D3D10EffectType; p->typeDesc = d; return p; }
};
