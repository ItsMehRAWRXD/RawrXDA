...
// #include <d3dcompiler.h> // Removed to avoid ID3D10Effect redefinition
#include <vector>
#include <string>
...
// ------------------------------------------------------------------------------
class D3D10Effect;
class D3D10EffectTechnique;
class D3D10EffectPass;
class D3D10EffectVariable;
class D3D10EffectConstantBuffer;
class D3D10EffectType;

typedef D3D10Effect ID3D10Effect;
typedef D3D10EffectTechnique ID3D10EffectTechnique;
typedef D3D10EffectPass ID3D10EffectPass;
typedef D3D10EffectVariable ID3D10EffectVariable;
typedef D3D10EffectConstantBuffer ID3D10EffectConstantBuffer;
typedef D3D10EffectType ID3D10EffectType;
