...
Compiler_RunBuildPipeline PROTO :DWORD
Compiler_RunCodeGenerator PROTO :DWORD
Compiler_RunPreprocessor PROTO :DWORD
Compiler_RunOptimizer PROTO :DWORD
...
HandleMenuCommand proc wParam:DWORD, lParam:DWORD
    ...
    cmp eax, 1200  ; Build->Build Pipeline
    je @OnBuildPipeline
    cmp eax, 1201  ; Build->Run Code Generator
    je @OnBuildCodegen

    ; AI/Tools menu commands (1300-1399)
    cmp eax, 1300  ; Tools->Macro Preprocess
    je @OnToolsPreprocess
    cmp eax, 1301  ; Tools->Run Optimizer
    je @OnToolsOptimize
...
@OnBuildPipeline:
    invoke Compiler_RunBuildPipeline, g_hMainWindow
    ret

@OnBuildCodegen:
    invoke Compiler_RunCodeGenerator, g_hMainWindow
    ret

@OnToolsPreprocess:
    invoke Compiler_RunPreprocessor, g_hMainWindow
    ret

@OnToolsOptimize:
    invoke Compiler_RunOptimizer, g_hMainWindow
    ret
