...
GGUFStream_EnableWirecap proto :DWORD
GGUFStream_DisableWirecap proto
...
.data
    ...
    szWirecap  db "C:\\Users\\HiH8e\\OneDrive\\Desktop\\RawrXD-production-lazy-init\\masm_ide\\build\\gguf_wirecap.bin",0
...
WinMain proc hInst:DWORD, hPrev:DWORD, lpCmd:DWORD, nCmd:DWORD
    ...
    ; Optional: mirror streamed bytes to a capture file for beacon/wirecap analysis
    push offset szWirecap
    call GGUFStream_EnableWirecap
...
@Done:
    ; Stop wirecap if enabled
    call GGUFStream_DisableWirecap
...
@OpenFailed:
    ; Print open error and GetLastError
    push 0
    push 0
