; Universal Compiler Runtime - NASM x64 - Minimal Core Symbols
; Provides all required symbols for compiler_from_scratch.asm implementations
; Pure NASM syntax, no external dependencies, Windows x64 calling convention
