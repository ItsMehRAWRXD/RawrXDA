...
// Windows-specific process enumeration compatibility
...
// Extended TCP table compatibility
#ifndef TCP_TABLE_OWNER_PID_ALL
#define TCP_TABLE_OWNER_PID_ALL 5
#endif

// Function forward declarations to prevent conflicts
#ifdef __cplusplus
extern "C" {
#endif

// Beacon functions (if enabled)
#ifdef MIRAI_BEACON
void beacon_init(void);
void beacon_checkin(void);
#endif
