...
PUBLIC ProcessDroppedFile
PUBLIC GetFileExtension
PUBLIC RouteFileByExtension
PUBLIC OpenMASMFile
PUBLIC OpenTextFile
...
OpenMASMFile PROC
    ...
    ; Copy filename to szFileName for existing loading infrastructure
    lea rdi, szFileName
    mov rsi, rcx
...
copy_done:
    ; Use existing file loading infrastructure
    call ui_load_selected_file
