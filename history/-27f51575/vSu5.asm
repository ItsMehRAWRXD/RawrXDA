...
@write_content:
    ...
    mov eax, g_FileState.pBuffer
    push edx
    mov edx, g_FileState.dwBytesRead
    invoke WriteFile, hFile, eax, edx, addr dwBytesWritten, NULL
    pop edx
    pop eax
    test eax, eax
    jz @write_fail
    
    ; Verify bytes written (reload from memory to avoid register issues)
    mov ecx, dwBytesWritten
    cmp ecx, g_FileState.dwBytesRead
    jne @write_fail
