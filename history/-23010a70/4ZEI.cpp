...
void CloudRunnerWidget::dispatchWorkflow(const QString& instanceType, const QString& zipUrl) {
    ...
    connect(reply, &QNetworkReply::finished, this, &CloudRunnerWidget::onDispatchFinished);
}
...
void CloudRunnerWidget::downloadArtifacts(const QString& runId) {
    ...
    connect(reply, &QNetworkReply::finished, this, &CloudRunnerWidget::onPollFinished);
}
