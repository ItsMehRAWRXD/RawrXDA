...
// --- AdvancedFeatures ---
// Implementation moved to AdvancedFeatures.h

namespace RawrXD {
// ReactServerGenerator impl moved to ReactServerGenerator.h
} 
...
std::vector<std::string> AgenticEngine::getAvailableModels() { return {"default"}; }uery.rfind("/react-server", 0) { // Check for react-server command
