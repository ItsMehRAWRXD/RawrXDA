...
g_dwWordLens        dd 256 dup(?)   ; Parallel table of word le\
ngths
...
; Returns RAX = length
; ---------------------------------------------------------
reverse_string_inplace proc frame
    push rbx
    .pushreg rbx
    push rsi
    .pushreg rsi
...
; ---------------------------------------------------------
apply_text_reversal proc frame
    push rbx
    .pushreg rbx
    push rsi
    .pushreg rsi
