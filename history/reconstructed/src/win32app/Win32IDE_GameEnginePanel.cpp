...
void Win32IDE::showGameEngineStatusDialog() {
    ...
    MessageBoxA(m_hwndMain, status.c_str(), "Game Engine Status — RawrXD IDE",
...
void Win32IDE::cmdGameEngineDetect() {
    ...
    if (result.isValid) {
        ...
        appendToOutput("[GameEngine] No game engine project detected at: " +
                       std::string(path) + "\n");
        MessageBoxA(m_hwndMain, "No Unity or Unreal Engine project found at this location.",
...
void Win32IDE::cmdUnityAssetBrowser() {
    ...
    for (const auto& [type, count] : typeCounts) {
        ...
        switch (static_cast<UnityAssetType>(type)) {
            ...
            case UnityAssetType::Audio:         typeName = "Audio";       break;
            case UnityAssetType::Animation:     typeName = "Animations";  break;
            case UnityAssetType::AnimController: typeName = "Animators";   break;
            case UnityAssetType::Font:          typeName = "Fonts";       break;
            case UnityAssetType::ScriptableObject: typeName = "ScriptableObjects"; break;
