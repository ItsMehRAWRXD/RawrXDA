...
public slots:
    ...
    void onSearchModeToggled(bool enabled);
    void onDeepResearchModeToggled(bool enabled);
    void onThinkingModeToggled(bool enabled);
...
signals:
    ...
    void deepResearchModeChanged(bool enabled);
    void thinkingModeChanged(bool enabled);
...
private:
    ...
    QCheckBox* searchModeToggle_;
    QCheckBox* deepResearchModeToggle_;
    QCheckBox* thinkingModeToggle_;
    QLabel* statusLabel_;
    bool maxMode_;
    bool searchMode_{false};
    bool deepResearchMode_{false};
