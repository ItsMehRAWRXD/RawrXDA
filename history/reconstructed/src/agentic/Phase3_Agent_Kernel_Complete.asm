...
ASYNC_IO_CONTEXT STRUCT
    ; Inline OVERLAPPED fields (replaces OVERLAPPED <> for ml64 compat)
    ovl_Internal        DQ ?            ; OVERLAPPED.Internal
    ovl_InternalHigh    DQ ?            ; OVERLAPPED.InternalHigh
    ovl_Offset          DD ?            ; OVERLAPPED.Offset
    ovl_OffsetHigh      DD ?            ; OVERLAPPED.OffsetHigh
    ovl_hEvent          DQ ?            ; OVERLAPPED.hEvent
...
SAFE_MAGIC_BYTES    DQ 08A8A8A8A8A8A8A8Ah  ; Safetensors header
TORCH_MAGIC_BYTES   DQ 01950A86A20F9469Ch  ; PyTorch pickle magic
...
Phase3Initialize PROC FRAME
    ...
    mov edx, SIZEOF AGENT_CONTEXT + 63
    and edx, NOT 63
