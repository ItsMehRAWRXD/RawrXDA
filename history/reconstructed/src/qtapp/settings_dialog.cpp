...
QWidget* SettingsDialog::createVisualTab()
{
    ...
    QCheckBox* darkModeToggle = new QCheckBox("Enable dark mode", themeGroup);
    QCheckBox* highContrastToggle = new QCheckBox("High contrast", themeGroup);
    themeLayout->addWidget(darkModeToggle);
    themeLayout->addWidget(highContrastToggle);
    themeGroup->setLayout(themeLayout);

    QGroupBox* fontGroup = new QGroupBox("Editor Font", tab);
    QVBoxLayout* fontLayout = new QVBoxLayout(fontGroup);
    QSpinBox* fontSize = new QSpinBox(fontGroup);
    fontSize->setRange(8, 48);
    fontSize->setValue(14);
    fontLayout->addWidget(new QLabel("Font size", fontGroup));
...
void SettingsDialog::applyVisualSettings()
{
    ...
    QMessageBox::information(this, "Visual Settings", "Visual settings applied!");
}
