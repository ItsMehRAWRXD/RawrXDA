...
sig_fsg             CODE_SIGNATURE <{0EBh, 02h, 0EBh, 05h, 0E8h}, {5 dup(0FFh)}, 5, 1, OFFSET Handle_FSG>
...
sig_timing          CODE_SIGNATURE <{0Fh, 31h, 89h, 44h, 24h, 00h, 0Fh, 31h, 2Bh, 44h, 24h}, {0FFh, 0FFh, 0FFh, 0FFh, 0FFh, 00h, 0FFh, 0FFh, 0FFh, 0FFh, 0FFh}, 11, 2, OFFSET Neutralize_Timing>
...
sig_flatten         CODE_SIGNATURE <{8Bh, 04h, 0Bh, 0FFh, 0E0h}, {5 dup(0FFh)}, 5, 3, OFFSET Unflatten_ControlFlow>
sig_opaque          CODE_SIGNATURE <{33h, 0C0h, 74h, 00h}, {0FFh, 0FFh, 0FFh, 00h}, 4, 4, OFFSET Simplify_Opaque>
sig_seh             CODE_SIGNATURE <{48h, 8Dh, 05h, 00h, 00h, 00h, 00h, 48h, 89h, 05h}, {0FFh, 0FFh, 0FFh, 00h, 00h, 00h, 00h, 0FFh, 0FFh, 0FFh}, 10, 5, OFFSET Handle_Metamorphic>
...
sig_decoy           CODE_SIGNATURE <{55h, 48h, 89h, 0E5h, 48h, 81h, 0ECh, 00h, 00h, 00h, 00h, 0C9h, 0C3h}, {0FFh, 0FFh, 0FFh, 0FFh, 0FFh, 0FFh, 0FFh, 00h, 00h, 00h, 00h, 0FFh, 0FFh}, 13, 6, OFFSET Eliminate_Decoy>
...
scan_loop:
    ...
    lea rdx, (CODE_SIGNATURE ptr [r14]).mask
    mov ecx, r15d
