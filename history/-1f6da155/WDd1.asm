...
; These are now defined in ui_system_complete.asm
...
IDEPaneSystem_CreateDefaultLayout PROC hParent:DWORD
    ...
    ; In a real implementation, this would create child windows for:
    ; 1. File Explorer / Project Tree
    ; 2. Output / Terminal
    ; 3. AI Chat / Browser
    
    invoke OutputDebugStringA, CSTR("IDEPaneSystem: Creating default 3-pane layout")
