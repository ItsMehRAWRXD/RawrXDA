...
gui_save_pane_layout PROC
    ...
    ; Use existing write_json_to_file function to save the layout
    ; The layout is already in PaneRegistry memory
    lea rcx, [LayoutSaveFile]       ; filename
    lea rdx, [PaneRegistry]         ; data buffer
    mov r8, SIZEOF PANE * MAX_PANES  ; size in bytes
    call write_json_to_file
...
gui_load_pane_layout PROC
    ...
    ; Copy filename to temp location
    mov rsi, rcx
    lea rdi, [LayoutSaveFile]
    mov ecx, 512
    rep movsb
    ...
    ; For now, initialize with default layout if file doesn't exist
    ; In production, would read file and parse JSON here
    ; This prevents crashes and maintains functionality
