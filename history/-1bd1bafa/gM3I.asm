...
config_done:
    ...
    ; File tree component (actual TreeView hwnd)
    ...
    ; Terminal component (bottom terminal RichEdit)
    ...
    mov rcx, rax
    lea rdx, szChatComp
    mov r8d, COMPONENT_CHAT
    call gui_create_component

    ; Input box component
    call ui_get_input_hwnd
    mov rcx, rax
    lea rdx, szInputComp
    mov r8d, COMPONENT_INPUT
    call gui_create_component
    ...
    ; Task Proposal Widget component
    call ui_get_task_proposal_hwnd
    mov rcx, rax
    lea rdx, szTaskProposalComp
    mov r8d, COMPONENT_TASK_PROPOSAL
    call gui_create_component

    ; Initialize task proposal widget
    call ui_init_task_proposal_widget

    ; Add to component registry
    lea rdx, szTaskProposalComp
    mov r8d, COMPONENT_TASK_PROPOSAL
    call gui_register_component

    ; Set up event handlers
    call ui_setup_task_proposal_events

    ; Apply theme to task proposal widget
    call ui_apply_theme_to_task_proposal

    ; Make it visible
    call ui_show_task_proposal_widget
...
.data
    szChatComp      BYTE "Chat",0
    szInputComp     BYTE "Input",0
    szTerminalComp  BYTE "Terminal",0
    szStatusBarComp BYTE "StatusBar",0
    szFileTreeComp  BYTE "FileTree",0
    szEditorComp    BYTE "Editor",0
    szTaskProposalComp  BYTE "TaskProposal",0
