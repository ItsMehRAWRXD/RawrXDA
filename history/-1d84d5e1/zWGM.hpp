...
struct CorrectionResult {
    ...
    static CorrectionResult success(const QString& output, FailureType failure) {
        return CorrectionResult{true, output, failure, "Correction applied"};
    }
    
    static CorrectionResult failure(FailureType failureType, const QString& diagnostic) {
