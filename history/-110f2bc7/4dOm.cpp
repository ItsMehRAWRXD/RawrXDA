...
{
    // Professional License Gate — Model Monitor requires Professional tier
    LicenseEnforcementGate::getInstance().checkAccess(EnterpriseFeature::ModelMonitor, "constructor");
