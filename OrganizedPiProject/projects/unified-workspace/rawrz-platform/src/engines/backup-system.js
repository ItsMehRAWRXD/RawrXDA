...
class BackupSystem extends EventEmitter {
    constructor() {
        ...
        this.selfSufficient = true; // JavaScript backup system is self-sufficient
        this.externalDependencies = [];
        this.requiredDependencies = [];
        this.realImplementation = true; // Real backup system with actual file operations
    ...
    async determineStorageLocation(backup) {
        try {
            ...
            // Provide default storage location if none enabled
            const defaultPath = process.env.BACKUP_DEFAULT_PATH || './backups';
            console.warn(`[Backup System] No enabled storage location found, using default: ${defaultPath}`);
            
            // Create default storage location
            this.storageLocations.set('DEFAULT', {
                id: 'DEFAULT',
