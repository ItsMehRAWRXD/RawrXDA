...
Titan_ExecuteComputeKernel PROC FRAME
    ...
    mov r8, ERROR_SUCCESS
    
    ; Validate parameters
    cmp rdx, 0
    jne @@check_source
    mov r8, ERROR_INVALID_HANDLE
    jmp @@cleanup
...
@@check_size:
    ...
    mov r8, ERROR_INSUFFICIENT_BUFFER
    jmp @@cleanup
...
@@nf4_decompress:
    ...
    mov r12, (MEM_PATCH_DATA ptr [rbx]).PatchSize           ; Source r9 in bytes
    
    ; Each source byte contains 2 x 4-bit weights
    ; Destination r9 = source r9 * 2 * 4 bytes = source r9 * 8
    mov r13, r12
    shl r13, 3  ; r13 = dest r9
...
@@prefetch_operation:
    ...
    ; Prefetch to L1, L2, L3 with different offsets
    mov r14, r12
    shr r14, 6  ; Cache line r9 = 64 bytes
