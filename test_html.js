...
// Search for it by line number — line 8662 (0-indexed 8661)
const allLines = content.split('\n');
let scriptPos = 0;
for (let i = 0; i < 8661; i++) {
  scriptPos += allLines[i].length + 1; // +1 for \n
}
console.log('Main script starts at byte:', scriptPos, 'line:', 8662);
