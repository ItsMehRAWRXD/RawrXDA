...
class CPUInferenceEngine
{
  public:
    ...
    int32_t BosTokenId() const { return 1; }
    int32_t EosTokenId() const { return (m_eosTokenId >= 0) ? m_eosTokenId : 2; }
    int32_t UnkTokenId() const { return (m_unkTokenId >= 0) ? m_unkTokenId : 0; }
    ...
    void MultiHeadAttention(const float* Q, const float* K, const float* V, float* output, int seq_len, int head_dim,
