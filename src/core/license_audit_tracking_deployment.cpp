...
// getAuditEventCount, getAuditDenialCount, getFeatureDenialRate, isSystemAnomalous
// are defined in license_helper_utilities.cpp (single definition to avoid LNK2005).
