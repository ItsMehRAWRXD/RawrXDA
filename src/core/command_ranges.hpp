...
// Also includes legacy Terminal IDs from Win32IDE.cpp (3001-3006)
constexpr uint32_t TERM_MIN   = 3001;
...
// Tools            (range 3010-3013, legacy from Win32IDE.cpp)
constexpr uint32_t TOOLS_MIN  = 3010;
constexpr uint32_t TOOLS_MAX  = 3013;

// Modules          (range 3050-3052, legacy from Win32IDE.cpp)
constexpr uint32_t MODULES_MIN = 3050;
constexpr uint32_t MODULES_MAX = 3052;
