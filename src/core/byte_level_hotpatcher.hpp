...
typedef BytePatchEnhanced BytePatch;
...
// Legacy compatibility typedef
typedef ByteSearchResultEnhanced ByteSearchResult;
...
// Legacy compatibility typedef
typedef ByteMutationEnhanced ByteMutation;
...
// Direct I/O — legacy wrapper (implemented in byte_level_hotpatcher.cpp)
...
// Legacy compatibility wrapper (implemented in byte_level_hotpatcher.cpp)
