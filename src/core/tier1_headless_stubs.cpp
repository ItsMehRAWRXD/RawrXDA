// ============================================================================
// tier1_headless_stubs.cpp — Tier 1 Cosmetic Handlers (Headless/CLI)
// ============================================================================
// RawrEngine/RawrXD_Gold use auto_feature_registry; ssot_handlers (with full
// Tier1 implementations) is Win32 IDE only. This file provides headless implementations
// for handleTier1* so command_registry links without ssot_handlers.
