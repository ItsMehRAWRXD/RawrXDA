...
std::string AgenticBridge::RunDumpbin(const std::string&, const std::string&) {
    return "[Headless] RunDumpbin not available — use full IDE build for RE tools.";
}
std::string AgenticBridge::RunCodex(const std::string&) {
    return "[Headless] RunCodex not available — use full IDE build for codex analysis.";
}
std::string AgenticBridge::RunCompiler(const std::string&) {
    return "[Headless] RunCompiler not available — use full IDE build.";
}
SubAgentManager* AgenticBridge::GetSubAgentManager() { return nullptr; }
std::string AgenticBridge::RunSubAgent(const std::string&, const std::string&) {
    return "[Headless] SubAgent not available — use full IDE build for chain/swarm.";
}
std::string AgenticBridge::ExecuteChain(const std::vector<std::string>&, const std::string&) {
    return "[Headless] ExecuteChain not available — use full IDE build.";
}
std::string AgenticBridge::ExecuteSwarm(const std::vector<std::string>&, const std::string&, int) {
    return "[Headless] ExecuteSwarm not available — use full IDE build.";
}
void AgenticBridge::CancelAllSubAgents() {}
std::string AgenticBridge::GetSubAgentStatus() const {
    return "Headless: SubAgent manager not available.";
}
