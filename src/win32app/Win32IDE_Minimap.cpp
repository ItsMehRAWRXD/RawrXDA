...
// Minimap dimension constants
static constexpr int MINIMAP_DEFAULT_WIDTH = 80;
...
LRESULT CALLBACK MinimapWndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
