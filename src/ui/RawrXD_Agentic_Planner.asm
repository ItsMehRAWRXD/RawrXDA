...
.data
szExplorerRoot db \ D:\rawrxd\,0
szChatHeader db \RawrXD Sovereign Chat v15.1\,13,10,\Ready for input...\,13,10,0
szTermHeader db \RawrXD Terminal v1.0\,13,10,\> \,0
szFindWildcard db \\*\,0
...
@@exit:
    ...
    pop rbp
    ret
Core_UI_PopulateExplorer endp
Core_UI_AddTreeItem proc
    sub rsp, 128
    ; (Stub for TreeView insertion)
    add rsp, 128
    ret
Core_UI_AddTreeItem endp
