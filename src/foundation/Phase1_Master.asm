...
DetectCpuCapabilities PROC FRAME
    ...
    mov [r12].CPU_CAPABILITIES.vendor_id+4, edx
    mov [r12].CPU_CAPABILITIES.vendor_id+8, ecx
    
    ; Get brand string (CPUID 80000002h-80000004h)
    mov eax, 80000002h
    cpuid
    mov [r12].CPU_CAPABILITIES.brand_string, eax
    mov [r12].CPU_CAPABILITIES.brand_string+4, ebx
    mov [r12].CPU_CAPABILITIES.brand_string+8, ecx
    mov [r12].CPU_CAPABILITIES.brand_string+12, edx
    
    mov eax, 80000003h
    cpuid
    mov [r12].CPU_CAPABILITIES.brand_string+16, eax
    mov [r12].CPU_CAPABILITIES.brand_string+20, ebx
    mov [r12].CPU_CAPABILITIES.brand_string+24, ecx
    mov [r12].CPU_CAPABILITIES.brand_string+28, edx
    
    mov eax, 80000004h
    cpuid
    mov [r12].CPU_CAPABILITIES.brand_string+32, eax
    mov [r12].CPU_CAPABILITIES.brand_string+36, ebx
    mov [r12].CPU_CAPABILITIES.brand_string+40, ecx
    mov [r12].CPU_CAPABILITIES.brand_string+44, edx
