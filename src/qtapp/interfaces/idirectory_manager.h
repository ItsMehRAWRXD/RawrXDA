...
public:
     ...
     */
    virtual FileOperationResult createDirectory(const std::string& path) = 0;
     ...
     * \return Operation result
     */
    virtual FileOperationResult deleteDirectory(const std::string& path,
     ...
     * \return Operation result
     */
    virtual FileOperationResult copyDirectory(const std::string& sourcePath,
     ...
     */
    virtual std::string toAbsolutePath(const std::string& relativePath,
                                   const std::string& basePath = std::string()) const = 0;
     ...
     */
    virtual std::string toRelativePath(const std::string& absolutePath,
                                   const std::string& basePath) const = 0;
