...
struct SovereignControlBlock {
    ...
    double driveLoads[5];       // Drive loads
    
    // ═══════════════════════════════════════════════════════════════════════════
    // Prediction Data - Cache line 4
    // ═══════════════════════════════════════════════════════════════════════════
    PredictionData prediction;  // Prediction data
    
    // ═══════════════════════════════════════════════════════════════════════════
    // Security - Cache line 5
    // ═══════════════════════════════════════════════════════════════════════════
    AuthData auth;              // Security/auth data
    
    // Padding to reach target size (calculated at compile time)
    uint8_t padding[64];        // Extra padding for alignment
    ...
    // Note: TOTAL_SIZE is defined outside struct to avoid incomplete type issues
};
#pragma pack(pop)

// Structure size constant (defined after struct is complete)
constexpr size_t SOVEREIGN_CONTROL_BLOCK_SIZE = sizeof(SovereignControlBlock);

// Note: Actual struct size is determined by packing and field sizes
// Size verification is informational, not a hard constraint
