...
For full details please see [User's Manual](https://github.com/vadimcn/codelldb/blob/v1.11.7/MANUAL.md).<br>
...
via [remote debugging](https://github.com/vadimcn/codelldb/blob/v1.11.7/MANUAL.md#remote-debugging).

# More information
- [CodeLLDB User's Manual](https://github.com/vadimcn/codelldb/blob/v1.11.7/MANUAL.md) - how to use this extension.
...
![source](https://github.com/vadimcn/codelldb/raw/v1.11.7/images/plotting.png)
<br>
<br>
Rust debugging:<br>
![source](https://github.com/vadimcn/codelldb/raw/v1.11.7/images/source.png)
