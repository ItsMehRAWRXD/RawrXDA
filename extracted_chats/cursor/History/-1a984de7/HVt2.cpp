...
CompilerConfig CompilerConfigManager::getCompilerConfig(const QString &language) const
{
    ...
    // Create default config without storing it (const-safe)
    CompilerConfig defaultConfig;
    defaultConfig.language = language;
    defaultConfig.enabled = true;
    defaultConfig.timeoutMs = m_globalTimeoutMs;
    defaultConfig.defaultOutputPath = m_defaultOutputPath;
    defaultConfig.fileExtensions = QStringList() << language.toLower();
