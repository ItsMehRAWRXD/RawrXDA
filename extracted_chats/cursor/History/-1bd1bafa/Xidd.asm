...
parse_delay:
    ...
    ; Skip to value and parse (simplified - same pattern as duration)
    xor r13d, r13d
...
;==========================================================================
; Helper: StringCompare(rcx=str1, rdx=str2) -> eax (0 if equal, non-zero otherwise)
;==========================================================================
StringCompare PROC
    push rbx
    push rsi
...
szLayoutPaddingKey    db '"padding"', 0
szLayoutSpacingKey    db '"spacing"', 0
szLayoutGrid          db "grid", 0
szLayoutFlex          db "flex", 0
szLayoutStack         db "stack", 0
szLayoutAbsolute      db "absolute", 0
szAnimDurationKey     db '"duration"', 0
szAnimEasingKey       db '"easing"', 0
szAnimDelayKey        db '"delay"', 0
szEaseIn              db "ease-in", 0
szEaseOut             db "ease-out", 0
szEaseInOut           db "ease-in-out", 0
szEaseLinear          db "linear", 0
fltZero               dd 0.0
fltOne                dd 1.0
fltTwo                dd 2.0
fltPadding            dd 10.0
