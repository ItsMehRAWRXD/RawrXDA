...
class PluginMarketplace {
        ...
        try {
                    ...
                    return `
                        <div style="border: 1px solid var(--cursor-border); border-radius: 8px; padding: 12px 14px; margin-bottom: 10px; background: rgba(119, 221, 190, 0.05);">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <div style="font-weight: 600; font-size: 13px; color: var(--cursor-jade-dark); text-transform: uppercase;">${provider}</div>
                                ...
                                <button onclick="pluginMarketplace.deleteApiKey('${provider}')" style="background: rgba(255, 71, 87, 0.12); border: 1px solid #ff4757; color: #ff4757; padding: 6px 12px; border-radius: 6px; cursor: pointer; font-size: 11px; font-weight: 600;">Remove</button>
                            </div>
                        </div>
                    `;
                }).join('')
            ...
            container.innerHTML = `
                ...
                <div style="border-top: 1px solid var(--cursor-border); padding-top: 16px;">
                    <div style="font-weight: 600; font-size: 13px; color: var(--cursor-jade-dark); margin-bottom: 8px;">Add or Update API Key</div>
    ...
    async saveApiKey() {
        ...
        try {
            const response = await this.apiKeysAPI.set(provider, key, {});
                ...
                ? models.map(model => {
                    ...
                    return `
                        <div style="border: 1px solid var(--cursor-border); border-radius: 8px; padding: 12px 14px; margin-bottom: 10px; background: rgba(119, 221, 190, 0.05);">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <div style="font-weight: 600; font-size: 13px; color: var(--cursor-jade-dark);">${name}</div>
                                    <div style="font-size: 11px; color: var(--cursor-text-muted); margin-top: 4px;">${size} • Updated ${updated}</div>
                                </div>
                                <div style="display: flex; gap: 8px;">
                                    <button onclick="pluginMarketplace.showOllamaModelInfo('${name}')" style="background: rgba(119, 221, 190, 0.12); border: 1px solid var(--cursor-jade-light); color: var(--cursor-jade-dark); padding: 6px 12px; border-radius: 6px; cursor: pointer; font-size: 11px; font-weight: 600;">Details</button>
                                    <button onclick="pluginMarketplace.deleteOllamaModel('${name}')" style="background: rgba(255, 71, 87, 0.12); border: 1px solid #ff4757; color: #ff4757; padding: 6px 12px; border-radius: 6px; cursor: pointer; font-size: 11px; font-weight: 600;">Remove</button>
                                </div>
                            </div>
                        </div>
                    `;
