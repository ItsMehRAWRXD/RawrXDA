...
void Win32IDE::updateCommandStates() {
    ...
    m_commandStates[3009] = hasTerminal; // Clear All Terminals
...
void Win32IDE::handleTerminalCommand(int commandId) {
    switch (commandId) {
        ...
        case 3009: // Terminal: Clear All Terminals
            clearAllTerminals();
...
void Win32IDE::buildCommandRegistry()
{
    ...
    m_commandRegistry.push_back({3009, "Terminal: Clear All Terminals", "", "Terminal"});
