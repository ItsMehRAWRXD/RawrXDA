...
// IDM_TRANSCEND_INIT_HWSYNTH      = 6015 (6011 reserved for Explorer toolbar)
// IDM_TRANSCEND_INIT_MESHBRAIN    = 6016
// IDM_TRANSCEND_INIT_SPECIATOR    = 6017
// IDM_TRANSCEND_INIT_NEURAL       = 6018
// IDM_TRANSCEND_INIT_OMEGA        = 6019
...
bool Win32IDE::handleTranscendenceCommand(int cmdId) {
    ...
    // Individual phase init (6011-6014 used by Explorer toolbar)
    case 6010: coord.initializePhase(rawrxd::TranscendencePhase::SelfHost);  return true;
    case 6015: coord.initializePhase(rawrxd::TranscendencePhase::HWSynth);   return true;
    case 6016: coord.initializePhase(rawrxd::TranscendencePhase::MeshBrain); return true;
    case 6017: coord.initializePhase(rawrxd::TranscendencePhase::Speciator); return true;
    case 6018: coord.initializePhase(rawrxd::TranscendencePhase::Neural);    return true;
    case 6019: coord.initializePhase(rawrxd::TranscendencePhase::Omega);     return true;
