      ...
      <div className="heatmap-content">
          ...
          <div className="token-details">
            ...
            <div className="details-grid">
              ...
              <div className="detail-item">
                ...
                <span className="value">{(selectedToken.confidence * 100).toFixed(1)}%</span>
              </div>
              <div className="detail-item">
                <span className="label">Entropy:</span>
                <span className="value">{selectedToken.entropy.toFixed(3)}</span>
              </div>
              <div className="detail-item">
                <span className="label">Max Logit:</span>
                <span className="value">{selectedToken.maxLogit.toFixed(3)}</span>
              </div>
              <div className="detail-item">
                <span className="label">Min Logit:</span>
                <span className="value">{selectedToken.minLogit.toFixed(3)}</span>
              </div>
              <div className="detail-item">
                <span className="label">Avg Logit:</span>
                <span className="value">{selectedToken.avgLogit.toFixed(3)}</span>
              </div>
        ...
        {hoveredToken && !selectedToken && (
          <div className="token-tooltip">
            ...
            <br />
            Confidence: {(hoveredToken.confidence * 100).toFixed(1)}%
            <br />
            Entropy: {hoveredToken.entropy.toFixed(3)}
          </div>
        )}
      </div>
