                ...
                if extra:
                    ...
                    if extra.isdigit():
                        ...
                        if num_lines > 0:
                            ...
                            if Lang == "py":
                                for i in range(num_lines):
                                    template_lines.append(f"    # Additional line {i+1} - extend this Python template")
                            elif Lang == "js":
                                for i in range(num_lines):
                                    template_lines.append(f"    // Additional line {i+1} - extend this JavaScript template")
                            elif Lang == "go":
                                for i in range(num_lines):
                                    template_lines.append(f"\t// Additional line {i+1} - extend this Go template")
                            elif Lang == "rs" or Lang == "rust":
                                for i in range(num_lines):
                                    template_lines.append(f"    // Additional line {i+1} - extend this Rust template")
                            elif Lang == "sh" or Lang == "bash":
                                for i in range(num_lines):
                                    template_lines.append(f"# Additional line {i+1} - extend this shell script")
                            elif Lang == "c":
                                for i in range(num_lines):
                                    template_lines.append(f"    // Additional line {i+1} - extend this C template")
                            else:
                                for i in range(num_lines):
                                    template_lines.append(f"    # Additional line {i+1} - extend this template")
