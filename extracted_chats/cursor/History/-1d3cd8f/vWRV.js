...
const server = http.createServer((req, res) => {
    ...
    switch (path) {
                ...
                models: [
                    {
                        ...
                        modified_at: '2025-10-29T00:00:00Z',
                        size: 2400000,
                        digest: 'bigdaddyg-latest-v1',
                        details: {
                            family: 'bigdaddyg',
                            parameter_size: '2.3M',
                            quantization_level: 'custom'
                        },
                        capabilities: ['general', 'assembly', 'chat']
                    },
                    {
                        name: 'BigDaddyG:Code',
                        modified_at: '2025-10-29T00:00:00Z',
                        size: 1800000,
                        digest: 'bigdaddyg-code-v1',
                        details: {
                            family: 'bigdaddyg',
                            parameter_size: '1.8M',
                            quantization_level: 'custom'
                        },
                        capabilities: ['code-generation', 'multi-language', 'templates']
                    },
                    {
                        name: 'BigDaddyG:Debug',
                        modified_at: '2025-10-29T00:00:00Z',
                        size: 2100000,
                        digest: 'bigdaddyg-debug-v1',
                        details: {
                            family: 'bigdaddyg',
                            parameter_size: '2.1M',
                            quantization_level: 'custom'
                        },
                        capabilities: ['debugging', 'error-analysis', 'performance']
                    },
                    {
                        name: 'BigDaddyG:Crypto',
                        modified_at: '2025-10-29T00:00:00Z',
                        size: 3200000,
                        digest: 'bigdaddyg-crypto-v1',
                        details: {
                            family: 'bigdaddyg',
                            parameter_size: '3.2M',
                            quantization_level: 'custom'
                        },
                        capabilities: ['encryption', 'security', 'cryptography', 'hashing']
                    }
                ]
            }));
            break;
        ...
        case '/':
            res.writeHead(200, corsHeaders);
            res.end(JSON.stringify({ 
                message: 'BigDaddyG Multi-Model Server',
                version: '1.0.0',
                available_models: [
                    'BigDaddyG:Latest (General purpose)',
                    'BigDaddyG:Code (Code generation)',
                    'BigDaddyG:Debug (Debugging & analysis)',
                ...
                emotional_states_supported: ['CALM', 'FOCUSED', 'INTENSE', 'OVERWHELMED']
            }));
            break;
