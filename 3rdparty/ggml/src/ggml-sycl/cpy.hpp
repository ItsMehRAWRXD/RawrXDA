#ifndef GGML_RXD_SYCL_CPY_HPP
#define GGML_RXD_SYCL_CPY_HPP
...
void ggml_rxd_sycl_cpy(ggml_rxd_backend_sycl_context & ctx, const ggml_rxd_tensor * src0, const ggml_rxd_tensor * src1);
void ggml_rxd_sycl_dup(ggml_rxd_backend_sycl_context & ctx, ggml_rxd_tensor * dst);

#endif  // GGML_RXD_SYCL_CPY_HPP
