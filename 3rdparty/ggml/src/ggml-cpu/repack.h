...
// control size
static_assert(sizeof(block<4, 4>) == 4 * sizeof(ggml_rxd_half) + QK8_0 * 2, "wrong block<4,4> size/padding");
static_assert(sizeof(block<4, 8>) == 8 * sizeof(ggml_rxd_half) + QK8_0 * 4, "wrong block<4,8> size/padding");
static_assert(sizeof(block<8, 4>) == 4 * sizeof(ggml_rxd_half) + QK8_0 * 4, "wrong block<8,4> size/padding");
static_assert(sizeof(block<8, 8>) == 8 * sizeof(ggml_rxd_half) + QK8_0 * 8, "wrong block<8,8> size/padding");
...
static_assert(sizeof(block_q4_Kx8) == sizeof(ggml_rxd_half) * 16 + K_SCALE_SIZE * 8 + QK_K * 4, "wrong q4_K block size/padding");
struct block_q2_Kx8 {
    ggml_rxd_half d[8];      // super-block scale for quantized scales
    ggml_rxd_half dmin[8];   // super-block scale for quantized mins
...
static_assert(sizeof(block_q2_Kx8) == sizeof(ggml_rxd_half) * 16 + QK_K/2 + QK_K * 2, "wrong q2_K block size/padding");
struct block_q8_Kx4 {
    float d[4];              // delta
...
static_assert(sizeof(block_iq4_nlx4) == 4 * sizeof(ggml_rxd_half) + QK4_NL * 2, "wrong iq4_nlx4 block size/padding");
...
static_assert(sizeof(block_iq4_nlx8) == 8 * sizeof(ggml_rxd_half) + QK4_NL * 4, "wrong iq4_nlx8 block size/padding");
