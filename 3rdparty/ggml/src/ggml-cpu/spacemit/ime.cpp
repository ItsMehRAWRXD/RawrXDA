...
// control size
static_assert(sizeof(block<4, 16>) == 16 * sizeof(ggml_rxd_half) + QK4_0 * 8, "wrong block<4,16> size/padding");
static_assert(sizeof(block_with_zp<4, 16>) == 16 * sizeof(ggml_rxd_half) + QK4_0 * 8 + 16 * sizeof(uint8_t),
              "wrong block_with_zp<4,16> size/padding");
static_assert(sizeof(block<8, 16>) == 16 * sizeof(ggml_rxd_half) + QK4_0 * 16, "wrong block<8,16> size/padding");
...
static block_q4_0x16 make_block_q4_0x16(block_q4_0 * in, unsigned int blck_size_interleave) {
    block_q4_0x16 out;
    GGML_RXD_ASSERT(QK4_0 / blck_size_interleave == 2);
