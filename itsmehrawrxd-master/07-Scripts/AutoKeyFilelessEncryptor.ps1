...
# - Generates random key/IV automatically – no passwords, no user interaction
# - Prints only a fileless stub (fresh C source) that generates keys at run-time
