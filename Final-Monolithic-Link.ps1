...
param(
    ...
    [string[]]$ExcludeDirs = @(".git", "dist", "node_modules", "temp", "source_audit", "crash_dumps", "build_fresh", "build_gold", "build_prod", "build_universal", "build_ide", "build_qt_free", "build_win32_gui_test")
)
